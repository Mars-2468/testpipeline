...
<div class="row">
  ...
  <option value="<c:out value="${contextRoot}"/>/dashBoard/newwaterconnection.do">New Water Connection</option>
  <option value="<c:out value="${contextRoot}"/>/dashBoard/changeinownershiptype.do">Change In Ownership Type</option>
  <option value="<c:out value="${contextRoot}"/>/dashBoard/changeinwaterconnectiontype.do">Change In Water Connection Type</option>
  <option value="<c:out value="${contextRoot}"/>/dashBoard/discontinuewaterconnection.do">Discontinue Water Connection</option>
  <option value="<c:out value="${contextRoot}"/>/dashBoard/reconnectionofwaterline.do">Reconnection Of Water Line</option>
  <option value="<c:out value="${contextRoot}"/>/dashBoard/waterconnection .do">Change In Water Connection Usage</option>
<option value="<c:out value="${contextRoot}"/>/dashBoard/waternodues.do">Water No Dues Certificate</option>
  <option value="<c:out value="${contextRoot}"/>/dashBoard/watermetercomplaint.do">Complaints Against Water Meter</option>
  <option value="<c:out value="${contextRoot}"/>/dashBoard/illegalwaterconnectioncomplaint.do">Illegal Water Connection Complaint</option>
    <option value="<c:out value="${contextRoot}"/>/dashBoard/waterforcecomplaint.do">Water Force Complaint</option>
    <option value="<c:out value="${contextRoot}"/>/dashBoard/waterqualitycomplaint.do">Complaint Against Water Quality</option>
...
'#33B7FF' 
 ...
 function getListOnCategory(category){
	 ...
	 onPageSubmit('<c:out value="${contextRoot}"/>/dashBoard/getWaterDeptListOnCategory.do');
