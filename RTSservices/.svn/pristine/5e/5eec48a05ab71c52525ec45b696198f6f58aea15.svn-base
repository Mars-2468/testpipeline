...
<div class="mainHdr">
    ...
    height: 30px;
		...
		<fmt:message key="Property Tax Re-Assessment" />
		:
...
<div valign="top" id="SetFormHeight">
	<input type="hidden" name="id"
		value="${propertyTaxAssessment.propertyAssessmentID}">
	<c:set var="doc"
	...
	<table width="100%" border="0" cellpadding="2" cellspacing="2">
		...
		<tr>
			...
			<td colspan="2"><input type="text" class="form-control"
				style="width: 180px" id="ph_no" maxlength="50" name="ph_no"
		...
		<tr>
			...
			<td colspan="2"><input type="text" class="form-control"
				id="email" style="width: 230px" name="email"
				value="<c:out value="${propertyTaxAssessment.propertyHolderName}"/>"
				disabled /></td>
		</tr>
		<tr>
			<td colspan="1.5"><span class="ClsLabel" style="font-size: 14px"><fmt:message
		...
		<tr>
			...
			<td colspan="2"><input type="text" class="form-control"
				style="width: 180px" id="childeName" maxlength="45" tabindex="3"
				name="childeName"
				value="<c:out value="${propertyTaxAssessment.taxPincode}"/>"
				disabled /></td>
		...
		<tr>
			...
			<td colspan="2"><input type="text" class="form-control"
				style="width: 180px" id="childeName" maxlength="45" tabindex="3"
				name="childeName"
				value="<c:out value="${propertyTaxAssessment.taxMobileNo}"/>"
				disabled /></td>
		...
		<tr>
			...
			<td colspan="2"><input type="text" class="form-control"
				...
				name="fees"
				value="<c:out value="${rtiApplication.applicationCost}"/>" disabled /></td>
		</tr>
   ...
   <span class="download" style="align-items: center;color:white;">Download</span>
		...
		<c:if test="${doc[2] != 'null'}">
			<tr>
				<td colspan="3.5"><span class="ClsLabel"
					style="font-size: 14px"><fmt:message
							key="Copy Of Demand
								Bill Of Current Year (चालू वर्षाच्या मागणी बिलाची प्रत)" />:</span> 
				<td style="text-align: center" colspan="3.5"><a
					class="ClsButton" type="button" target="_blank"
	...
	<%-- 	<c:if test="${doc[1] != 'null'}">
			<tr>
				<td colspan="3.5"><span class="ClsLabel"
					style="font-size: 14px"><fmt:message
							key="Affidavit(If this Additional Information Is To Be Furnished, Separate Annexure Should Be Attached.) (प्रतिज्ञापत्र ही अतिरिक्त माहिती सादर करायची असल्यास, स्वतंत्र परिशिष्ट जोडले जावे.)" />:</span>
				<td style="text-align: center" colspan="3.5"><a class="bg-button btn btn-primary bd-highlight action"
   type="button"
   target="_blank"
...
<td colspan="4" align="center"><input type="button"
	...
	<input type="hidden" class="ClsTextbox_mr" style="width: 180px"
		...
		value="<c:out value="${propertyTaxAssessment.propertyAssessmentID}"/>" />
	...
	<input type="hidden" id="rtiApplicationRefId"
		...
		value="${propertyTaxAssessment.rti_ref_id}" />
...
<script type="text/javascript">
	...
	function saveFees(){
		...
		onPageSubmit('<c:out value="${contextRoot}"/>/rtsapplication/savePropertyAssessmentTranscriptFees.do?id='+refId);
		}else{
			return false;
		}
		}else{
