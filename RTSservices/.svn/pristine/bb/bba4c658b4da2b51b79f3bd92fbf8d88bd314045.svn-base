...
<body>
    ...
    <form class="needs-validation" novalidate>
      <div class="container mt-3">
           <div class="printable">
               <h3 class="text-center"><strong>Application Form For Trade Licence Outdated Renewal Notice								
        ...
        <div class="col-md-3">
            <div class="mb-3 mt-3">
                <label for="" class="form-label lbleng">First Name<span class="text-danger">*</span></label>
        ...
        <div class="col-md-3">
            <div class="mb-3 mt-3">
                <label for="" class="form-label lbleng">Last Name<span class="text-danger"
        ...
        <div class="col-md-3">
            <div class="mb-3 mt-3">
                ...
                <input type="email" class="form-control" style="background-image: none;" id="email" placeholder="" name="appEmail" value=""
    ...
    errorFeedback.style.display = 'block';
          ...
          <br>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="mb-3 mt-3">
                            <label for="" class="form-label lbleng">Zone No.<span class="text-danger"
                                    style="color: red;">*</span> </label>
                        ...
                        <div class="col-md-3">
                            <div class="mb-3 mt-3">
                                <label for="" class="form-label lbleng">Name of Area</label>
                        ...
                        <div class="col-md-3">
                            <div class="mb-3 mt-3">
                                ...
                                <input type="text" class="form-control" pattern="^\s*\S.*$"style="background-image: none;" id="" placeholder="" name="TradeLicenceNo" value=""maxlength=100" pattern="^\s*\S.*$"required>
                                <div class="invalid-feedback">
                        ...
                        <div class="col-md-3">
                            <div class="mb-3 mt-3">
                                <label for="" class="form-label lbleng">Updated Trade Name </label>
            
                                <input type="text" class="form-control" pattern="^\s*\S.*$"style="background-image: none;" id="" placeholder="" pattern="^\s*\S.*$" name="UpdatedTradeName " maxlength=100"pattern="^([A-Za-z]{0,})([A-Za-z]{1,}\s?)+$" value="">
                                
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="mb-3 mt-3">
                                <label for="" class="form-label lbleng">Updated Trade Type<span class="text-danger"
                                        style="color: red;">*</span></label>
            
                                <input type="text" class="form-control" pattern="^\s*\S.*$"style="background-image: none;" id="" placeholder="" pattern="^\s*\S.*$" name="UpdatedTradeType" value=""  required>
                                <div class="invalid-feedback">
                                    Please Enter Valid Updated Trade Type.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="mb-3 mt-3">
                                <label for="" class="form-label lbleng">Updated Owner/Partner Name <span class="text-danger"
                                        style="color: red;">*</span></label>
            
                                <input type="text" class="form-control" pattern="^\s*\S.*$"style="background-image: none;" id=""maxlength=100" placeholder="" name="UpdatedOwner/PartnerName " value="" pattern="^([A-Za-z]{0,})([A-Za-z]{1,}\s?)+$" required>
                                <div class="invalid-feedback">
                        ...
                        <div class="col-md-3">
                            <div class="mb-3 mt-3">
                                <label for="" class="form-label lbleng">Updated Partner Count <span class="text-danger"
                                        style="color: red;">*</span></label>
            
                                <input type="number" class="form-control" style="background-image: none;" id="" maxlength="3"placeholder="" name="UpdatedOwner/PartnerCount " value="" required>
                                <div class="invalid-feedback">
			...
			<div class="col-md-3">
                <div class="mb-3 mt-3">
                    <label for="" class="form-label">NOC for the related department issued from the NMC/Department Officer/Govt/Semi Govt. Officer<span class="text-danger"
                            style="color: red;">*</span> 
</label>
                    <input type="file" class="form-control" style="background-image: none;" id="doc1" placeholder=""
                         name="applicantIProof" required>
                         <div class="invalid-feedback">
            ...
            <div class="col-md-3">
                <div class="mb-3 " style="margin-top: 40px;">
                    <label for="" class="form-label lbleng">Copy of the Former Licence (In case of Renewal the Licence)<span
                            class="text-danger" style="color: red;"  >*</span></label>

                    <input type="file" class="form-control" style="background-image: none;" id="doc2" placeholder="" name="CopyOfTheFormerLicence " required>
                    <div class="invalid-feedback">
                        File selected is either greater than 2Mb or not of type .pdf.
                    </div>
            ...
            <div class="col-md-3">
                <div class="mb-3 "style="margin-top: 65px;">
                    <label for="" class="form-label lbleng">No Dues Certificate for Property Tax</label>
			...
			<div class="col-md-3">
                <div class="mb-3"style="margin-top: 65px">
                    <label for="" class="form-label lbleng"> Building Authorization Document <span
                            class="text-danger" style="color: red;"  >*</span></label>
...
<script>
    ...
    data.append('idProof4', $("#doc4").get(0).files[0]);
            ...
            filesPath = filesPath + basePath + "tradeLicenseOutdatedRenewal/" + i + value + ","
                    isFileSelected = true;
                }
            }
            $.ajax({
