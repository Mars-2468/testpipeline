...
<div class="container">
	<h3 style="font-size: 18px; font-weight: bold;">
		...
		<fmt:message key="Application Form For  Water Reconnection" />
		:
...
<div valign="top" id="">
	<input type="hidden" name="id"
		value="${waterReconnection.waterConnectionId}">
	<table width="100%" border="0" cellpadding="2" cellspacing="2"
		...
		<tr>
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.waterDisconnection.CINNo" /></span><span class="ClsRequiredFields"></span>: </td>
			<td><input type="text" class="form-control" style="width: 300px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${waterReconnection.cinNo}"/>" readonly/></td>
			...
			<td><input type="text" class="form-control" style="width: 300px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${waterReconnection.zoneNo}"/>" readonly/></td>				
		</tr>
		<tr>
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.waterDisconnection.consumerName" />:</span></td>
			<td><textarea class="form-control" style="width: 300px;"
					id="ownerAddress" maxlength="200" name="ownerAddress" rows="2" readonly>${waterReconnection.consumerName}</textarea></td>
              
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.waterDisconnection.consumerAddress" />:</span></td>
			<td><textarea class="form-control" style="width: 300px;"
					id="ownerAddress" maxlength="200" name="ownerAddress" rows="2" readonly>${waterReconnection.consumerAddress}</textarea></td>
...
<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
			...
			<td><input type="text" class="form-control" style="width: 300px"
	id="ownerName" maxlength="50" name="ownerName"
	value="<c:out value="${waterReconnection.tap_size}"/>" readonly/></td>
...
<td><input type="text" class="form-control" style="width: 300px"
	id="ownerName" maxlength="50" name="ownerName"
	value="<c:out value="${waterReconnection.category}"/>" readonly/></td>
...
<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
			...
			<td><input type="text" class="form-control" style="width: 300px"
	id="ownerName" maxlength="50" name="ownerName"
	value="<c:out value="${waterReconnection.balance_arrears}"/>" readonly/></td>
...
<td><input type="text" class="form-control" style="width: 300px"
	id="ownerName" maxlength="50" name="ownerName"
	value="<c:out value="${waterReconnection.cut_off_date}"/>" readonly/></td>
...
<tr>
		<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
			...
			<td><input type="text" class="form-control" style="width: 300px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${waterReconnection.meterNo}"/>" readonly/></td>
				<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="ESR" />:</span><span class="ClsRequiredFields"></span></td>
			<td><input type="text" class="form-control" style="width: 300px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${waterReconnection.esr}"/>" readonly/></td>
           </tr>
			<tr>
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.waterDisconnection.email" /></span><span class="ClsRequiredFields"></span>: </td>
			<td><input type="text" class="form-control" style="width: 300px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${waterReconnection.email}"/>" readonly/></td>
		
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.waterDisconnection.mobileNo" /></span><span class="ClsRequiredFields"></span>: </td>
			<td><input type="text" class="form-control" style="width: 300px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${waterReconnection.mobileNo}"/>" readonly/></td>
	...
	<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
			...
			<td><input type="text" class="form-control" style="width: 300px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${waterReconnection.alterMobileNo}"/>" readonly/></td>	
		
			<!-- <td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.waterDisconnection.title" />:</span></td>
			<td><input type="text" class="form-control"
				style="width: 300px;" id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${waterReconnection.title}"/>" readonly/></td>
				</tr>  	
		...
		<tr>
			...
			<td><input type="text" class="form-control"
				style="width: 300px;" id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${waterReconnection.firstName}"/>" readonly/></td>
	
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.fathername" />:</span><span class="ClsRequiredFields"></span></td>
			<td><input type="text" class="form-control" style="width: 300px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${waterReconnection.middleName}"/>" readonly/></td>
		...
		<tr>
			...
			<td><input type="text" class="form-control"
				style="width: 300px;" id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${waterReconnection.lastName}"/>" readonly/></td>
...
<input type="text" class="form-control" style="width: 300px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${waterReconnection.fullName}"/>" readonly/>
			</td>
			</tr>  	
		
		<tr>
		<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.waterDisconnection.plotNo" /></span><span class="ClsRequiredFields"></span>: </td>
			<td><input type="text" class="form-control" style="width: 300px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${waterReconnection.plotNo}"/>" readonly/></td>
			...
			<td><input type="text" class="form-control" style="width: 300px"
				...
				value="<c:out value="${waterReconnection.buildingName}"/>" readonly/></td>
</tr>  	
		
		<tr>
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.waterDisconnection.streetName" /></span><span class="ClsRequiredFields"></span>: </td>
			<td><input type="text" class="form-control" style="width: 300px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${waterReconnection.streetName}"/>" readonly/></td>
			...
			<td><input type="text" class="form-control" style="width: 300px"
				id="changedHospitalNameAndAddress" maxlength="30"
				name="changedHospitalNameAndAddress"
				value="<c:out value="${waterReconnection.areaName}"/>" readonly/></td>
										</tr>  	
						<tr>
			...
			<td><input type="text" class="form-control" style="width: 300px"
				id="changedHospitalNameAndAddress" maxlength="30"
				name="changedHospitalNameAndAddress"
				value="<c:out value="${waterReconnection.landmark}"/>" readonly /></td>
		...
		<tr>
			...
			<td><input type="text" class="form-control" style="width: 300px"
				id="changedHospitalNameAndAddress" maxlength="30"
				name="changedHospitalNameAndAddress"
				value="<c:out value="${waterReconnection.pincode}"/>" readonly/></td>


			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.waterDisconnection.aadhaarNo" /><span class="ClsRequiredFields"></span></span>: </td>
			<td><input type="text" class="form-control" style="width: 300px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${waterReconnection.aadhaarNo}"/>" readonly/></td>
		</tr>  	
		...
		<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
			...
			<td><input type="text" class="form-control" style="width: 300px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${waterReconnection.applicantcity}"/>" readonly /></td>
</tr>
		<tr>
			...
			<td><textarea class="form-control" style="width: 300px;"
					id="ownerAddress" maxlength="200" name="ownerAddress" rows="2" readonly>${waterReconnection.address}</textarea></td>   
			<%-- <td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.waterDisconnection.consumerNo" />:</span></td>
			<td><input type="text" class="form-control" style="width: 300px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${waterReconnection.consumerNo}"/>" /></td> --%>
		...
		<!-- <tr>
			...
			<td><input type="text" class="form-control" style="width: 300px"
				id="changedHospitalNameAndAddress" maxlength="30"
				name="changedHospitalNameAndAddress"
				value="<c:out value="${waterReconnection.depositReceiptNo}"/>" readonly/></td>

			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.waterDisconnection.receiptDate" /></span><span class="ClsRequiredFields"></span>: </td>
			<td><input type="text" class="form-control" style="width: 300px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${waterReconnection.depositReceiptDate}"/>" readonly/></td>

		</tr>
		<tr>

			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.waterDisconnectionrr.purpose" />:</span></td>
			<td><textarea class="form-control" style="width: 300px;"
					id="ownerAddress" maxlength="200" name="ownerAddress" rows="2" readonly>${waterReconnection.purpose}</textarea></td>
		-->			
			...
			<td style="width: 230px; height: 30px"><span class="ClsLabel"
				style="font-size: 14px"> <c:if
					 ...
					 <c:if test="${requestScope.rtiApplication.workFlowStatus==9}">
						<b>Application has been sent to approving authority.</b> 
...
<tr>
			<td colspan="5"><span class="ClsLabel"
				style="font-size: 15px; font-weight: bold;"><fmt:message
						key="List of Documents (with attachment) For Water Reconnection" />:</span></td>
...
<!-- Add on -->
	    ...
	    <td>
                         ...
                         <c:choose>
        <c:when test="${requestScope.forLogin eq 'nothing'}">
        
                           <td style="text-align: center">
                            <input type="number" class="form-control" id="feesApplicable" maxlength="5"  style="margin-left: 192px;width:200px" name="demandfees" value="<c:out value="${waterReconnection.demandfees}"/>" oninput="validateInput(this);"/>
                          </td>
     	 </c:when>
        <c:otherwise>
            <td style="text-align: center">
    ...
    value="<c:out value="${waterReconnection.demandfees}"/>"
...
<!-- Add on -->
    ...
    <c:choose>
        <c:when test="${empty waterReconnection.approvalRemark and requestScope.forLogin eq 'nothing'}">
            <td style="text-align: center;">
            <textarea class="form-control" style="width: 310px;margin-left: 182px;"
					id="approvalRemark" maxlength="200" name="approvalRemark" rows="2">${waterReconnection.approvalRemark}</textarea></td>
        ...
        <c:otherwise>
            <td style="text-align: center;">
               <textarea class="form-control" style="width: 310px;margin-left: 182px;"
					id="approvalRemark" maxlength="200" name="approvalRemark" rows="2" readonly>${waterReconnection.approvalRemark}</textarea></td>
    ...
    <c:choose>
        <c:when test="${empty waterReconnection.uploadedDemand and requestScope.forLogin eq 'nothing'}">
          
                <td style="text-align: center">
                    <input type="file" name="demanddoc" id="demanddoc" style="width: 220px" onchange="confirmFileUpload()" />
               
  <!-- <a class="bg-button btn btn-primary bd-highlight" style="color:white" id="demandUpload"  type="button" target="_blank" onclick="uploadPoliceNoc1();"><span
							class="download" style="align-items: center">Upload</span></a>    -->
							            </td>
        </c:when>
        <c:otherwise>
            <c:if test="${not empty waterReconnection.uploadedDemand}">
                <td style="text-align: center">
                   <a class="bg-button btn btn-success bd-highlight action"
   type="button"
   target="_blank"
   onclick="docDownload('${waterReconnection.uploadedDemand}');">
   <span class="download" style="align-items: center;color:white;">Download</span>
</a>
                </td>
            </c:if>
...
<c:if test="${requestScope.forLogin eq 'nothing'}"		>
  ...
  <!-- Agreement Upload old -->
    ...
    <c:choose>
        <c:when test="${empty waterReconnection.supporting and requestScope.forLogin eq 'nothing'}">
                <td>
        ...
        <c:otherwise>
            <c:if test="${not empty waterReconnection.supporting}">
                <td style="text-align: center">
                 <a class="bg-button btn btn-success bd-highlight action"
   type="button"
   target="_blank"
   onclick="docDownload('${waterReconnection.supporting}');">
   <span class="download" style="align-items: center;color:white;">Download</span>
</a>
...
<c:if test="${requestScope.forLogin eq 'nothing' and requestScope.rtiApplication.workFlowStatus == 3 || requestScope.rtiApplication.workFlowStatus == 2 || requestScope.rtiApplication.workFlowStatus == 1}">
    <tr style="height: 60px;">
       ...
       <c:if test="${waterReconnection.paymentStatus=='Paid'}">checked="checked" disabled="true"</c:if> />
    ...
    <c:choose>
        <c:when test="${empty waterReconnection.acknowledgement}">
        		<c:if test="${(requestScope.rtiApplication.workFlowStatus==2 || requestScope.rtiApplication.workFlowStatus == 1) && requestScope.forLogin eq 'nothing'}">
   ...
   <a class="bg-button btn btn-primary bd-highlight" style="color:white" id="acknowledgementUpload"  type="button" target="_blank" onclick="uploadFireNoc();"><span
        ...
        <c:otherwise>
            <c:if test="${not empty waterReconnection.acknowledgement}">
            <td style="text-align: center">
                          <a class="bg-button btn btn-success bd-highlight action"
   type="button"
   target="_blank"
   onclick="docDownload('${waterReconnection.acknowledgement}');">
   <span class="download" style="align-items: center;color:white;">Download</span>
</a>
                </td>
            </c:if>
...
<c:if test="${requestScope.rtiApplication.workFlowStatus==3  && requestScope.forLogin eq 'nothing'}">
...
<input type="hidden" id="rtiApplicationRefIds" name="rtiApplicationRefIds" value="${waterReconnection.rti_ref_id}" />
 <input type="hidden" class="ClsTextbox" id="waterConnectionId" style="width:180px"  name="waterConnectionId" value="<c:out value="${waterReconnection.waterConnectionId}"/>" />
...
function saveEntity()
{
	onPageSubmit('<c:out value="${contextRoot}"/>/rtiapplication/createWaterReconnectionWork.do');
}
	</script>
...
function saveFees() {
    ...
    var demanddoc = '${waterReconnection.uploadedDemand}';
    ...
    if (feeId.val() !== '' && approvalRemark.val() !== '') {
      ...
      if (confirm('Are you sure you want to save?')) {
        ...
        onPageSubmit('<c:out value="${contextRoot}"/>/rtsapplication/saveReconnectionWater.do');
    ...
    function savePaymentStatus() {
      ...
      //  var acknowledgementUpload = $('#acknowledgementUpload');
        ...
        if (payment.prop('checked')) {
            ...
            onPageSubmit('<c:out value="${contextRoot}"/>/rtsapplication/saveReconnectionWaterPayment.do');
...
$(document).ready(function() {
    ...
    function uploadPoliceNoc1() {
        ...
        for (var i = 0; i < file.length; i++) {
   			...
   			const value = splitName + ".pdf";
                ...
                filesPath = filesPath + basePath + "waterreconnection/" + i + value + ","
                isFileSelected = true;
            }
        }
        var appType = 1;
        ...
        $.ajax({
            url: "<c:out value='${contextRoot}'/>/rtsapplication/uploadManageWaterReconnection.do?appType="+appType+"&UID="+uid1,
            type: 'POST',
            data: data,
            cache: false,
            dataType: 'json',
	...
	$(document).ready(function() {
 	    var demandfees = "${waterReconnection.demandfees}";
 		var workflowStatus="${requestScope.rtiApplication.workFlowStatus}";
