...
@Repository
public class CitizenZoneDaoImpl extends HibernateDaoSupport implements CitizenZoneDAO{
	...
	try {
	      ...
	      if (log.isDebugEnabled()) {
		    ...
		    return (List<CitizenZone>) getHibernateTemplate().loadAll(CitizenZone.class);
