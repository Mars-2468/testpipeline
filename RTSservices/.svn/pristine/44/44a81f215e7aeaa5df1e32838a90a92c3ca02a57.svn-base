...
import com.mars.rti.dao.DogLicenseDashboardDAO;
import com.mars.rti.model.RTIApplication;
import com.mars.rti.search.DashBoardLabelSearch;
@Repository
public class DogLicenseDashboardDAOImpl  extends HibernateDaoSupport implements DogLicenseDashboardDAO{
		
		private static final Log log = LogFactory.getLog(BirthDashboardDAOImpl.class);
