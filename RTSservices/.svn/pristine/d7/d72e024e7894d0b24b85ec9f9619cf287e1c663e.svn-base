...
@Entity
@Table(name = "tradelicense_cancellation", schema = "egovrti")
public class TradeLicenseCancellation {
	
	@Id
	@Column(name = "tradeLicense_cancellationid", nullable = false, unique = true)
	@SequenceGenerator(name = "tradeLicensecancel_seq", sequenceName = "tradeLicensecancel_seq")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "tradeLicensecancel_seq")
	private long tradeLicenseCancellationID;
	...
	public long getTradeLicenseCancellationID() {
		return tradeLicenseCancellationID;
	}

	public void setTradeLicenseCancellationID(long tradeLicenseCancellationID) {
		this.tradeLicenseCancellationID = tradeLicenseCancellationID;
	}
