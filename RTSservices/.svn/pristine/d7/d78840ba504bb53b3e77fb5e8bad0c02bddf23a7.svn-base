...
@Entity
@Table(name = "tradelicense_duplicatecopy", schema = "egovrti")
public class TradeLicenseDuplicateCopy {
	
	@Id
	@Column(name = "tradelicense_duplicateid", nullable = false, unique = true)
	@SequenceGenerator(name = "tradeLicenseDuplicate_seq", sequenceName = "tradeLicenseDuplicate_seq")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "tradeLicenseDuplicate_seq")
	private long tradeLicenseDuplicateID;
	...
	public long getTradeLicenseDuplicateID() {
		return tradeLicenseDuplicateID;
	}

	public void setTradeLicenseDuplicateID(long tradeLicenseDuplicateID) {
		this.tradeLicenseDuplicateID = tradeLicenseDuplicateID;
	}
