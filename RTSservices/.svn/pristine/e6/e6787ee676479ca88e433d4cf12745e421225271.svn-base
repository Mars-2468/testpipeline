...
<div class="container">
	<h3 style="font-size: 18px; font-weight: bold;">
		...
		<fmt:message key="Application Form For Trade License Duplicate Copy" />
		:
...
<div valign="top" id="SetFormHeight">
	<input type="hidden" name="id"
		value="${tradeLicenseDuplicateCopy.tradeLicenseDuplicateID}">
	<table width="100%" border="0" cellpadding="2" cellspacing="2"
		...
		<tr>
			...
			<td><input type="text" class="form-control"
				...
				value="<c:out value="${tradeLicenseDuplicateCopy.firstName}"/>" /></td>
			...
			<td><input type="text" class="form-control" style="width: 350px"
				...
				value="<c:out value="${tradeLicenseDuplicateCopy.middleName}"/>" /></td>
		...
		<tr>
			...
			<td><input type="text" class="form-control"
				style="width: 350px;" id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${tradeLicenseDuplicateCopy.lastName}"/>" /></td>

			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicenseDuplicateCopy.fullname" />:</span><span
				class="ClsRequiredFields"></span></td>
			<td>
<input type="text" class="form-control" style="width: 350px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${tradeLicenseDuplicateCopy.fullName}"/>" />
			</td>
		</tr>
		<tr>

			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicenseDuplicateCopy.pincode" />:</span></td>
			<td><input type="text" class="form-control" style="width: 350px;"
					id="ownerAddress" maxlength="200" name="ownerAddress" value="<c:out value="${tradeLicenseDuplicateCopy.pinCode}"/>"/></td>

			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicenseDuplicateCopy.aadhaarno" /><span class="ClsRequiredFields"></span>: </td>
			<td><input type="text" class="form-control" style="width: 350px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${tradeLicenseDuplicateCopy.aadhaarNo}"/>" /></td>

		</tr>
		<tr>

			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicenseDuplicateCopy.emailid"/>:</span></td>
			<td><input type="text" class="form-control" style="width: 350px"
				id="changedHospitalNameAndAddress" maxlength="30"
				name="changedHospitalNameAndAddress"
				value="<c:out value="${tradeLicenseDuplicateCopy.emailID}"/>" /></td>

			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicenseDuplicateCopy.mobileno" /><span class="ClsRequiredFields"></span>: </td>
			<td><input type="text" class="form-control" style="width: 350px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${tradeLicenseDuplicateCopy.mobileNumber}"/>" /></td>

		</tr>
		<tr>
		<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicenseDuplicateCopy.addressForCorre" /><span class="ClsRequiredFields"></span>: </td>
			<td><textarea class="form-control" style="width: 350px;"
					id="ownerAddress" maxlength="200" name="ownerAddress" rows="2">${tradeLicenseDuplicateCopy.adressForCorrespondence}</textarea></td>
			
						<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicenseDuplicateCopy.zoneno" />:</span></td>
			<td><input type="text" class="form-control" style="width: 350px"
				id="changedHospitalNameAndAddress" maxlength="30"
				name="changedHospitalNameAndAddress"
				value="<c:out value="${tradeLicenseDuplicateCopy.zoneNo}"/>" /></td>
</tr>
<tr>
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicenseDuplicateCopy.wardno" /><span class="ClsRequiredFields"></span>: </td>
			<td><input type="text" class="form-control" style="width: 350px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${tradeLicenseDuplicateCopy.wardNo}"/>" /></td>

		
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicenseDuplicateCopy.nameofarea" />:</span></td>
			<td><input type="text" class="form-control" style="width: 350px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${tradeLicenseDuplicateCopy.nameOfArea}"/>" /></td>
</tr>
		<tr>
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicenseDuplicateCopy.tradelicenseno" />:</span><span class="ClsRequiredFields"></span></td>
			<td><input type="text" class="form-control" style="width: 350px"
					id="ownerAddress" maxlength="50" name="ownerAddress" value="<c:out value="${tradeLicenseDuplicateCopy.tradeLicenceNo}"/>"/>

			</td>
		

			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicenseDuplicateCopy.updatedtradename" />:</span></td>
			<td><input type="text" class="form-control" style="width: 350px"
				id="changedHospitalNameAndAddress" maxlength="30"
				name="changedHospitalNameAndAddress"
				value="<c:out value="${tradeLicenseDuplicateCopy.updateTradeName}"/>" /></td>
</tr>
		<tr>
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicenseDuplicateCopy.updatedtradetype" /><span class="ClsRequiredFields"></span>:
			</td>
			<td><input type="text" class="form-control" style="width: 350px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${tradeLicenseDuplicateCopy.updatedTradeType}"/>" /></td>

		

			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicenseDuplicateCopy.updatedownername" />:</span></td>
			<td><input type="text" class="form-control" style="width: 350px"
				id="changedHospitalNameAndAddress" maxlength="30"
				name="changedHospitalNameAndAddress"
				value="<c:out value="${tradeLicenseDuplicateCopy.updatedOwnerName}"/>" /></td>
</tr>
		<tr>
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicenseDuplicateCopy.updatedpartnercount" /><span class="ClsRequiredFields"></span>:
			</td>
			<td><input type="text" class="form-control" style="width: 350px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${tradeLicenseDuplicateCopy.updatedPartnerCount}"/>" /></td>
				<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicenseDuplicateCopy.feesApplicable" /><span class="ClsRequiredFields"></span>:
			</td>
			<td><input type="text" class="form-control" style="width: 350px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${tradeLicenseDuplicateCopy.feesApplicable}"/>" /></td>
...
<tr>
	       <td colspan="6" align="center">
                      ...
                      <button class="ClsButton clsButtonUpload" onclick="download(${tradeLicenseDuplicateCopy.rtiRefId},'tradeLicenseDuplicateCopyCertificateReport.do')">GENERATE CERTIFICATE</button>
	...
	<c:if test="${requestScope.rtiApplication.workFlowStatus==2}">
				...
				<tr>
					<td colspan="6" align="center"><a
						...
						onclick="downloads('${tradeLicenseDuplicateCopy.rtiRefId}', 'tradeLicenseDuplicateCopyCertificateReport.do');"
						type="button" target="_blank"> <span class="download"
							style="display: flex; align-items: center;width: 160px;">Generate
								Certificate</span>
											...
											onclick="download1(${tradeLicenseDuplicateCopy.rtiRefId});return false;"><span
...
<tr>
			<td colspan="5"><span class="ClsLabel"
				style="font-size: 15px; font-weight: bold;"><fmt:message
						key="List of Documents (Attachment) For Trade License Duplicate Copy" />:</span></td>
		...
		<tr>
			<td style="width: 600px; height: 30px"><span class="ClsLabel"
				style="font-size: 14px;"><fmt:message
						key="label.tradeLicenseDuplicateCopy.nocforrelateddept" />:</span></td>
...
<a class="bg-button btn btn-primary bd-highlight action"
   ...
   <span class="download" style="align-items: center;color:white;">Download</span>
		...
		<tr>
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicenseDuplicateCopy.copyofformerlicnse" />:</span></td>
<td style="text-align: center"> <a class="bg-button btn btn-primary bd-highlight action"
   ...
   <span class="download" style="align-items: center;color:white;">Download</span>
		...
		<tr>
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicenseDuplicateCopy.propertynodue" />:</span></td>
<td style="text-align: center"><a class="bg-button btn btn-primary bd-highlight action"
   type="button"
   target="_blank"
   ...
   <span class="download" style="align-items: center;color:white;">Download</span>
		...
		<tr>
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicenseDuplicateCopy.buildingauthdocument" />:</span></td>
<td style="text-align: center"><a class="bg-button btn btn-primary bd-highlight action"
   type="button"
   target="_blank"
 ...
 <input type="hidden" class="ClsTextbox" id="tradeLicenseDuplicateID" style="width:180px"  name="tradeLicenseDuplicateID" value="<c:out value="${tradeLicenseDuplicateCopy.tradeLicenseDuplicateID}"/>" />
    <input type="hidden" id="rtiApplicationRefId" name="rtiApplicationRefId" value="" />
        			  			  <input type="hidden" id="rtiApplicationRefIds" name="rtiApplicationRefIds" value="${tradeLicenseDuplicateCopy.rtiRefId}" />
...
<script type="text/javascript">
	function saveEntity() {
		onPageSubmit('<c:out value="${contextRoot}"/>/rtiapplication/createTradeLicenseDuplicateCopyWork.do');
	}
