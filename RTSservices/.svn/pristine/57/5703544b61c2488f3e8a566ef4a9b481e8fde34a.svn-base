...
/**
 * <p>Title: TalukaDAO.java </p>

 * <p>Description: This interface is used for hibernate operations for Taluka</p>
...
public interface TalukaDAO {
    ...
    /**
	 * This method delete Taluka for a given Id
	 * 
	 * @param id as long
	 * 
	 */
    ...
    /**
     * This method is used to delete a list of Taluka records from the database.
     * 
     * @param listTaluka as List
     */
    public void deleteAll(List<Taluka> listTaluka);
		...
		/**
		 * This method returns count of the Taluka objects from the database
		 * 
		 * @return long
		 * @exception Exception
		 */
		...
		/**
		 * This method returns count of the Taluka objects from the database based on Search
		 * @param TalukaSearch searchTaluka
		 * @return long
		 * @exception Exception
		 */
