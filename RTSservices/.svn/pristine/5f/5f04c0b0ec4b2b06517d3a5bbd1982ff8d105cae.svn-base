...
<div class="container">
	...
	<h3>
		TOWN PLANNING DEPARTMENT DASHBOARD 
	</h3>
...
<div class="row">
  ...
  <option value="<c:out value="${contextRoot}"/>/dashBoard/zone.do">Zone Certificate</option>
  <option value="<c:out value="${contextRoot}"/>/dashBoard/partmap.do">Part Map Certificate</option>
  <option value="<c:out value="${contextRoot}"/>/dashBoard/constructionofbuilding.do">Construction Of Building Or Layout Of Buildings Group Housing Certificate</option>
  <option value="<c:out value="${contextRoot}"/>/dashBoard/constructionofbuildingsqm.do">Contruction Of Building Upto 150 SQ.M. Certificate</option>
  <option value="<c:out value="${contextRoot}"/>/dashBoard/mobiletower.do">Mobile Tower Certificate</option>
</select>
...
'#33B7FF' 
 ...
 function getListOnCategory(category){
	 ...
	 onPageSubmit('<c:out value="${contextRoot}"/>/dashBoard/getTownPlanningListOnCategory.do');
