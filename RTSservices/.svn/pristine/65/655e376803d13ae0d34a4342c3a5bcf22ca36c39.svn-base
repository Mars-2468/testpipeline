...
<script type="text/javascript">
	function editRTIApplicationdog() {
		...
		onPageSubmit('<c:out value="${contextRoot}"/>/rtsapplication/editIllegalWaterConnection.do');
	}

	function saveMandapCertificates() {

		onPageSubmit('<c:out value="${contextRoot}"/>/rtsapplication/saveIllegalWaterConnection.do');
	}
...
<div class="container">
	<h3 style="font-size: 18px; font-weight: bold;">
		...
		<fmt:message key="Application Form For Illegal Water Connection Complaint" />
		:
...
<div valign="top" id="SetFormHeight">
	<input type="hidden" name="id"
		value="${illegalWaterConnection.illegalWaterConnectionID}">
	<table width="100%" border="0" cellpadding="2" cellspacing="2"
		class="container">
		<tr>
		<c:if test="${not empty illegalWaterConnection.cinNo}">
				...
				<td><input type="text" class="form-control"
					...
					value="<c:out value="${illegalWaterConnection.cinNo}"/>" /></td>
			</c:if>
		
			<c:if test="${not empty illegalWaterConnection.zoneNo}">

				<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
							key="label.waterquality.zone" />:</span></td>
				<td><input type="text" class="form-control"
					style="width: 300px" id="ownerName" maxlength="50" name="ownerName"
					value="<c:out value="${illegalWaterConnection.zoneNo}"/>" /></td>
			</c:if>
			</tr>
		<tr>
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
			...
			<td><input type="text" class="form-control" style="width: 300px"
				...
				value="<c:out value="${illegalWaterConnection.consumerName}"/>" /></td>
<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.waterquality.consumerAddress" />:</span></td>
			<td><input type="text" class="form-control" style="width: 300px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${illegalWaterConnection.consumerAddress}"/>" /></td>

		</tr>
		<tr>
			
			<c:if test="${not empty illegalWaterConnection.existingEsr}">
				<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
							key="ESR" />:</span></td>
				<td><input type="text" class="form-control"
					style="width: 300px" id="ownerName" maxlength="50" name="ownerName"
					value="<c:out value="${illegalWaterConnection.existingEsr}"/>" /></td>
		...
		<tr>
			...
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
				...
				<td><input type="text" class="form-control"
					style="width: 300px" id="ownerName" maxlength="50" name="ownerName"
					value="<c:out value="${illegalWaterConnection.consumerNo}"/>" /></td> 
			-->
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.waterquality.meterNo" />:</span></td>
			<td><input type="text" class="form-control" style="width: 300px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${illegalWaterConnection.meterNo}"/>" /></td>
		</tr>
		<tr>
...
<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
			...
			<td><input type="text" class="form-control" style="width: 300px"
	id="ownerName" maxlength="50" name="ownerName"
	value="<c:out value="${illegalWaterConnection.tap_size}"/>" /></td>
...
<td><input type="text" class="form-control" style="width: 300px"
	id="ownerName" maxlength="50" name="ownerName"
	value="<c:out value="${illegalWaterConnection.category}"/>" /></td>
...
<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
			...
			<td><input type="text" class="form-control" style="width: 300px"
	id="ownerName" maxlength="50" name="ownerName"
	value="<c:out value="${illegalWaterConnection.balance_arrears}"/>" /></td>
...
<td><input type="text" class="form-control" style="width: 300px"
	id="ownerName" maxlength="50" name="ownerName"
	value="<c:out value="${illegalWaterConnection.cut_off_date}"/>" /></td>
...
<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
			...
			<td><input type="text" class="form-control" style="width: 300px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${illegalWaterConnection.emailId}"/>" /></td>
			...
			<td><input type="text" class="form-control" style="width: 300px"
				...
				value="<c:out value="${illegalWaterConnection.mobileNo}"/>" /></td>
		</tr>
		<tr>
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
			...
			<td><input type="text" class="form-control"
				style="width: 300px;" id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${illegalWaterConnection.title}"/>" /></td>
			...
			<td><input type="text" class="form-control" style="width: 300px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${illegalWaterConnection.firstName}"/>" /></td>
		...
		<tr>
			...
			<td><input type="text" class="form-control"
				style="width: 300px;" id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${illegalWaterConnection.middleName}"/>" /></td>
			...
			<td><input type="text" class="form-control" style="width: 300px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${illegalWaterConnection.lastName}"/>" /></td>
		</tr>
		<tr>
			...
			<td><input type="text" class="form-control" style="width: 300px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${illegalWaterConnection.fullName}"/>" /></td>

			<!-- <td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.waterquality.flatNo" />:</span></td>
			<td><input type="text" class="form-control" style="width: 300px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${illegalWaterConnection.plotNo}"/>" /></td>
		...
		<tr>
			...
			<td><input type="text" class="form-control" style="width: 300px"
				...
				name="changedHospitalNameAndAddress"
				value="<c:out value="${illegalWaterConnection.buildingName}"/>" /></td>
			...
			<td><input type="text" class="form-control" style="width: 300px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${illegalWaterConnection.streetName}"/>" /></td>
		...
		<tr>
			...
			<td><input type="text" class="form-control" style="width: 300px"
				id="changedHospitalNameAndAddress" maxlength="30"
				name="changedHospitalNameAndAddress"
				value="<c:out value="${illegalWaterConnection.areaName}"/>" /></td>-->

			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.waterquality.address" />:</span></td>
			<td><textarea class="form-control" style="width: 300px"
					id="ownerAddress" maxlength="200" rows="2" name="ownerAddress">${illegalWaterConnection.addressForCorrespondence}</textarea></td>
		...
		<!-- <tr>
			...
			<td><input type="text" class="form-control" style="width: 300px"
				id="changedHospitalNameAndAddress" maxlength="30"
				name="changedHospitalNameAndAddress"
				value="<c:out value="${illegalWaterConnection.landmark}"/>" /></td>
			...
			<td><input type="text" class="form-control" style="width: 300px"
				id="changedHospitalNameAndAddress" maxlength="30"
				name="changedHospitalNameAndAddress"
				value="<c:out value="${illegalWaterConnection.pinCode}"/>" /></td>
		</tr>
		<tr>
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
			...
			<td><input type="text" class="form-control" style="width: 300px"
				id="changedHospitalNameAndAddress" maxlength="30"
				name="changedHospitalNameAndAddress"
				value="<c:out value="${illegalWaterConnection.aadharNo}"/>" /></td>
		...
		<tr>
			...
			<td><input type="text" class="form-control" style="width: 300px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${illegalWaterConnection.depositReceiptNo}"/>" /></td>
-->
		...
		<tr>
			...
			<td><textarea class="form-control" style="width: 300px"
					id="ownerAddress" maxlength="200" rows="2" name="ownerAddress">${illegalWaterConnection.purposeOfIllegalConn}</textarea></td>
	...
	<table width="100%" border="0" cellpadding="2" cellspacing="2"
        ...
        <c:when test="${userId == 3950 || userId == 4150 || userId == 4151 || userId == 4152 || userId == 4153 || userId == 4154 || userId == 4155 || userId ==4156 || userId == 4157 || userId == 4158 || userId == 1 || userId == 4550}">
                           ...
                           <td>
                            <input type="number" class="form-control" id="feesApplicable" maxlength="5"  style="width:200px" name="demandfees" value="<c:out value="${illegalWaterConnection.demandfees}"/>" oninput="validateInput(this);"/>
                          </td>
     	 </c:when>
        <c:otherwise>
            <td>
    ...
    value="<c:out value="${illegalWaterConnection.demandfees}"/>"
    ...
    <c:choose>
        <c:when test="${empty illegalWaterConnection.uploadedDemand}">
        ...
        <c:otherwise>
            <c:if test="${not empty illegalWaterConnection.uploadedDemand}">
                <td>
                    <a target="_blank" href="<c:out value='${illegalWaterConnection.uploadedDemand}'/>" id="uploadCer">
...
<c:if test="${(requestScope.rtiApplication.workFlowStatus == 3 || requestScope.rtiApplication.workFlowStatus == 2 || requestScope.rtiApplication.workFlowStatus == 1 || requestScope.rtiApplication.workFlowStatus == 5) && (userId == 3950 || userId == 4150 || userId == 4151 || userId == 4152 || userId == 4153 || userId == 4154 || userId == 4155 || userId == 4156 || userId == 4157 || userId == 4158 || userId == 1 || userId == 4550)}">
    <tr style="height: 60px;">
       ...
       <c:if test="${illegalWaterConnection.paymentStatus=='Paid'}">checked="checked" disabled="true"</c:if> />
    ...
    <c:choose>
        <c:when test="${empty illegalWaterConnection.acknowledgement}">
        		<c:if test="${(requestScope.rtiApplication.workFlowStatus==2 || requestScope.rtiApplication.workFlowStatus == 1 || requestScope.rtiApplication.workFlowStatus == 5) && (userId == 3950 || userId == 4150 || userId == 4151 || userId == 4152 || userId == 4153 || userId == 4154 || userId == 4155 || userId ==4156 || userId == 4157 || userId == 4158 || userId == 1 || userId == 4550)}">
        ...
        <c:otherwise>
            <c:if test="${not empty illegalWaterConnection.acknowledgement}">
            <td>
                    <a target="_blank" href="<c:out value='${illegalWaterConnection.acknowledgement}'/>" id="uploadCer">
...
<input type="hidden" class="ClsTextbox" id="illegalWaterConnectionID" style="width: 180px" name="illegalWaterConnectionID" value="<c:out value="${illegalWaterConnection.illegalWaterConnectionID}"/>" />
<input type="hidden" id="rtiApplicationRefId" name="rtiApplicationRefId"
	value="<c:out value="${requestScope.rtiApplication.rtiApplicationId}"/>" />
				  			  ...
				  			  <input type="hidden" id="rtiApplicationRefIds" name="rtiApplicationRefIds" value="${illegalWaterConnection.rtiRefId}" />
...
function saveEntity()
{
	onPageSubmit('<c:out value="${contextRoot}"/>/rtiapplication/createWaterIllegalComplaintWork.do');
}
	</script>
...
function saveFees() {
    ...
    var demanddoc = '${illegalWaterConnection.uploadedDemand}';

    if (feeId.val() !== '') {
       if (confirm('Are you sure you want to save?')) {
        var uid = $('#rtiApplicationRefIds').val();
        onPageSubmit('<c:out value="${contextRoot}"/>/rtsapplication/saveIllegalComplaintWater.do');
    ...
    function savePaymentStatus() {
       ...
       // var acknowledgementUpload = $('#acknowledgementUpload');
        ...
        if (payment.prop('checked')) {
            ...
            onPageSubmit('<c:out value="${contextRoot}"/>/rtsapplication/saveIllegalComplaintWaterPayment.do');
...
$(document).ready(function() {
    ...
    var feesApplicable = '${illegalWaterConnection.demandfees}';
    var demanddoc = '${illegalWaterConnection.uploadedDemand}';
    var workflowStatus = '${requestScope.rtiApplication.workFlowStatus}';
	...
	$(document).ready(function() {
	    ...
	    var workflowStatus = '${requestScope.rtiApplication.workFlowStatus}';
        var demanddoc = '${illegalWaterConnection.uploadedDemand}';
        var acknowledgementdoc = '${illegalWaterConnection.acknowledgement}';
    ...
    function uploadPoliceNoc1() {
        ...
        for (var i = 0; i < file.length; i++) {
   			...
   			const value = splitName + ".pdf";
                ...
                filesPath = filesPath + basePath + "illegalWaterConnection/" + i + value + ","
                isFileSelected = true;
            }
        }
        var appType = 1;
        var uid1 = document.getElementById('illegalWaterConnectionID').value;
        $.ajax({
            url: "<c:out value='${contextRoot}'/>/rtsapplication/uploadManageWaterIllegalConnectionComplaint.do?appType="+appType+"&UID="+uid1,
            type: 'POST',
            data: data,
            cache: false,
            dataType: 'json',
