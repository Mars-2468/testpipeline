...
<body>
	...
	<div class="container-fluid mt-2" style="width: 180vh">
            ...
            <div class="printable">
                <h3  class="text-center"><strong>Application For Trimming of Tree Branches(वृक्षांच्या फांद्या कापण्यासाठी परवानगी)</strong></h3>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="mb-3 mt-3">
                        ...
                        <input type="text" class="form-control waterRequired" style="background-image: none;"  name="lastname" id="last_name"  pattern="[A-Za-z]+" onchange="Display(this.id)" required>
                        <div class="invalid-feedback">
                ...
                <div class="col-md-3">
                    <div class="mb-3 mt-3">
                        ...
                        <input type="text" class="form-control waterRequired" style="background-image: none;"  id="full_name" placeholder="" name="fullName" readonly>
                    </div>
                </div>
                ...
                <div class="mb-3 mt-3">
                    ...
                    <input type="text" class="form-control" style="background-image: none;"  id="aadhaarNumber1" placeholder="" name="aadharNo" value=""
                    pattern="[0-9]{12}"
                     maxlength="12">
                     <div class="invalid-feedback">
            ...
            <div class="col-md-3">
                    <div class="mb-3 mt-3">
                        ...
                        <label for="email" class="form-label lbleng">Mobile No.(मोबाईल क्र.)<span class="text-danger" >*</span> </label>
                        <input type="text" class="form-control waterRequired " pattrn="[5-9]{1}[0-9]{9}" maxlength="10" style="background-image: none;"  id="mobileno" placeholder="" name="mobileNo" 
                            required>
                            <div class="invalid-feedback">
                ...
                <div class="col-md-3">
                    <div class="mb-3 mt-3">
                        ...
                        <input type="email" class="form-control waterRequired " style="background-image: none;"  id="email" placeholder="" name="email" 
                            required>
                            <div class="invalid-feedback">
                ...
                <div class="col-md-3">
                    <div class="mb-3 mt-3">
                        ...
                        <label for="email" class="form-label lbleng">Plot/ Flat No. (प्लॉट/फ्लॅट क्र.)<span class="text-danger" >*</span> </label>
                        <input type="text" class="form-control waterRequired " pattrn="[5-9]{1}[0-9]{9}" maxlength="10" style="background-image: none;"  id="plot_no" placeholder="" name="applicantPlotNo" 
                ...
                <div class="col-md-3">
                    <div class="mb-3 mt-3">
                        ...
                        <input type="text" class="form-control waterRequired" style="background-image: none;"  id="buildingName" placeholder="" name="applicantBuildingName" onchange="change(this.id)" >
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="mb-3 mt-3">
                        ...
                        <input type="text" class="form-control waterRequired" style="background-image: none;" id="street_name" placeholder="" name="applicantStreetName" onchange="change(this.id)" required>
                        <div class="invalid-feedback">
 ...
 <div class="col-md-3">
                ...
                <div class="col-md-3">
                    <div class="mb-3 mt-3">
                        <label for="" class="form-label lbleng">Name of the City(शहराचे नाव)<span class="text-danger" >*</span></label>

                        <input type="text" class="form-control waterRequired" style="background-image: none;" id="city" placeholder="" name="nameOfCity" value="Nagpur" onchange="change(this.id)" required>
                        <div class="invalid-feedback">
                            Please Enter  Valid Area Name.
                         </div>
                    </div>
                ...
                <div class="col-md-3">
                    <div class="mb-3 mt-3">
                        <label for="" class="form-label lbleng"> Landmark (लँडमार्क)</label>

                        <input type="text" class="form-control waterRequired" style="background-image: none;"  id="landmark" placeholder="" name="landmark" onchange="change(this.id)">
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="mb-3 mt-3">
                        ...
                        <input type="text" class="form-control waterRequired" style="background-image: none;" id = "pin_code" pattern="[0-9]{6}" name="pincode"
...
<div class="row">
   <!--  <div class="col-md-3">
    ...
    <div class="col-md-3">
        <div class="mb-3 mt-1">
        <label for="primary_full_address" class="form-label lbleng">Reason For Tree Trimming<br>(वृक्षांच्या फांद्या छाटण्यासाठी कारण)<span class="text-danger">*</span></label>
        <select class="form-select" style="background-image: none;" id="iFunction" name="resonetreetrimming" onchange="changeddl(this)" required>
            <option value="" selected="">-Select Reason For Tree Trimming-</option>
            <option value="Trimming down dangerous  branches"> Trimming down dangerous  branches </option>
            <option value="Obstruction to electrical wires"> Obstruction to electrical wires </option>
            <option value="Obstruction to Construction">Obstruction to Construction</option>
  ...
  Number of Tree Trimming<br>(वृक्ष छाटणीची संख्या)
  <span class="text-danger" style="color: red;">*</span>
</label>
  <input type="text" class="form-control" style="background-image: none;" id="number"  name="numberoftreetrimming" onchange="validateZero()" rows="4" oninput="calculate(); this.value = this.value.replace(/[^0-9]/g, '')" maxlength="2" required>
    <div class="invalid-feedback" id="zero-error">
      Please Enter Valid No. of Certificate Copies.
    </div>
</div>
  </div>-->
   ...
   <div class="col-md-3">
    <div class="mb-3 mt-1">
        <label for="" class="form-label lbleng">Number of Tree Trimming (वृक्ष छाटणीची संख्या)<span class="text-danger">*</span></label>
        <input type="text" class="form-control" style="background-image: none;" onchange="noOfTreeCal()" id="noOfTreeTrimming" placeholder="" name="numberoftreetrimming" maxlength="4" pattern="[0-9]+" required>
        <div class="invalid-feedback">
...
<script>
    ...
    <div class="mb-3 mt-3">
        ...
        <textarea class="form-control" oninput="validateTextarea()" style="background-image: none;"  rows="2" id="treeAddress" name="treeAddress" required></textarea>
        <div class="invalid-feedback" id="errorFeedback">
            Please enter a valid address.
        </div>
         </div>
     ...
     <div class="row">
            ...
            <div class="col-md-3">
                <div class="mb-0" style="margin-top: 24px;">
                    <label for="" class="form-label">Sanctioned plan of construction(बांधकामाचा मंजूर आराखडा)
             </label>
               ...
               <!--  <div class="col-md-3">
                ...
                <div class="col-md-3">
                    <div class="mb-3" style="margin-top: 48px;"> 
                        <label for="" class="form-label"> Photograph Of Tree  (वृक्षाचे छायाचित्र)<span class="text-danger"
                            style="color: red;">*</span></label>
      ...
      // 	data.append('idProof6', $("#city_survey5").get(0).files[0]);
            ...
            for (var i = 0; i < file.length; i++) {
       			...
       			const value = splitName + ".pdf";
                    ...
                    filesPath = filesPath + basePath + "TreeTrimmingApplication/" + id + value + ","
                    isFileSelected = true;
                }
            }
            $.ajax({
                url: "<c:out value='${contextRoot}'/>/rtsapplication/uploadTreeTrimming.do?id="+id,
                type: 'POST',
                data: data,
                cache: false,
                dataType: 'json',
...
<li>2.Sanctioned plan of construction(बांधकामाचा आराखडा मंजूर)</li>
