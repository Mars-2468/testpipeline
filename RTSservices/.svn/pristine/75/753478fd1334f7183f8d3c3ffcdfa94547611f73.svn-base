...
<script type="text/javascript">
	function editRTIApplication(id) {
		...
		onPageSubmit('<c:out value="${contextRoot}"/>/rtsapplication/editDikshaBhumiMandapPermission.do');
	}
	function searchRTIApplication() {
		onPageSubmit('<c:out value="${contextRoot}"/>/rtsapplication/listRTSDurgaUtsavMandapApplication.do');
	}
</script>
<style type="text/css">
.btn-success { -
