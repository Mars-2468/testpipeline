...
/**
 * <p>Title: WorkflowTemplateTaskDAO.java </p>

 * <p>Description: This interface is used for hibernate operations for WorkflowTemplateTask</p>
...
public interface WorkflowTemplateTaskDAO {
    ...
    /**
     * This method is used to delete a list of WorkflowTemplateTask records from the database.
     * 
     * @param listWorkflowTemplateTask as List
     */
