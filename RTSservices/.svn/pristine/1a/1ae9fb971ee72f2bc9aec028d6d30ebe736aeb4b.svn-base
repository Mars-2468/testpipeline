...
<script type="text/javascript">
	function editRTIApplication(id) {
		...
		onPageSubmit('<c:out value="${contextRoot}"/>/rtsapplication/editMTPRegistrationCertificate.do');
	}
...
<b style="color:green;">Citizen Form Approved.</b>
</c:if>
...
<b>Verified by PCPNDT Cell.</b>
</c:if>
<c:if test="${rtiApplnList.workFlowStatus==10}">
PCPNDT Cell Verification Approved by MHO.
</c:if>
<c:if test="${rtiApplnList.workFlowStatus==11}">
<b style="color:red !important;">Inspection Report uploaded.</b>
</c:if>
</td>
