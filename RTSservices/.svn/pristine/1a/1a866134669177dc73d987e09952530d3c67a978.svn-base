...
<div class="mainHdr">
    ...
    height: 30px;
		...
		<fmt:message key="Reassessment For Renovation" />
		:
...
<div valign="top" id="SetFormHeight">
	<input type="hidden" name="id"
		value="${propertyTaxAssessment.newlyConstructedPropertyId}">
	<c:set var="doc"
...
<tr>
			...
			<td colspan="2">
					...
					<input type="text" class="form-control" style="width: 180px"
						...
						value="<c:out value="${propertyTaxAssessment.houseNo}"/>" disabled/>
			</td>

			<td colspan="1.5"><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="Measle Number
							(गोवर क्र)" /></span><span class="ClsRequiredFields">:</span>
			</td>
			<td colspan="2">
					<input type="text" class="form-control" style="width: 180px"
						id="fatherName" maxlength="45" tabindex="4" name="fatherName"
						value="<c:out value="${propertyTaxAssessment.measleNo}"/>" disabled/>
				</td>
		...
		<td colspan="1.5"><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="Land /Plot No
							(जमीन / भूखंड क्र)" /></span><span class="ClsRequiredFields">:</span>
			</td>
			<td colspan="2">
					<input type="text" class="form-control" style="width: 180px"
						id="fatherName" maxlength="45" tabindex="4" name="fatherName"
						value="<c:out value="${propertyTaxAssessment.plotNo}"/>" disabled/>
				</td>
		...
		<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
			...
			<td colspan="2"><input type="text" class="form-control" style="width: 180px"
	...
	<td colspan="1.5"><span class="ClsLabel" style="font-size: 14px"><fmt:message
			...
			<td colspan="2">
					...
					<input type="text" class="form-control" style="width: 180px"
						id="childeName" maxlength="45" tabindex="3" name="childeName"
						value="<c:out value="${propertyTaxAssessment.mouje}"/>" disabled/>
			</td>
			...
			<td colspan="2"><input type="text" class="form-control"
				style="width: 180px" id="childeName" maxlength="45" tabindex="3"
				name="areasPendingStatus"
				value="<c:out value="${propertyTaxAssessment.areasPendingStatus}"/>"
				disabled /></td>
		...
		<td colspan="1.5"><span class="ClsLabel" style="font-size: 14px"><fmt:message
			...
			<td colspan="2"><input type="text" class="form-control"
				style="width: 180px" id="childeName" maxlength="45" tabindex="3"
				name="ownerName"
				value="<c:out value="${propertyTaxAssessment.areasPending}"/>"
				disabled /></td>
		...
		<tr>
			<td colspan="1.5"><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="Property Address
							(मालमत्तेचा पत्ता)" />:</span></td>
			<td colspan="2">

					<input type="text" class="form-control" style="width: 180px"
						id="childeName" maxlength="45" tabindex="3" name="childeName"
						value="<c:out value="${propertyTaxAssessment.propertyAddress}"/>" disabled/>
			</td>
...
<%--  <c:if test="${requestScope.rtiApplication.workFlowStatus==3 ||requestScope.rtiApplication.workFlowStatus==2 || requestScope.rtiApplication.workFlowStatus==1}">
   ...
   <c:if test="${not empty rtiApplication.propertyTaxCertificate}">
<tr>
<td>
              
               <a class="bg-button btn btn-success bd-highlight action" style="color:white" id=""  class="imagefile" type="button" target="_blank" href="<c:out value="${rtiApplication.propertyTaxCertificatet}"/>"><span
							class="download" style="align-items: center">Download</span></a>
</td>
</tr>
               </c:if>
...
<td colspan="4" align="center"><input type="button"
	...
	<input type="hidden" class="ClsTextbox_mr" style="width: 180px"
		...
		value="<c:out value="${propertyTaxAssessment.newlyConstructedPropertyId}"/>" /> 
...
<!-- <script type="text/javascript">
	function saveEntity() {
		...
		function saveEntity() {
			onPageSubmit('<c:out value="${contextRoot}"/>/rtiapplication/createNewlyConstructedPropertyWork.do');
		}
		...
		function saveFees(){
			...
			onPageSubmit('<c:out value="${contextRoot}"/>/rtsapplication/saveNewlyConstructedPropertyFees.do?id='+refId);
			}else{
				return false;
			}
			}else{
...
/*  	$(document).ready(function() {
 	    var paymentReceipt = '${propertyTaxAssessment.paymentReceipt}';
