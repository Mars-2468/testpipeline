...
<body>
    ...
    <form class="needs-validation" novalidate>
          <div class="container-fluid mt-2" style="width: 180vh">
           <div class="printable">
               <h3 class="text-center">Application Form For Trade Licence Name Change (व्यापार परवाना नाव बदलण्यासाठी अर्ज)					
         ...
         <div class="invalid-feedback">Please Enter Valid Updated Trade Type.
                        ...
                        <div class="col-md-3">
                            <div class="mb-3 mt-3">
                                ...
                                <input type="text" class="form-control" pattern="^\s*\S.*$" style="background-image: none;"id="" placeholder="" name="updatedOwnerName" value="" maxlength="100" pattern="^([A-Za-z]{0,})([A-Za-z]{1,}\s?)+$" required>
                                <div class="invalid-feedback">
...
.
            ...
            <div class="col-md-3">
						<div class="mb-3 mt-5">
							<label for="" class="form-label lbleng">Fees Applicable
								(शुल्क लागू)<span class="text-danger" style="color: red;">*</span>
							</label> <input type="text" class="form-control"
								style="background-image: none;" id="fees" placeholder=""
								name="feesApplicable" value="500" required readonly>
      	               ...
      	               if (!form.checkValidity() || !isFormValid) {
      	              	...
      	              	upload(function(status) {
      	              	    ...
      	              	    if (status === true || status === 'true') {
      	               		...
      	               		onPageSubmit('<c:out value="${contextRoot}"/>/rtsapplication/saveTradeLicenseNameChange.do');
      	              	    } 
	    ...
	    data.append('idProof3', $("#doc4").get(0).files[0]);
	       ...
	       for (var i = 0; i < file.length; i++) {
	  			...
	  			const value = splitName + ".pdf";
	               ...
	               filesPath = filesPath + basePath + "tradeLicenseNameChange/" + id + value + ","
	               isFileSelected = true;
	           }
	       }
	       $.ajax({
	                url: "<c:out value='${contextRoot}'/>/rtiapplication/uploadDocumentTradeLicenseNameChange.do?id="+id,
	           type: 'POST',
	           data: data,
	           cache: false,
	           dataType: 'json',
