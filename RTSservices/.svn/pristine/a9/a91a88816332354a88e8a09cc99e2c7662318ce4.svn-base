    	...
    	<div class="row">
        	<div class="col-md-6 d-flex align-items-center">
            	<ol class="breadcrumb bg-white pb-0">
                    <li class="breadcrumb-item"><a href='<c:out value="${contextRoot}"/>/ws/nmc/dashboard.do'><strong>मुख्यपृष्ठ</strong></a></li>
                    <li class="breadcrumb-item active"><strong>पशुवैद्यकीय विभाग</strong></li>
...
<div class="container-fluid my-3" >
	<div class="container" >
    	<div class="row mb-4">
            <div class="col-md-3">
                 <a class="card" style="width: 262px;height:106px" href='<c:out value="${contextRoot}"/>/ws/rtiapplication/newRTIDogLicence.do'>
                    <div class="card-body d-flex align-items-top justify-content-between">                    			 
                                  <span class="title-width platform-title"> <p class="h5"><strong>श्वान परवाना नोंदणी प्रमाणपत्र
                                  </strong></p></span>
                                    <p class="image-icon d-inline-block m-0 mr-0 float-right"><img src="<%=url%>img/Dog1.png"></p>
                                    </div>
                </a>
            </div>
            ...
            <div class="col-md-3">
                <a class="card" style="width: 262px;height:106px" href='<c:out value="${contextRoot}"/>/ws/rtiapplication/newRTIDogRenewalLicence.do'>
                    <div class="card-body d-flex align-items-top justify-content-between">                    			 
                                  <span class="title-width platform-title"><p class="h5 m-0"><strong>श्वान परवाना नोंदणी प्रमाणपत्र नूतनीकरण
                                   </strong></p></span>
                                    <p class="image-icon d-inline-block m-0 mr-0 float-right"><img src="<%=url%>img/dogRenewal.png"></p>                               
            ...
            <%-- <div class="col-md-3">
                 <a class="card" href='<c:out value="${contextRoot}"/>/ws/rtsapplication/newRTIMarriageApplication.do'>
                
                    <div class="card-body d-flex align-items-top justify-content-between">                    			 
                                  <span class="title-width platform-title"><p class="h5 m-0">Marriage<br>Certificate</p></span>
