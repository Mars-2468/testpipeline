...
<div id="SearchDivId" class="ClsSearch">
		...
		<table id="SearchTable" class="searchForm" style="display:none;" width="98%">
			<tr>
				<td style="width: 200px"><span class="ClsLabel">Registration Date Between </span></td>
			<td style="width: 300px">
					<input type="text" class="ClsTextboxDate" id="registrationFromDate" style="width:100px;height:20px"  name="registrationFromDate"   value="${registrationFromDate}"    /> - 
						
					<input type="text" class="ClsTextboxDate" id="registrationToDate"  style="width:100px;height:20px" name="registrationToDate" value="${registrationToDate}"   />
				</td>
				...
				<td>
					<input type="submit" class="ClsButton" id="search" name="search" value="   <fmt:message key="common.button.search"/>   " onclick="javascript:search()" />
					
				</td>			
			</tr>
			
		</table>
		<c:if test="${registrationFromDate !=null || registrationToDate!=null || category!=null}">
			<script>
...
<h2 style="text-align:center">RTI Applications Data</h2>


<div class="columns">
  <ul class="price">
    <li class="header" style="background-color:#4CAF50">New Receipts</li>
    <li class="grey">${newReciepts}</li>
