...
<h2 style="text-align:center">Death Applications Data</h2>
...
'#33B7FF' 
 ...
 function search()
 {
 	onPageSubmit('<c:out value="${contextRoot}"/>/dashBoard/death.do');
 }
 ...
 function getListOnCategory(category){
	 ...
	 onPageSubmit('<c:out value="${contextRoot}"/>/dashBoard/getDeathListOnCategory.do');
