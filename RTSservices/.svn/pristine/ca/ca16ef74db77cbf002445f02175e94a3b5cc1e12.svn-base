...
<div class="row">
  ...
  <option value="<c:out value="${contextRoot}"/>/dashBoard/firerecommendation.do">Fire Recommendation</option>
  <option value="<c:out value="${contextRoot}"/>/dashBoard/compliancecertificate.do">Compliance Certificate For Existing Building</option>
</select>
...
<table id="recordId" cellpadding="0" cellspacing="1" width="100%" class="dataGrid">
			<thead>
				<tr>
...
function ExportToExcel(recordId){
       var htmltable= document.getElementById('recordId');
...
'#33B7FF' 
 ...
 function getListOnCategory(category){
	 ...
	 onPageSubmit('<c:out value="${contextRoot}"/>/dashBoard/getfireDeptListOnCategory.do');
