...
<div class="container">
<h2 style="text-align:center">Dog License Renewal Applications Data</h2>
...
'#33B7FF' 
 ...
 function getListOnCategory(category){
	 ...
	 onPageSubmit('<c:out value="${contextRoot}"/>/dashBoard/getDogLicenseRenewalListOnCategory.do');
