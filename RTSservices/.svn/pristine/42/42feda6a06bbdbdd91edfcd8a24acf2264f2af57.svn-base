...
@Service
public class TaxDeptDashboardServiceImpl implements TaxDeptDashboardService{
				private static final Log log = LogFactory.getLog(HealthDeptDashboardServiceImpl.class);
			
			@Autowired
			private TaxDeptDashboardDAO taxDeptDashboardDAO;
			...
			public long getPieChartOrBarChartData() {
				...
				return taxDeptDashboardDAO.getPieChartOrBarChartData();
			}
			@Override
			public long getPieChartOrBarChartData(String condValue) {
				...
				return taxDeptDashboardDAO.getPieChartOrBarChartData(condValue);
			}
			@Override
			public long getPieChartOrBarChartData(String condValue1,
				...
				return taxDeptDashboardDAO.getPieChartOrBarChartData(condValue1, condValue2,condValue3);
			}
			...
			public List<BigInteger> getPieChartOrBarChartBasedOnSearch(
				...
				return taxDeptDashboardDAO.getPieChartOrBarChartBasedOnSearch(registrtionFromDate, registrtionToDate, category);
			}
			...
			public List<RTIApplication> getRTIApplicationListByLabel(
				...
				return taxDeptDashboardDAO.getRTIApplicationListByLabel(dashBoardLabelSearch);
			}
			...
			public long getRTIApplicationCountByLabel(
				...
				return taxDeptDashboardDAO.getRTIApplicationCountByLabel(dashBoardLabelSearch);
			}
			@Override
			public double getPieChartOrBarChartDatas(){
				...
				// TODO Auto-generated method stub
					...
					return taxDeptDashboardDAO.getPieChartOrBarChartDatas();
