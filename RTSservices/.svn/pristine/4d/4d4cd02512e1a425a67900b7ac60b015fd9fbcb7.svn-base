...
<h2 style="text-align:center">Dog License Applications Data</h2>
...
'#33B7FF' 
 ...
 function search()
 {
 	onPageSubmit('<c:out value="${contextRoot}"/>/dashBoard/dogLicense.do');
 }
 ...
 function getListOnCategory(category){
	 ...
	 onPageSubmit('<c:out value="${contextRoot}"/>/dashBoard/getDogListOnCategory.do');
