...
<div class="mainHdr">
	<h3> 
				...
				<fmt:message key="Application form for New Trade Licence "/> 				
...
<input type="hidden" name="id"
		value="${tradeLicenceNew.tradeNewId}">
	...
	<td><input type="text" class="form-control" style="width: 180px"
			...
			<td><input type="text" class="form-control" style="width: 180px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${tradeLicenceNew.lastName}"/>" /></td>
			...
			<td><input type="text" class="form-control" style="width: 180px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${tradeLicenceNew.fullName}"/>" /></td>
		...
		<tr>
		 ...
		 <td><span class="ClsLabel" style="font-size: 14px"><fmt:message
			...
			<td><input type="text" class="form-control" style="width: 170px"
				...
				value="<c:out value="${tradeLicenceNew.pinCode}"/>" />
				&nbsp;</td>
		 ...
		 <td><span class="ClsLabel" style="font-size: 14px"><fmt:message
			...
			<td><input type="text" class="form-control" style="width: 170px"
				id="changedHospitalNameAndAddress" maxlength="30"
				name="changedHospitalNameAndAddress"
				value="<c:out value="${tradeLicenceNew.aadhaarNo}"/>" />
				&nbsp;</td>
			...
			<td><input type="text" class="form-control" style="width: 230px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${tradeLicenceNew.email}"/>" /></td>
          ...
          <td><span class="ClsLabel" style="font-size: 14px"><fmt:message
			...
			<td><input type="text" class="form-control" style="width: 170px"
				id="changedHospitalNameAndAddress" maxlength="30"
				name="changedHospitalNameAndAddress"
				value="<c:out value="${tradeLicenceNew.mobileNo}"/>" />
				&nbsp;</td>
			...
			<td><input type="text" class="form-control" style="width: 170px"
				id="changedHospitalNameAndAddress" maxlength="30"
				name="changedHospitalNameAndAddress"
				value="<c:out value="${tradeLicenceNew.address}"/>" />
				&nbsp;</td>
			...
			<td><input type="text" class="form-control" style="width: 180px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${tradeLicenceNew.nameOfBusiness}"/>" /></td>
</tr>
<tr>
			 <td><span class="ClsLabel" style="font-size: 14px"><fmt:message
			...
			<td><input type="text" class="form-control" style="width: 180px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${tradeLicenceNew.businessDetails}"/>" /></td>
			...
			<td><input type="text" class="form-control" style="width: 170px"
				id="changedHospitalNameAndAddress" maxlength="30"
				name="changedHospitalNameAndAddress"
				value="<c:out value="${tradeLicenceNew.businesDoneDate}"/>" />
				&nbsp;</td>
</tr>
<tr>
			 <td><span class="ClsLabel" style="font-size: 14px"><fmt:message
			...
			<td><input type="text" class="form-control" style="width: 180px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${tradeLicenceNew.spaceType}"/>" /></td>
			...
			<td><input type="text" class="form-control" style="width: 170px"
				id="changedHospitalNameAndAddress" maxlength="30"
				name="changedHospitalNameAndAddress"
				value="<c:out value="${tradeLicenceNew.length}"/>" />
				&nbsp;</td>
 </tr>
 <tr>
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
			...
			<td><input type="text" class="form-control" style="width: 180px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${tradeLicenceNew.height}"/>" /></td>
			...
			<td><input type="text" class="form-control" style="width: 170px"
				id="changedHospitalNameAndAddress" maxlength="30"
				name="changedHospitalNameAndAddress"
				value="<c:out value="${tradeLicenceNew.width}"/>" />
				&nbsp;</td>
</tr>
<tr>
			 <td><span class="ClsLabel" style="font-size: 14px"><fmt:message
			...
			<td><input type="text" class="form-control" style="width: 180px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${tradeLicenceNew.zoneNo}"/>" /></td>
			...
			<td><input type="text" class="form-control" style="width: 170px"
				id="changedHospitalNameAndAddress" maxlength="30"
				name="changedHospitalNameAndAddress"
				value="<c:out value="${tradeLicenceNew.wardNo}"/>" />
				&nbsp;</td>
</tr>
<tr>
			 <td><span class="ClsLabel" style="font-size: 14px"><fmt:message
			...
			<td><input type="text" class="form-control" style="width: 180px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${tradeLicenceNew.areaName}"/>" /></td>
			...
			<td><input type="text" class="form-control" style="width: 180px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${tradeLicenceNew.businessUsagePlace}"/>" /></td>
		...
		<tr>
			...
			<td><input type="text" class="form-control" style="width: 230px"
				id="changedHospitalNameAndAddress" maxlength="30"
				name="changedHospitalNameAndAddress"
				value="<c:out value="${tradeLicenceNew.updatedTradeType}"/>" />
				&nbsp;</td>

			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicenserenewal.fees" /><span class="ClsRequiredFields"></span>:
			</td>
			<td><input type="text" class="form-control" style="width: 180px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${tradeLicenceNew.fees}"/>" /></td>
...
<tr>
	       <td colspan="6" align="center">
                      ...
                      <button class="ClsButton clsButtonUpload" onclick="download(${tradeLicenceNew.rti_ref_id},'tradeLicenseNewCertificateReport.do')">GENERATE CERTIFICATE</button>
...
<c:if test="${requestScope.rtiApplication.workFlowStatus==2}">
				...
				<tr>
					<td colspan="6" align="center"><a
						...
						onclick="downloads('${tradeLicenceNew.rti_ref_id}', 'tradeLicenseNewCertificateReport.do');"
						type="button" target="_blank"> <span class="download"
							style="display: flex; align-items: center;width: 160px;">Generate
								Certificate</span>
											...
											onclick="download1(${tradeLicenceNew.rti_ref_id});return false;"><span
        ...
        <tr>
            <!-- <td colspan="6" style="padding-top:5px">
                <img src="../images/Transpx.gif" height="15px" />
                     ...
                     <tr>
                     <td colspan="4">
                      <span class="ClsLabel" style="font-size:14px"><fmt:message key="List of Documents (Attachment) For TradeLicence New" />:</span>
                     </td>
                     </tr>
...
<a class="ClsButton" type="button" target="_blank" href="<c:out value="${doc[1]}"/>"><span style="margin-left:20px;">Download</span></a>                    
                     </td>
                     </tr> --%>
...
<input type="hidden" class="ClsTextbox" style="width:180px" id="rtiapplrefno" maxlength="12" name="rtiapplrefno" value="<c:out value="${treeTrimming.rtiapplrefno}"/>" /> --%>
 ...
 <input type="hidden" class="ClsTextbox" id="tradeNewId" style="width:180px"  name="tradeNewId" value="<c:out value="${tradeLicenceNew.tradeNewId}"/>" />
    <input type="hidden" id="rtiApplicationRefId" name="rtiApplicationRefId" value="" />
    			  			  <input type="hidden" id="rtiApplicationRefIds" name="rtiApplicationRefIds" value="${tradeLicenceNew.rti_ref_id}" />
...
function saveEntity()
{
	onPageSubmit('<c:out value="${contextRoot}"/>/rtiapplication/createTradeLicenceNewWork.do');
}
