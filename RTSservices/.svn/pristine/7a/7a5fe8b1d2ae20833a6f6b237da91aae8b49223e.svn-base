...
/**
 * <p>Title: BankBranchDAO.java </p>

 * <p>Description: This interface is used for hibernate operations for BankBranch</p>
...
public interface BankBranchDAO {
    ...
    /**
     * This method is used to delete a list of BankBranch records from the database.
     * 
     * @param listBankBranch as List
     */
