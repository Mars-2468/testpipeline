...
<body>
    ...
    <form class="needs-validation" novalidate>
          <div class="container-fluid mt-2" style="width: 180vh">
           <div class="printable">
               <h3 class="text-center">Application Form For Trade License Cancellation (व्यापार परवाना रद्द करण्यासाठी अर्ज)						
        ...
        <div class="col-md-3">
            <div class="mb-3 mt-3">
                ...
                maxlength="80"    pattern="[A-Za-z]+" onchange="Display(this.id)" required>
                <div class="invalid-feedback">
        ...
        <div class="col-md-3">
        <div class="mb-3 mt-3">
            <label for="" class="form-label lbleng"> Aadhaar No.(आधार क्र.)
            </label>
...
function validateTextarea() {
  ...
  if (regex.test(text)) {
    ...
    errorFeedback.style.display = 'block';
          ...
          <br>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="mb-3 mt-3">
                            <label for="" class="form-label lbleng">Zone No. (झोन क्र.)<span class="text-danger"
                                    style="color: red;">*</span> </label>
                        ...
                        <div class="col-md-3">
                            <div class="mb-3 mt-3">
                                ...
                                <input type="text" class="form-control"  style="background-image: none;"id="" placeholder="" name="tradeLicenceNo" maxlength="100"value="" required>
                                <div class="invalid-feedback">
                        ...
                        <div class="col-md-3">
                            <div class="mb-3 mt-3" style="margin-top: 40px">
                                <label for="" class="form-label lbleng">Updated Trade Name (अद्यतनित व्यापार नाव)</label>
            
                                <input type="text" class="form-control"  style="background-image: none;"id="" placeholder=""maxlength="100" name="updateTradeName" pattern="^([A-Za-z]{0,})([A-Za-z]{1,}\s?)+$" value="">
         ...
         <div class="invalid-feedback">Please Enter Valid Updated Trade Type.
                        ...
                        <div class="col-md-3">
                            <div class="mb-3 mt-3">
                                ...
                                <input type="text" class="form-control" maxlength="100" style="background-image: none;"id="" placeholder="" name="updatedOwnerName" value="" pattern="^([A-Za-z]{0,})([A-Za-z]{1,}\s?)+$" >
                                <div class="invalid-feedback">
    ...
    <input type="number" class="form-control" maxlength="3" style="background-image: none;" id="" placeholder="" name="updatedPartnerCount" value="" >
    <div class="invalid-feedback">
        Please enter a valid updated partner count.
    </div>
</div>
                         ...
                         <div class="col-md-3">
                            <div class="mb-3 mt-3">
                                ...
                                <input type="text" value ="500" class="form-control" style="background-image: none;" id="" maxlength="100" placeholder="" name="feesApplicable" readonly>
                            </div>
                        </div>
            ...
            <div class="col-md-3">
                <div class="mb-3 " style="margin-top: 96px;">
    ...
    for (var i = 0; i < file.length; i++) {
		...
		const value = splitName + ".pdf";
		 if(value==='' && value===undefined){
            ...
            filesPath = filesPath + basePath + "tradeLicenseCancellation/" + i + value + ","
            isFileSelected = true;
        }
    }
    $.ajax({
        url: "<c:out value='${contextRoot}'/>/rtiapplication/uploadDocumentTradeLicenseCancellation.do",
        type: 'POST',
        data: data,
        cache: false,
        dataType: 'json',
