...
@Repository
public class FireDeptDashboardDAOImpl extends HibernateDaoSupport implements FireDeptDashboardDAO{


		
			private static final Log log = LogFactory.getLog(FireDeptDashboardDAOImpl.class);
