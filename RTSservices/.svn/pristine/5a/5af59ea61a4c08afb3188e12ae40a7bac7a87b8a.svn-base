...
<body>
    ...
    <form class="needs-validation" novalidate>
          <div class="container-fluid mt-2" style="width: 180vh">
           <div class="printable">
               <h3 class="text-center">Application Form For Trade License Cancellation (व्यापार परवाना रद्द करण्यासाठी अर्जाचा नमुना)						
        ...
        <div class="col-md-3">
            <div class="mb-3 mt-3">
                <label for="" class="form-label lbleng">Last Name (आडनाव)<span class="text-danger"
					...
					<div class="mb-3 mt-4">
                        ...
                        <div class="col-md-3">
                            <div class="mb-3 mt-3">
                                ...
                                <input type="text" class="form-control"  style="background-image: none;"id="" placeholder="" name="nameOfArea"maxlength="100" value=""  >
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="mb-3 mt-3">
                                <label for="" class="form-label lbleng">Trade Licence No.<span class="text-danger" style="color: red;" >*</span></label>
            
                                <input type="text" class="form-control"  style="background-image: none;"id="" placeholder="" pattern="^\s*\S.*$"name="tradeLicenceNo" maxlength="100"value="" required>
                                <div class="invalid-feedback">
                        ...
                        <div class="col-md-3">
                            <div class="mb-3" style="margin-top: 40px">
                                ...
                                <input type="text" class="form-control"  style="background-image: none;"id="" placeholder="" name="updateTradeName" pattern="^\s*\S.*$"pattern="^([A-Za-z]{0,})([A-Za-z]{1,}\s?)+$" maxlength="100" value="">
    ...
    <div class="mb-3 mt-3">
        ...
        <select class="form-select" style="background-image: none;" id="trade" name="updatedTradeType" onchange="tradeLicense(this.id)" required>
         ...
         <div class="invalid-feedback">Please Enter Valid Updated Trade Type.
                        ...
                        <div class="col-md-3">
                            <div class="mb-3 mt-3">
                                <label for="" class="form-label lbleng">Updated Owner/Partner Name (अपडेट केलेले मालक/भागीदाराचे नाव)<span class="text-danger"
                                        style="color: red;">*</span></label>
            
                                <input type="text" class="form-control"  style="background-image: none;"id="" pattern="^\s*\S.*$"placeholder="" name="updatedOwnerName" value="" pattern="[A-Za-z]+" maxlength="100" required>
                                <div class="invalid-feedback">
                        ...
                        <div class="col-md-3">
                            <div class="mb-3 mt-3">
                                <label for="" class="form-label lbleng">Updated Partner Count (अद्यतनित भागीदार संख्या)<span class="text-danger"
                                        style="color: red;">*</span></label>
            
                                <input type="number" class="form-control"  style="background-image: none;"id="" placeholder=""pattern="^\s*\S.*$" maxlength="3" name="updatedPartnerCount" value="" required>
                                <div class="invalid-feedback">
                                    Please Enter Valid Updated the Partner Count .
                                </div>
                            </div>
                        </div>
                         ...
                         <div class="col-md-3">
                            <div class="mb-3 mt-3">
                                ...
                                <input type="text" value ="500" class="form-control" style="background-image: none;" id="" placeholder="" name="feesApplicable" readonly>
                            </div>
                        </div>
			...
			<div class="col-md-3">
                <div class="mb-3 mt-4">
                    <label for="" class="form-label">NOC for the related department issued from the NMC/Department Officer/Govt/Semi Govt. Officer<span class="mand_error"
                            style="color: red;">*</span> 
</label>
            ...
            <div class="col-md-3">
                <div class="mb-3 " style="margin-top: 50px;">
                    <label for="" class="form-label lbleng">Copy of the Former Licence (पूर्वीच्या परवान्याची प्रत)<span
                            class="mand_error" style="color: red;"  >*</span></label>

                    <input type="file" class="form-control"  style="background-image: none;" id="doc2" accept=".pdf" placeholder="" name="copyOfFormerLicence" required>
                    <div class="invalid-feedback">
                        File selected is either greater than 2Mb or not of type .pdf.
                    </div>
            ...
            <div class="col-md-3">
                <div class="mb-3 "style="margin-top: 25px;">
                    <label for="" class="form-label lbleng">No Dues Certificate for Property Tax (मालमत्ता करासाठी कोणतेही देय प्रमाणपत्र नाही)</label>

                    <input type="file" class="form-control"  style="background-image: none;" id="doc3" accept=".pdf" placeholder="" name="propertyTaxNoDue" >
                </div>
            </div>
			<div class="col-md-3">
                <div class="mb-3"style="margin-top: 50px">
            ...
            Array.from(forms).forEach(form => {
                form.addEventListener('submit', event => {
                    ...
                    if (!form.checkValidity() || !isFormValid) {
               		...
               		onPageSubmit('<c:out value="${contextRoot}"/>/rtsapplication/saveTradeLiCenseCancellation.do');
                   	    } else {
        ...
        function upload(callback) {
            ...
            for (var i = 0; i < file.length; i++) {
       			...
       			const value = splitName + ".pdf";
                    ...
                    filesPath = filesPath + basePath + "tradeLicenseCancellation/" + id + value + ","
                    isFileSelected = true;
                }
            }
            $.ajax({
                url: "<c:out value='${contextRoot}'/>/rtiapplication/uploadDocumentTradeLicenseCancellation.do?id="+id,
                type: 'POST',
                data: data,
                cache: false,
                dataType: 'json',
