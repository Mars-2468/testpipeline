...
@Entity
@Table(name = "durga_utsav_mandap_permission", schema = "egovrti")
public class DurgaUtsavMandapPermission {

	@Id
	@Column(name = "durga_utsav_mandap_permission_id", nullable = false, unique = true)
	@SequenceGenerator(name = "durga_utsav_mandap_permissionId_seq", sequenceName = "durga_utsav_mandap_permissionId_seq")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "durga_utsav_mandap_permissionId_seq")
	private long durgaUtsavMandapPermissionId;
	...
	@Column(name = "durga_utsav_visarjan", nullable = true)
	private String durgaUtsavVisarjan;
	
	@Column(name = "durga_utsav_immersion", nullable = true)
	private String durgaUtsavImmersion;
	...
	public long getDurgaUtsavMandapPermissionId() {
		return durgaUtsavMandapPermissionId;
	}

	public void setDurgaUtsavMandapPermissionId(long durgaUtsavMandapPermissionId) {
		this.durgaUtsavMandapPermissionId = durgaUtsavMandapPermissionId;
	}
	...
	public String getDurgaUtsavVisarjan() {
		return durgaUtsavVisarjan;
	}

	public void setDurgaUtsavVisarjan(String durgaUtsavVisarjan) {
		this.durgaUtsavVisarjan = durgaUtsavVisarjan;
	}

	public String getDurgaUtsavImmersion() {
		return durgaUtsavImmersion;
	}

	public void setDurgaUtsavImmersion(String durgaUtsavImmersion) {
		this.durgaUtsavImmersion = durgaUtsavImmersion;
	}
