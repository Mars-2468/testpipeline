...
@Entity
@Table(name = "property_assessment_transcript", schema = "egovrti")
public class PropertyAssessmentTrasScript {

	@Id
	@Column(name = "property_assessment_id", nullable = false, unique = true)
	@SequenceGenerator(name = "propertyassessment_seq", sequenceName = "propertyassessment_seq", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "propertyassessment_seq")

	private long propertyAssessmentID;
	...
	public long getPropertyAssessmentID() {
		return propertyAssessmentID;
	}

	public void setPropertyAssessmentID(long propertyAssessmentID) {
