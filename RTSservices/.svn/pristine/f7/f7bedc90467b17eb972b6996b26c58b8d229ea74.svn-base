...
//import com.mars.rti.ws.model.NursingHomeRestDTO;
//
//@Controller
//public class NursingHomeRestController {
//	private static Log log = LogFactory.getLog(NursingHomeRestController.class);
//
//	@Autowired
...
//	
//	@RequestMapping(method = RequestMethod.POST, value ="/saveNursingHome")
//	public @ResponseBody NursingHomeRestDTO saveNursingHome(@RequestBody NursingHomeRestDTO nursingHomeRestDTO, HttpServletRequest request,
...
//	
//			if (nursingHomeRestDTO.getOpd() != null && !nursingHomeRestDTO.getOpd().isEmpty()) {
//				nursingHomes.setOpd(nursingHomeRestDTO.getOpd());
//			} else {
//				errorMessage.append("OPD details field is required, ");
//				condition = false;
//			}
//
//			if (nursingHomeRestDTO.getIpd() != null && !nursingHomeRestDTO.getIpd().isEmpty()) {
//				nursingHomes.setIpd(nursingHomeRestDTO.getIpd());
//			} else {
//				errorMessage.append("IPD details field is required, ");
//				condition = false;
//			}
//			
//			
...
//         
//         
//         if (nursingHomeRestDTO.getCertificate_of_medical_file() != null
// 				&& !nursingHomeRestDTO.getCertificate_of_medical_file().isEmpty()) {
// 			files[4] = nursingHomeRestDTO.getCertificate_of_medical_file();
// 		} else {
// 			errorMessage.append("Certificate of Medical Education is required, ");
// 			condition = false;
// 		}
//
// 		if (nursingHomeRestDTO.getMmc_file() != null && !nursingHomeRestDTO.getMmc_file().isEmpty()) {
// 			files[5] = nursingHomeRestDTO.getMmc_file();
// 		} else {
...
// 			files[6] = nursingHomeRestDTO.getMnc_file();
// 		} else {
...
// 			files[7] = nursingHomeRestDTO.getBio_medical_file();
// 		} else {
...
// 			files[8] = nursingHomeRestDTO.getFire_noc_file();
// 		} else {
...
// 			files[9] = nursingHomeRestDTO.getPollution_file();
// 		} else {
...
// 			files[10] = nursingHomeRestDTO.getWater_tax_file();
// 		} else {
// 			errorMessage.append("Current year property tax and water tax payment receipt is required, ");
// 			condition = false;
// 		}
//
//// 		if (nursingHomeRestDTO.getPermission_map_file() != null
//// 				&& !nursingHomeRestDTO.getPermission_map_file().isEmpty()) {
//// 			files[11] = nursingHomeRestDTO.getPermission_map_file();
//// 		} else {
//// 			errorMessage.append("Building Permission and Map  is required, ");
//// 			condition = false;
//// 		}
////
//// 		if (nursingHomeRestDTO.getOccupancy_file() != null && !nursingHomeRestDTO.getOccupancy_file().isEmpty()) {
//// 			files[12] = nursingHomeRestDTO.getOccupancy_file();
//// 		} else {
//// 			errorMessage.append("Occupancy certificate and Occupancy Map is required, ");
//// 			condition = false;
//// 		}
////
//// 		if (nursingHomeRestDTO.getNotarized_file() != null && !nursingHomeRestDTO.getNotarized_file().isEmpty()) {
//// 			files[13] = nursingHomeRestDTO.getNotarized_file();
//// 		} else {
//// 			errorMessage.append("Notarized Affidavit regarding Parking is required, ");
//// 			condition = false;
//// 		}
////
//// 		if (nursingHomeRestDTO.getRegistered_rent_agreement() != null
//// 				&& !nursingHomeRestDTO.getRegistered_rent_agreement().isEmpty()) {
//// 			files[14] = nursingHomeRestDTO.getRegistered_rent_agreement();
//// 		} else {
//// 			errorMessage.append("Registered rent agreement is required, ");
//// 			condition = false;
//// 		}
////
//// 		if (nursingHomeRestDTO.getTrust_registration_file() != null
//// 				&& !nursingHomeRestDTO.getTrust_registration_file().isEmpty()) {
//// 			files[15] = nursingHomeRestDTO.getTrust_registration_file();
//// 		} else {
//// 			errorMessage.append("Trust Registration certificate is required, ");
//// 			condition = false;
//// 		}
////
//// 		if (nursingHomeRestDTO.getSign_and_date_file() != null
//// 				&& !nursingHomeRestDTO.getSign_and_date_file().isEmpty()) {
//// 			files[16] = nursingHomeRestDTO.getSign_and_date_file();
//// 		} else {
...
//				nursingHomeRestDTO.setCertificate_of_medical_file("");
...
////				nursingHomeRestDTO.setPermission_map_file("");
////				nursingHomeRestDTO.setOccupancy_file("");
////				nursingHomeRestDTO.setNotarized_file("");
////				nursingHomeRestDTO.setRegistered_rent_agreement("");
////				nursingHomeRestDTO.setTrust_registration_file("");
