...
<div class="row">
  ...
  <option value="<c:out value="${contextRoot}"/>/dashBoard/propertyTaxUtara.do">Property Tax Utara</option>
  <option value="<c:out value="${contextRoot}"/>/dashBoard/propertyTaxNoDues.do">Property Tax No Dues Certificate</option>
  <option value="<c:out value="${contextRoot}"/>/dashBoard/propertyTransferRegistration.do">Property Transfer Registration </option>
<option value="<c:out value="${contextRoot}"/>/dashBoard/propertyNewTaxRecovery.do">New Tax Recovery (Mutation)</option>
  <option value="<c:out value="${contextRoot}"/>/dashBoard/propertyAssesmentTranscript.do">Property Assessment Transcript </option>
  <option value="<c:out value="${contextRoot}"/>/dashBoard/PropertyTaxDemand.do">Provide the Property Tax Demand</option>
<option value="<c:out value="${contextRoot}"/>/dashBoard/propertyTaxExemption.do">Tax Exemption</option>
  <option value="<c:out value="${contextRoot}"/>/dashBoard/propertyTaxExemptionNonResidential.do">Tax Exemption For Non-Residential Property </option>
  <option value="<c:out value="${contextRoot}"/>/dashBoard/propertySelfAssessment.do">Self Assessment</option>
<option value="<c:out value="${contextRoot}"/>/dashBoard/propertyComplaintRegistration.do">Property Complaint Registration</option>
  <option value="<c:out value="${contextRoot}"/>/dashBoard/partitionOfProperty.do">Partition Of Property</option>
  <option value="<c:out value="${contextRoot}"/>/dashBoard/newlyConstructedProperty.do">Newly Constructed Property</option>
</select>
...
'#33B7FF' 
 ...
 function search()
 {
 	//onPageSubmit('<c:out value="${contextRoot}"/>/dashboard/taxDept.do');
 }
 ...
 function getListOnCategory(category){
	 ...
	 onPageSubmit('<c:out value="${contextRoot}"/>/dashBoard/getTaxDeptListOnCategory.do');
