    	...
    	<div class="row">
        	<div class="col-md-6 d-flex align-items-center">
            	<ol class="breadcrumb bg-white pb-0">
                    ...
                    <li class="breadcrumb-item active" style="font-size:16px;"><strong>अग्निशमन विभाग</strong></li>
	...
	<div class="container">
    	<div class="row mb-4">
                 ...
                 <a class="card" style="width: 258px;height:96px" href='<c:out value="${contextRoot}"/>/ws/rtiapplication/newRTSFireRecommendationLetter.do'>
                    <div class="card-body d-flex align-items-top justify-content-between">                    			 
                                  <span class="title-width platform-title"> <p class="h5 m-0"><strong>अग्निशमन ना-हरकत दाखला देणे (तात्पुरते)</strong></p></span>
                                   <p class="image-icon d-inline-block m-0 mr-0 float-right"><img src="<%=url%>img/fireRecommendation.png"></p>                               
           ...
           <!--  <div class="col-md-3">
                <a class="card border">
                    <div class="card-body d-flex align-items-top justify-content-between">                    			 
                                  <span class="title-width platform-title"><p class="h5 m-0">Compliance Certificate<br>for Existing Building </p></span>
             ...
             <div class="col-md-3">
                <a class="card" style="width: 258px;height:96px" href='<c:out value="${contextRoot}"/>/ws/rtiapplication/newRTIFireComplianceCertificateApplication.do'>
                    <div class="card-body d-flex align-items-top justify-content-between">                    			 
                                  <span class="title-width platform-title"><p class="h5 m-0"><strong>अग्निशमन ना-हरकत दाखला देणे (अंतिम)</strong></p></span>
                                   <p class="image-icon d-inline-block m-0 mr-0 float-right"><img src="<%=url%>img/complainceFireNOC.png"></p>                               
