...
@Repository
public class TradeNameChangeDashboardDAOImpl extends HibernateDaoSupport implements TradeNameChangeDashboardDAO{
			
		
				private static final Log log = LogFactory.getLog(TradeNameChangeDashboardDAOImpl.class);
					...
					public long getPieChartOrBarChartData() {
						...
						try{
							...
							String fromClause="select count(r) from RTIApplication r where rti_service_id=34";
					...
					public long getPieChartOrBarChartData(String condValue) {
						...
						try{
							...
							StringBuffer sql=new StringBuffer();
							String fromClause="select count(r) from RTIApplication r where r.finalStatus='"+condValue+"' and rti_service_id=34";
					...
					public long getPieChartOrBarChartData(String condValue1,
						...
						try{
							...
							StringBuffer sql=new StringBuffer();
							String fromClause="select count(r) from RTIApplication r where r.finalStatus not in ('"+condValue1+"','"+condValue2+"','"+condValue3+"')and rti_service_id=34";
				...
				public List<RTIApplication> getRTIApplicationListByLabel(
					...
					try{
						...
						StringBuffer sql=new StringBuffer();
						String fromClause="select r from RTIApplication r where rti_service_id=34";
				...
				public double getPieChartOrBarChartDatas() {
					...
					try {
						...
						String sqlString = "select sum(applicationCost) from RTIApplication rtiApplication where workFlowStatus in(2,1) and rti_service_id=34";
