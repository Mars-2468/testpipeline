...
import com.mars.rti.dao.MarriageDashboardDAO;
import com.mars.rti.model.RTIApplication;
import com.mars.rti.search.DashBoardLabelSearch;
@Repository
public class MarriageDashboardDAOImpl extends HibernateDaoSupport implements MarriageDashboardDAO{
		
		private static final Log log = LogFactory.getLog(MarriageDashboardDAOImpl.class);
		...
		public long getPieChartOrBarChartData() {
			...
			try{
				...
				String fromClause="select count(r) from RTIApplication r where r.subject='MARRIAGE-CERTIFICATE'";
		...
		public long getPieChartOrBarChartData(String condValue) {
			...
			try{
				...
				StringBuffer sql=new StringBuffer();
				String fromClause="select count(r) from RTIApplication r where r.subject='MARRIAGE-CERTIFICATE' and r.finalStatus='"+condValue+"'";
		...
		public long getPieChartOrBarChartData(String condValue1,
			...
			try{
				...
				StringBuffer sql=new StringBuffer();
				String fromClause="select count(r) from RTIApplication r where r.finalStatus not in ('"+condValue1+"','"+condValue2+"','"+condValue3+"','New') and rti_service_id=11";
