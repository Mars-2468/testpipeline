...
<div class="container">
	<h3>
		SOLID WASTE MANAGEMENT(VETERINARY) - DEPARTMENT DASHBOARD 
	</h3>
...
<div class="row">
  ...
  <option value="<c:out value="${contextRoot}"/>/dashBoard/dogLicense.do">Dog License Certificate</option>
  <option value="<c:out value="${contextRoot}"/>/dashBoard/dogLicenseRenewal.do">Dog License Renewal Certificate</option>
</select>
...
'#33B7FF' 
 ...
 function search()
 {
 	onPageSubmit('<c:out value="${contextRoot}"/>/pages/core-pages/dashboard/solidWasteDept.do');
 }
 ...
 function getListOnCategory(category){
	 ...
	 onPageSubmit('<c:out value="${contextRoot}"/>/dashBoard/getListOnCategorysolidWasteDept.do');
