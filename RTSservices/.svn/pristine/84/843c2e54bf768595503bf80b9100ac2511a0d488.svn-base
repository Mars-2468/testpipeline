...
@Table(name="property_tax_no_dues")
@Entity
public class PropertyTaxNoDues {

					@Id
					@Column(name = "property_tax_no_dues_id", nullable = false, unique = true)
					@SequenceGenerator(name = "property_tax_no_dues_seq", sequenceName = "property_tax_no_dues_seq")
					@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "property_tax_no_dues_seq")
					
					private long propertyTaxNoDuesId;
					...
					public long getPropertyTaxNoDuesId() {
						return propertyTaxNoDuesId;
					}

					public void setPropertyTaxNoDuesId(long propertyTaxNoDuesId) {
						this.propertyTaxNoDuesId = propertyTaxNoDuesId;
					}
