...
<h2 style="text-align:center">Marriage Applications Data</h2>
...
'#33B7FF' 
 ...
 function search()
 {
 	onPageSubmit('<c:out value="${contextRoot}"/>/dashBoard/marriage.do');
 }
 ...
 function getListOnCategory(category){
	 ...
	 onPageSubmit('<c:out value="${contextRoot}"/>/dashBoard/getMarriageListOnCategory.do');
