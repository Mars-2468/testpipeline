...
@JsonPropertyOrder({ "title", "name", "fatherName", "surname",
	...
	"adressForCorrespondence", "zoneNo", "wardNo","nameOfArea","updatedTradeName", "updatedTradeType", "updatedOwnerName", "updatedPartnerCount",
...
public class TradeLicenseTypeChangeRestDTO implements Serializable{
