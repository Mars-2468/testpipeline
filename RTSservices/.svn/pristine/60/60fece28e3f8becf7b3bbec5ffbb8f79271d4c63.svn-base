...
<script type="text/javascript">
	...
	function saveMandapCertificates() {
		...
		onPageSubmit('<c:out value="${contextRoot}"/>/rtsapplication/saveWaterPressure.do');
	}
...
<div class="container">
	<h3 style="font-size: 18px; font-weight: bold;">
		...
		<fmt:message key="Application Form For Water Pressure Complaint" />
		:
...
<div valign="top" id="SetFormHeight">
	<input type="hidden" name="id"
		value="${waterPressure.waterPressureId}">
	<table width="100%" border="0" cellpadding="2" cellspacing="2"
		class="container">
		<tr>
			<c:if test="${not empty waterPressure.CINNo}">
			...
			<td><input type="text" class="form-control" style="width: 300px"
				...
				value="<c:out value="${waterPressure.CINNo}"/>" /></td>
</c:if>
		
					<c:if test="${not empty waterPressure.zoneNo}">
		
				<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
							key="label.waterMeterComplaint.zoneNo" />:</span></td>
				<td><input type="text" class="form-control"
					style="width: 300px" id="ownerName" maxlength="50" name="ownerName"
					value="<c:out value="${waterPressure.zoneNo}"/>" /></td>
					</c:if>
				</tr>
		<tr>				
				<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
...
<td>
				<textarea class="form-control" style="width: 300px"
					id="ownerAddress" maxlength="200" rows="2" name="ownerAddress">${waterPressure.consumerName}</textarea>
				</td>
...
<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
				...
				<td>
				<textarea class="form-control" style="width: 300px"
					id="ownerAddress" maxlength="200" rows="2" name="ownerAddress">${waterPressure.exitingAddress}</textarea>
				</td>
		</tr>
		<tr>
					<c:if test="${not empty waterPressure.esr}">
		
				<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
							key="ESR" />:</span></td>
				<td><input type="text" class="form-control"
					style="width: 300px" id="ownerName" maxlength="50" name="ownerName"
					value="<c:out value="${waterPressure.esr}"/>" /></td>
					</c:if>
								<c:if test="${not empty waterPressure.existingEsr}">
<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
							key="ESR" />:</span></td>
				<td><input type="text" class="form-control"
					style="width: 300px" id="ownerName" maxlength="50" name="ownerName"
					value="<c:out value="${waterPressure.existingEsr}"/>" /></td>
			...
			<td><input type="text" class="form-control" style="width: 300px"
				...
				value="<c:out value="${waterPressure.meterNo}"/>" /></td>
...
<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
			...
			<td><input type="text" class="form-control" style="width: 300px"
	id="ownerName" maxlength="50" name="ownerName"
	value="<c:out value="${waterPressure.tap_size}"/>" /></td>
...
<td><input type="text" class="form-control" style="width: 300px"
	id="ownerName" maxlength="50" name="ownerName"
	value="<c:out value="${waterPressure.category}"/>" /></td>
...
<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
			...
			<td><input type="text" class="form-control" style="width: 300px"
	id="ownerName" maxlength="50" name="ownerName"
	value="<c:out value="${waterPressure.balance_arrears}"/>" /></td>
...
<td><input type="text" class="form-control" style="width: 300px"
	id="ownerName" maxlength="50" name="ownerName"
	value="<c:out value="${waterPressure.cut_off_date}"/>" /></td>
	...
	<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
			...
			<td><input type="text" class="form-control" style="width: 300px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${waterPressure.email}"/>" /></td>
			...
			<td><input type="text" class="form-control" style="width: 300px"
				...
				name="changedHospitalNameAndAddress"
				value="<c:out value="${waterPressure.mobileNo}"/>" /></td>
				</tr>
...
<!-- <tr>
			...
			<td><input type="text" class="form-control" style="width: 300px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${waterPressure.consumerNo}"/>" /></td> 
-->
		...
		<tr>
			...
			<td><input type="text" class="form-control"
				style="width: 300px;" id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${waterPressure.title}"/>" /></td>
			...
			<td><input type="text" class="form-control" style="width: 300px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${waterPressure.firstName}"/>" /></td>
		...
		<tr>
			...
			<td><input type="text" class="form-control"
				style="width: 300px;" id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${waterPressure.middleName}"/>" /></td>
			...
			<td><input type="text" class="form-control" style="width: 300px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${waterPressure.lastName}"/>" /></td>
		</tr>
		<tr>
			...
			<td><input type="text" class="form-control" style="width: 300px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${waterPressure.fullName}"/>" /></td>

			<!-- <td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.waterMeterComplaint.plotNo" />:</span></td>
			<td><input type="text" class="form-control" style="width: 300px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${waterPressure.plotNo}"/>" /></td>
		...
		<tr>
			...
			<td><input type="text" class="form-control" style="width: 300px"
				id="changedHospitalNameAndAddress" maxlength="30"
				name="changedHospitalNameAndAddress"
				value="<c:out value="${waterPressure.buildingName}"/>" /></td>
			...
			<td><input type="text" class="form-control" style="width: 300px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${waterPressure.streetName}"/>" /></td>
		...
		<tr>
			...
			<td><input type="text" class="form-control" style="width: 300px"
				id="changedHospitalNameAndAddress" maxlength="30"
				name="changedHospitalNameAndAddress" value="<c:out value="${waterPressure.areaName}"/>" /></td>
-->
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.waterMeterComplaint.address" />:</span></td>
			<td><textarea class="form-control" style="width: 300px"
					id="ownerAddress" maxlength="200" rows="2" name="ownerAddress">${waterPressure.fullAddress}</textarea></td>
		...
		<!--  <tr>
			...
			<td><input type="text" class="form-control" style="width: 300px"
				id="changedHospitalNameAndAddress" maxlength="30"
				name="changedHospitalNameAndAddress"
				value="<c:out value="${waterPressure.landmark}"/>" /></td>
			...
			<td><input type="text" class="form-control" style="width: 300px"
				id="changedHospitalNameAndAddress" maxlength="30"
				name="changedHospitalNameAndAddress"
				value="<c:out value="${waterPressure.pinCode}"/>" /></td>
		</tr>
		<tr>
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
			...
			<td><input type="text" class="form-control" style="width: 300px"
				id="changedHospitalNameAndAddress" maxlength="30"
				name="changedHospitalNameAndAddress"
				value="<c:out value="${waterPressure.aadhaarNo}"/>" /></td>
	...
	<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
			...
			<td><input type="text" class="form-control" style="width: 300px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${waterPressure.applicantcity}"/>" /></td>
		</tr>-->
			...
			<!-- <tr>
				...
				<td><input type="text" class="form-control"
					style="width: 300px" id="ownerName" maxlength="50" name="ownerName"
					value="<c:out value="${waterPressure.depositReceiptNo}"/>" /></td>
<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
							key="label.waterMeterComplaint.receiptDate" />:</span></td>
				<td><input type="text" class="form-control"
					style="width: 300px" id="ownerName" maxlength="50" name="ownerName"
					value="<c:out value="${waterPressure.depositReceiptDate}"/>" /></td>
			...
			<td><textarea class="form-control" style="width: 300px"
					id="ownerAddress" maxlength="200" rows="2" name="ownerAddress">${waterPressure.problemDesc}</textarea></td>
	...
	<table width="100%" border="0" cellpadding="2" cellspacing="2"
		...
		<!-- <tr>
			<td colspan="5"><span class="ClsLabel"
				style="font-size: 15px; font-weight: bold;"><fmt:message
						key="List of Documents (Attachment) For Water Connection Force Capacity Complaint" />:</span></td>
        ...
        <c:when test="${userId == 3950 || userId == 4150 || userId == 4151 || userId == 4152 || userId == 4153 || userId == 4154 || userId == 4155 || userId ==4156 || userId == 4157 || userId == 4158 || userId == 1 || userId == 4550}">
                           ...
                           <td>
                            <input type="number" class="form-control" id="feesApplicable" maxlength="5"  style="width:200px" name="demandfees" value="<c:out value="${waterPressure.demandfees}"/>" oninput="validateInput(this);"/>
                          </td>
     	 </c:when>
        <c:otherwise>
            <td>
    ...
    value="<c:out value="${waterPressure.demandfees}"/>"
    ...
    <c:choose>
        <c:when test="${empty waterPressure.uploadedDemand}">
        ...
        <c:otherwise>
            <c:if test="${not empty waterPressure.uploadedDemand}">
                <td>
                    <a target="_blank" href="<c:out value='${waterPressure.uploadedDemand}'/>" id="uploadCer">
...
<c:if test="${(requestScope.rtiApplication.workFlowStatus == 3 || requestScope.rtiApplication.workFlowStatus == 2 || requestScope.rtiApplication.workFlowStatus == 1 || requestScope.rtiApplication.workFlowStatus == 5) && (userId == 3950 || userId == 4150 || userId == 4151 || userId == 4152 || userId == 4153 || userId == 4154 || userId == 4155 || userId == 4156 || userId == 4157 || userId == 4158 || userId == 1 || userId == 4550)}">
    <tr style="height: 60px;">
       ...
       <c:if test="${waterPressure.paymentStatus=='Paid'}">checked="checked" disabled="true"</c:if> />
    ...
    <c:choose>
        <c:when test="${empty waterPressure.acknowledgement}">
        		<c:if test="${(requestScope.rtiApplication.workFlowStatus==2 || requestScope.rtiApplication.workFlowStatus == 1 || requestScope.rtiApplication.workFlowStatus == 5) && (userId == 3950 || userId == 4150 || userId == 4151 || userId == 4152 || userId == 4153 || userId == 4154 || userId == 4155 || userId ==4156 || userId == 4157 || userId == 4158 || userId == 1 || userId == 4550)}">
        ...
        <c:otherwise>
            <c:if test="${not empty waterPressure.acknowledgement}">
            <td>
                    <a target="_blank" href="<c:out value='${waterPressure.acknowledgement}'/>" id="uploadCer">
...
<input type="hidden" class="ClsTextbox" id="waterPressureId"
	style="width: 180px" name="waterPressureId"
	value="<c:out value="${waterPressure.waterPressureId}"/>" />
<input type="hidden" id="rtiApplicationRefId" name="rtiApplicationRefId"
	value="" />
				  			  <input type="hidden" id="rtiApplicationRefIds" name="rtiApplicationRefIds" value="${waterPressure.rti_ref_id}" />
	
<%@include file="/pages/workflow/taskInclude.jsp"%>
<script type="text/javascript">
function saveEntity()
{
	onPageSubmit('<c:out value="${contextRoot}"/>/rtiapplication/createWaterPressureWork.do');
}
	</script>
...
function saveFees() {
    ...
    var demanddoc = '${waterPressure.uploadedDemand}';

    if (feeId.val() !== '') {
           if (confirm('Are you sure you want to save?')) {
        var uid = $('#rtiApplicationRefIds').val();
        onPageSubmit('<c:out value="${contextRoot}"/>/rtsapplication/savePressureComplaintWater.do');
    ...
    function savePaymentStatus() {
       ...
       // var acknowledgementUpload = $('#acknowledgementUpload');
        ...
        if (payment.prop('checked') ) {
            ...
            onPageSubmit('<c:out value="${contextRoot}"/>/rtsapplication/savePressureComplaintWaterPayment.do');
...
$(document).ready(function() {
    ...
    var feesApplicable = '${waterPressure.demandfees}';
    var demanddoc = '${waterPressure.uploadedDemand}';
    var workflowStatus = '${requestScope.rtiApplication.workFlowStatus}';
	...
	$(document).ready(function() {
	    ...
	    var workflowStatus = '${requestScope.rtiApplication.workFlowStatus}';
        var demanddoc = '${waterPressure.uploadedDemand}';
        var acknowledgementdoc = '${waterPressure.acknowledgement}';
    ...
    function uploadPoliceNoc1() {
        ...
        for (var i = 0; i < file.length; i++) {
   			...
   			const value = splitName + ".pdf";
                ...
                filesPath = filesPath + basePath + "waterpressure/" + i + value + ","
                isFileSelected = true;
            }
        }
        var appType = 1;
        var uid1 = document.getElementById('waterPressureId').value;
        $.ajax({
            url: "<c:out value='${contextRoot}'/>/rtsapplication/uploadManageWaterPressure.do?appType="+appType+"&UID="+uid1,
            type: 'POST',
            data: data,
            cache: false,
            dataType: 'json',
