...
@Repository
public class TradeLicenseRenewalDashboardDAOImpl extends HibernateDaoSupport implements TradeLicenseRenewalDashboardDAO{


			
				private static final Log log = LogFactory.getLog(TradeLicenseRenewalDashboardDAOImpl.class);
				...
				public long getPieChartOrBarChartData() {
					...
					try{
						...
						String fromClause="select count(r) from RTIApplication r where rti_service_id=33";
				...
				public long getPieChartOrBarChartData(String condValue) {
					...
					try{
						...
						StringBuffer sql=new StringBuffer();
						String fromClause="select count(r) from RTIApplication r where r.finalStatus='"+condValue+"' and rti_service_id=33";
				...
				public long getPieChartOrBarChartData(String condValue1,
					...
					try{
						...
						StringBuffer sql=new StringBuffer();
						String fromClause="select count(r) from RTIApplication r where r.finalStatus not in ('"+condValue1+"','"+condValue2+"','"+condValue3+"')and rti_service_id=33";
			...
			public List<RTIApplication> getRTIApplicationListByLabel(
				...
				try{
					...
					StringBuffer sql=new StringBuffer();
					String fromClause="select r from RTIApplication r where rti_service_id=33";
			...
			public double getPieChartOrBarChartDatas() {
				...
				try {
					...
					String sqlString = "select sum(applicationCost) from RTIApplication rtiApplication where workFlowStatus in(2,1) and rti_service_id=33";
