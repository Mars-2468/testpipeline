...
@JsonPropertyOrder({"canNo", "zoneNo", "existingConsumerName",
		...
		"proposedCategory", "totalNumberOfResidentialFlats", "alternateMobileNo",
		 "userMobileNumber", "applicantIdProofPdf","supportingDocPdf","responseStatus",
		"responseCode", "result", "status"})
	public class WaterConnectionUsageRestDTO implements Serializable {
		...
		@XmlElement(name = "proposedCategory")
		public String getProposedCategory() {
			return proposedCategory;
		}
		@XmlElement(name = "totalNumberOfResidentialFlats")
