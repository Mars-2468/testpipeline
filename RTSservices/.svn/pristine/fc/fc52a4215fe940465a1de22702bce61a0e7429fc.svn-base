...
/**
 * <p>Title: DictionaryDAO.java </p>

 * <p>Description: This interface is used for hibernate operations for Dictionary</p>
...
public interface DictionaryDAO {
    ...
    /**
     * This method is used to delete a list of Dictionary records from the database.
     * 
     * @param listDictionary as List
     */
