...
@Repository("dogLicenseDAO")
public class DogLicenseDAOImpl extends HibernateDaoSupport implements DogLicenseDAO {

	private static final Log log =LogFactory.getLog(DogLicenseDAOImpl.class);
	...
	public void dogLicenseCertificate(DogLicense dogLicense) {
		...
		try
		{
		    ...
		    getHibernateTemplate().saveOrUpdate(dogLicense);
	...
	public DogLicense dogLicenseSave(DogLicense dogLicense) {
		...
		try
		{
		    ...
		    dogLicreturn=(DogLicense)getHibernateTemplate().merge(dogLicense);
		} catch (NullPointerException nullpointerexception)
		{
		    log.error(nullpointerexception.getStackTrace());
		    throw new NullPointerException();
	...
	public List<DogLicense> getDogLicenseList(RTIApplicationSearch rTIApplicationSearch){
		try {
			...
			List<DogLicense> list = query.list();
	...
	public List<DogLicense> findDogLicenseIdFromRefNum(String rtiapplrefno){
		 if(log.isDebugEnabled()){
				log.debug("getBillCountBySearch Method is called");
			}
		    System.out.println("hello@");
			String sqlquery ="select dogLicense from DogLicense dogLicense where dogLicense.rtiapplrefno ="+"'"+rtiapplrefno+"'";
			List<DogLicense> list=null;
	...
	public DogLicense get(long id) {
		try {
			...
			return (DogLicense) getHibernateTemplate().get(DogLicense.class, new Long(id));
		} catch (Exception exception) {
			log.error(exception.getStackTrace(), exception);
			exception.printStackTrace();
		}
	...
	public DogLicense findDogIdFromRefNum(String rtiapplrefno) {
		...
		String HQL="select d from DogLicense d where d.rtiapplrefno="+rtiapplrefno;
