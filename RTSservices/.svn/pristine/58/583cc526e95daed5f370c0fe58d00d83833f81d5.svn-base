...
<h2 style="text-align:center">	Market Department Applications Data </h2>
...
<div class="row">
  ...
  <option value="<c:out value="${contextRoot}"/>/dashBoard/noc.do">NOC For Business/Trade/Godown</option>
  <option value="<c:out value="${contextRoot}"/>/dashBoard/tradeduplication.do">Trade License Duplication</option>
  <option value="<c:out value="${contextRoot}"/>/dashBoard/traderenewal.do">Trade License Renewal</option>
  <option value="<c:out value="${contextRoot}"/>/dashBoard/tradetransfer.do">Trade License Transfer</option>
  <option value="<c:out value="${contextRoot}"/>/dashBoard/tradenew.do">Trade License New</option>
  <option value="<c:out value="${contextRoot}"/>/dashBoard/tradenamechange.do">Trade License Name Change</option>
<option value="<c:out value="${contextRoot}"/>/dashBoard/tradetypechange.do">Trade License Type Change</option>
  <option value="<c:out value="${contextRoot}"/>/dashBoard/tradeownerchange.do">Trade License Owner/Partner Change</option>
  <option value="<c:out value="${contextRoot}"/>/dashBoard/partnercountupdate.do">License Partner Count Update</option>
    <option value="<c:out value="${contextRoot}"/>/dashBoard/outdatedrenewalnotice.do">Trade License Outdated Renewal Notice</option>
...
<div class="columns" id="All" onclick="getListOnCategory(this.id)">
  <ul class="price">
    <li class="header" style="background-color:#E404FA" >All Applications</li>
...
<div class="columns" id="Rejected" onclick="getListOnCategory(this.id)">
  <ul class="price">
    <li class="header" style="background-color:#E62C04" >Rejected</li>
...
<div id="myModal" class="modal">
 <div class="modal-content">
    ...
    <button type="button" class="btn btn-success" style="width:100px; margin-left:425px; margin-top:-30px; font-size:12px"  onclick="excel()">Export Excel</button>
<div>
...
<div class="mainHdr">
	...
	<c:choose>
	<c:when test="${empty receiptSatus}">-Records</c:when>
...
<table id = "excelTable" cellpadding="0" cellspacing="1" width="80%"  class="dataGrid">
			<thead>
				<tr>
					...
					<td onclick="javascript:resort('department');"
						style="cursor: pointer" wrap>Department <span
						id="upper(department)"></span>
					</td>
					<td onclick="javascript:resort('mobileNumber');"
						style="cursor: pointer" wrap>Mobile Number <span
			...
			<tbody>
				...
				<c:forEach var="rtiApplnList"
					...
					<tr>
						...
						<td><c:out value="${rtiApplnList.department}" /></td>
  ...
  if (event.target == modal) {
	...
	<script>
	    ...
	    Highcharts.setOptions({
		     colors: ['#E404FA', '#17DF68', '#33B7FF', '#FFC133', '#E62C04','#4CAF50']
	    });
...
/*  Highcharts.chart('container', {
 ...
 function getListOnCategory(category){
	...
	// var all=document.getElementById("All");
	 ...
	 onPageSubmit('<c:out value="${contextRoot}"/>/dashBoard/getListOnCategoryMarketDept.do');
