...
<div class="mainHdr">
    ...
    height: 30px;
		...
		<fmt:message key="Exemption in Tax" />
		:
...
<div valign="top" id="SetFormHeight">
	<input type="hidden" name="id"
		value="${propertyTaxAssessment.taxExemptionId}">
	<c:set var="doc"
...
<td colspan="1.5"><span class="ClsLabel" style="font-size: 14px"><fmt:message
			...
			<td colspan="2">
					...
					<input type="text" class="form-control" style="width: 180px"
						...
						value="<c:out value="${propertyTaxAssessment.name}"/>" disabled/>
			...
			<td colspan="2">
				...
				<td colspan="1.5"><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="Name of Property
							Holders/Occupants (मालमत्ताधारक/ भोगवटादारांचे नाव)" /></span><span class="ClsRequiredFields"></span></td>
			<td colspan="2">
					<input type="text" class="form-control" id="email"
						style="width: 230px" name="email"
						value="<c:out value="${propertyTaxAssessment.propertyHolderName}"/>" disabled/>
				</td>
		</tr>
		<tr>
			<td colspan="1.5"><span class="ClsLabel" style="font-size: 14px"><fmt:message
		...
		<tr>
			...
			<td colspan="2">
					...
					<input type="text" class="form-control" style="width: 180px"
						id="childeName" maxlength="45" tabindex="3" name="childeName"
						value="<c:out value="${propertyTaxAssessment.blockNo}"/>" disabled/>
			</td>
</tr>
...
<td colspan="1.5"><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="Ward Name (प्रभाग नाव)" /></span><span class="ClsRequiredFields">:</span>
			</td>
			<td colspan="2">
					<input type="text" class="form-control" style="width: 180px"
						id="fatherName" maxlength="45" tabindex="4" name="fatherName"
						value="<c:out value="${propertyTaxAssessment.blockName}"/>" disabled/>
				</td>
			...
			<td colspan="2">
					...
					<input type="text" class="form-control" style="width: 180px"
						id="childeName" maxlength="45" tabindex="3" name="childeName"
						value="<c:out value="${propertyTaxAssessment.taxPincode}"/>" disabled/>
			</td>
...
<td colspan="1.5"><span class="ClsLabel" style="font-size: 14px"><fmt:message
			...
			<td colspan="2">
					...
					<input type="text" class="form-control" style="width: 180px"
						id="childeName" maxlength="45" tabindex="3" name="childeName"
						value="<c:out value="${propertyTaxAssessment.address}"/>" disabled/>
			</td>
			...
			<td colspan="2">
					...
					<input type="text" class="form-control" style="width: 180px"
						id="childeName" maxlength="45" tabindex="3" name="ownerName"
						value="<c:out value="${propertyTaxAssessment.ownerName}"/>" disabled/>
			</td>
...
<td colspan="1.5"><span class="ClsLabel" style="font-size: 14px"><fmt:message
			...
			<td colspan="2">
					...
					<input type="text" class="form-control" style="width: 180px"
						id="childeName" maxlength="45" tabindex="3" name="childeName"
						value="<c:out value="${propertyTaxAssessment.taxMobileNo}"/>" disabled/>
			</td>
			...
			<td colspan="2">
					...
					<input type="text" class="form-control" style="width: 180px"
						id="childeName" maxlength="45" tabindex="3" name="ownerName"
						value="<c:out value="${propertyTaxAssessment.areasPending}"/>" disabled/>
			</td>
...
<td colspan="1.5"><span class="ClsLabel" style="font-size: 14px"><fmt:message
			...
			<td colspan="2">
					...
					<input type="text" class="form-control" style="width: 180px"
						id="childeName" maxlength="45" tabindex="3" name="areasPendingStatus"
						value="<c:out value="${propertyTaxAssessment.areasPendingStatus}"/>" disabled/>
			</td>
			...
			<td colspan="2">
					...
					<input type="text" class="form-control" style="width: 180px"
						id="childeName" maxlength="45" tabindex="3" name="ownerName"
						value="<c:out value="${propertyTaxAssessment.duesAmt}"/>" disabled/>
			</td>
...
<td colspan="1.5"><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="Exemption Regarding (कर सूट संबंधित)" />:</span></td>
			<td colspan="2">

					<input type="text" class="form-control" style="width: 180px"
						id="childeName" maxlength="45" tabindex="3" name="areasPendingStatus"
						value="<c:out value="${propertyTaxAssessment.exemptionRegarding}"/>" disabled/>
			</td>
			
			<c:if test="${not empty propertyTaxAssessment.medalNo}">
			<td colspan="1.5"><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="Medal no. (पदक क्र.)" />:</span></td>
			<td colspan="2">

					<input type="text" class="form-control" style="width: 180px"
						id="childeName" maxlength="45" tabindex="3" name="ownerName"
						value="<c:out value="${propertyTaxAssessment.medalNo}"/>" disabled/>
			</td>
</c:if>
...
<tr>
			<c:if test="${not empty propertyTaxAssessment.armyNo}">

<td colspan="1.5"><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="Army no. (लष्कर क्र.)" />:</span></td>
			<td colspan="2">

					<input type="text" class="form-control" style="width: 180px"
						id="childeName" maxlength="45" tabindex="3" name="areasPendingStatus"
						value="<c:out value="${propertyTaxAssessment.armyNo}"/>" disabled/>
			</td>
		</c:if>
		<td colspan="1.5"><span class="ClsLabel" style="font-size: 14px"><fmt:message
...
<%-- <c:if
       ...
       font-size: 17px;color:#01293d;font-style: italic;"><fmt:message
		...
		<c:if test="${doc[0] != 'null'}">
			<tr>
				...
				<td  colspan="3.5"><a class="bg-button btn btn-primary bd-highlight action" type="button" target="_blank" style="margin-left: 75px;"
		...
		<%-- <c:if test="${doc[1] != 'null'}">
			<tr>
				<td colspan="3.5"><span class="ClsLabel"
					style="font-size: 14px"><fmt:message
							key="Certificate of Shourya Medal (Attested Copy)(शौर्य पदकाचे प्रमाणपत्र (साक्षांकित प्रत))" />:</span> 
				<td style="text-align: center" colspan="3.5"><a class="bg-button btn btn-primary bd-highlight action" type="button" target="_blank" style="margin-left: 75px;"
		...
		<!--<c:if test="${doc[1] != 'null'}">
			<tr>
				<td colspan="3.5"><span class="ClsLabel"
					style="font-size: 14px"><fmt:message
							key="First Page of Discharge Book and Copy of Family Statement.(डिस्चार्ज बुकचे पहिले पान आणि कौटुंबिक स्टेटमेंटची प्रत.)" />:</span> 
				<td style="text-align: center" colspan="3.5"><a class="bg-button btn btn-primary bd-highlight action" type="button" target="_blank" style="margin-left: 75px;"
						href="<c:out value="${doc[1]}"/>"><span class="download"
							style="align-items: center">Download</span></a></td>
			</tr>
			...
			<tr>
				<td colspan="3.5"><span class="ClsLabel"
					style="font-size: 14px"><fmt:message
							key="ID Card of Ex-Servicemen /Widows of Ex-Servicemen And Wife (माजी सैनिक / <br>माजी सैनिकाच्या पत्नी/ विधवा यांचे ओळखपत्र)" />:</span> 
   ...
   <span class="download" style="align-items: center;color:white;">Download</span>
			...
			<tr>
				<td colspan="3.5"><span class="ClsLabel"
					style="font-size: 14px"><fmt:message
							key="Photocopy of Identity Card of Government Recognized Ex-Servicemen Organization or District Sainik Kalyan from the Office.(शासकीय मान्यताप्राप्त माजी सैनिक संघटना किंवा जिल्हा सैनिक कल्याण कार्यालयातुन ओळखपत्राची छायाप्रत)" />:</span> 
				<td style="text-align: center" colspan="3.5"><a class="bg-button btn btn-primary bd-highlight action"
   type="button"
   target="_blank"
...
<%-- 
	<c:if test="${doc[5] != 'null'}">
			<tr>
				<td colspan="3.5"><span class="ClsLabel"
					style="font-size: 14px"><fmt:message
							key="Certificate of survival from local corporator every year(
स्थानिक नगरसेवकाकडून दरवर्षी हयातीचा दाखला)" />:</span> 
				<td style="text-align: center" colspan="3.5"><a class="bg-button btn btn-primary bd-highlight action" type="button" target="_blank" style="margin-left: 75px;"
						href="<c:out value="${doc[5]}"/>"><span class="download"
							style="align-items: center">Download</span></a></td>
			</tr>
		</c:if> --%>
			...
			<tr>
				<td colspan="3.5"><span class="ClsLabel"
					style="font-size: 14px"><fmt:message
							key="Charity Commissioner's Office Registration Certificate(धर्मदाय आयुक्त कार्यालयाचे नोंदणी प्रमाणपत्र)" />:</span> 
				<td style="text-align: center" colspan="3.5"><a class="bg-button btn btn-primary bd-highlight action"
   type="button"
   target="_blank"
   ...
   <span class="download" style="align-items: center;color:white;">Download</span>
			...
			<tr>
				<td colspan="3.5"><span class="ClsLabel"
					style="font-size: 14px"><fmt:message
							key="Audit Report of Three years preceding the date of application(अर्जाच्या तारखेच्या आधीच्या तीन वर्षांचा लेखापरीक्षण अहवाल)" />:</span> 
				<td style="text-align: center" colspan="3.5"><a class="bg-button btn btn-primary bd-highlight action"
   type="button"
   target="_blank"
   ...
   <span class="download" style="align-items: center;color:white;">Download</span>
		...
		<%-- <c:if test="${doc[5] != 'null'}">
			<tr>
				<td colspan="3.5"><span class="ClsLabel"
					style="font-size: 14px"><fmt:message
							key="Certificate of Surviving from Competent Authority (सक्षम प्राधिकाऱ्याकडून हयात असल्याचे प्रमाणपत्र)" />:</span> 
				<td style="text-align: center" colspan="3.5"><a class="bg-button btn btn-primary bd-highlight action"
   type="button"
   target="_blank"
...
<c:if test="${not empty requestScope.rtiApplication.taxOtherCitizenDocumentUpload}">
	...
	<input type="hidden" class="ClsTextbox_mr" style="width: 180px"
		...
		value="<c:out value="${propertyTaxAssessment.taxExemptionId}"/>" /> 
...
<script type="text/javascript">
	function saveEntity() {
		onPageSubmit('<c:out value="${contextRoot}"/>/rtiapplication/createPropertyTaxExemptionWork.do');
	}
	...
	function saveFees(){
		...
		onPageSubmit('<c:out value="${contextRoot}"/>/rtsapplication/savePropertyTaxExemptionFees.do?id='+refId);
		}else{
			return false;
		}
		}else{
