...
<div class="container-fluid"  style="">
	<div class="row p-2 border bg-blue d-flex align-items-center">
        ...
        <div class="col-md-10 "><p class="h2 text-center text-white"><strong>Nagpur Municipal  Corporation</strong></p></div>
    	...
    	<div class="row">
        	<div class="col-md-6 d-flex align-items-center">
            	<ol class="breadcrumb bg-white pb-0">
                    <li class="breadcrumb-item"><a href='<c:out value="${contextRoot}"/>/ws/nmc/dashboard.do'>Home</a></li>
...
<div class="container-fluid my-3" >
	<div class="container" >
    	<div class="row mb-4">
            <%-- <div class="col-md-3 ">
                 <a class="card" href='<c:out value="${contextRoot}"/>/ws/rtiapplication/newRTIBirthApplication.do'>
                    <div class="card-body d-flex align-items-top justify-content-between">                    			 
                                  <span class="title-width platform-title"> <p class="h5 m-0">Birth<br>Certificate</p></span>
            ...
            <div class="col-md-3">
                <a class="card" href='<c:out value="${contextRoot}"/>/ws/rtiapplication/newRTIDeathApplication.do'>
                    <div class="card-body d-flex align-items-top justify-content-between">                    			 
                                  <span class="title-width platform-title"><p class="h5 m-0">Death<br>Certificate</p></span>
								   <p class="image-icon d-inline-block m-0 mr-0 float-right"><i class="fas fa-certificate"></i></p>	
            ...
            <div class="col-md-3">
                 <a class="card" href='<c:out value="${contextRoot}"/>/ws/rtsapplication/newRTIMarriageApplication.do'>
                    ...
                    <div class="card-body d-flex align-items-top justify-content-between">                    			 
                                  ...
                                  <p class="image-icon d-inline-block m-0 mr-0 float-right"><img src="<%=url%>img/marriage1.png"></p>                               
