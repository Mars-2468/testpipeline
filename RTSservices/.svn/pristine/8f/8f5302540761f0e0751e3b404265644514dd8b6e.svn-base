...
import com.mars.rti.dao.MarketDeptDashboardDAO;
import com.mars.rti.model.RTIApplication;
import com.mars.rti.search.DashBoardLabelSearch;
@Repository
public class MarketDeptDashboardDAOImpl extends HibernateDaoSupport implements MarketDeptDashboardDAO{


		
			private static final Log log = LogFactory.getLog(MarketDeptDashboardDAOImpl.class);
			...
			public long getPieChartOrBarChartData() {
				...
				try{
					...
					String fromClause="select count(r) from RTIApplication r where rti_service_id=32 or rti_service_id=40 or rti_service_id=41 or rti_service_id=42 or rti_service_id=38 or rti_service_id=44 or rti_service_id=34 or rti_service_id=35 or rti_service_id=36 or rti_service_id=33";
			...
			public long getPieChartOrBarChartData(String condValue) {
				...
				try{
					...
					StringBuffer sql=new StringBuffer();
					String fromClause="select count(r) from RTIApplication r where r.finalStatus='"+condValue+"' and (rti_service_id=32 or rti_service_id=40 or rti_service_id=41 or rti_service_id=42 or rti_service_id=38 or rti_service_id=44 or rti_service_id=34 or rti_service_id=35 or rti_service_id=36 or rti_service_id=33)";
			...
			public long getPieChartOrBarChartData(String condValue1,
				...
				try{
					...
					StringBuffer sql=new StringBuffer();
					String fromClause="select count(r) from RTIApplication r where r.finalStatus not in ('"+condValue1+"','"+condValue2+"','"+condValue3+"')and (rti_service_id=32 or rti_service_id=40 or rti_service_id=41 or rti_service_id=42 or rti_service_id=38 or rti_service_id=44 or rti_service_id=34 or rti_service_id=35 or rti_service_id=36 or rti_service_id=33)";
		...
		public List<RTIApplication> getRTIApplicationListByLabel(
			...
			if(log.isDebugEnabled()){
				log.debug("getRTIApplicationListByLabel Method is called 888");
			}
			...
			try{
				...
				StringBuffer sql=new StringBuffer();
				String fromClause="select r from RTIApplication r";
			...
			if (pageNumber > 1) {
				...
				log.debug("getRTIApplicationListByLabel Method is called344" +pageNumber);

			} else {
				log.debug("getRTIApplicationListByLabel Method is called37744" +pageNumber);
		...
		public double getPieChartOrBarChartDatas() {
			...
			try {
				...
				String sqlString = "select sum(applicationCost) from RTIApplication rtiApplication where workFlowStatus in(2,1) and (rti_service_id=32 or rti_service_id=40 or rti_service_id=41 or rti_service_id=42 or rti_service_id=38 or rti_service_id=44 or rti_service_id=34 or rti_service_id=35 or rti_service_id=36 or rti_service_id=33)";
