...
import com.fasterxml.jackson.annotation.JsonPropertyOrder;
	...
	@JsonPropertyOrder({"canNo", "zoneNo", "existingConsumerName",
		...
		"consumerAddress", "esr", "consumerEmailId", "consumerMobileNo",
		 "proposedTapSize", "alternateMobileNo",
		"proposedTapSize", "userMobileNumber", "applicantIdProofPdf","currentBillCopyPdf","responseStatus",
		"responseCode", "result", "status"})
	public class WaterConnectionTypeChangeRestDTO implements Serializable {
		...
		@XmlElement(name = "proposedTapSize")
