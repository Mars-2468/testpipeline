...
/**
 * <p>Title: TenancyDAO.java </p>

 * <p>Description: This interface is used for hibernate operations for Tenancy</p>
...
public interface TenancyDAO {
    ...
    /**
     * This method is used to delete a list of Tenancy records from the database.
     * 
     * @param listTenancy as List
     */
