...
@Entity
@Table(name = "water_connection_certificate", schema = "egovrti")
public class WaterConnectionNoDue {

	@Id
	@Column(name = "waterconnection_id", nullable = false, unique = true)
	@SequenceGenerator(name = "waterconnection_seq", sequenceName = "waterconnection_seq", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "waterconnection_seq")
	...
	@Column(name = "purpose_of_no_due", nullable = true)
	private String purposeOfNoDue;
    ...
    public String getPurposeOfNoDue() {
		return purposeOfNoDue;
	}

	public void setPurposeOfNoDue(String purposeOfNoDue) {
		this.purposeOfNoDue = purposeOfNoDue;
	}
