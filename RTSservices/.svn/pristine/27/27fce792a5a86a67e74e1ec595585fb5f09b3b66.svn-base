...
<div class="mainHdr">
	<h3> 
				...
				<fmt:message key="Application form for Trade Licence Partner/Owner Change"/> 				
...
<input type="hidden" name="id"
		value="${tradeLicencePartnerChange.tradeLicencePartnerChangeId}">
	...
	<td><input type="text" class="form-control" style="width: 180px"
			...
			<td><input type="text" class="form-control" style="width: 180px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${tradeLicencePartnerChange.lastName}"/>" /></td>
				
				
				<td><span
				class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicensePartnerChange.fullname" />:</span></td>
			<td><input type="text" class="form-control" style="width: 180px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${tradeLicencePartnerChange.fullName}"/>" /></td>
		...
		<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicensePartnerChange.pincode" />:</span></td>
			<td><input type="text" class="form-control" style="width: 170px"
				...
				value="<c:out value="${tradeLicencePartnerChange.pinCode}"/>" />
				&nbsp;</td>
		
		
		<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicensePartnerChange.aadhaarno" />:</span></td>
			<td><input type="text" class="form-control" style="width: 170px"
				id="changedHospitalNameAndAddress" maxlength="30"
				name="changedHospitalNameAndAddress"
				value="<c:out value="${tradeLicencePartnerChange.aadhaarNo}"/>" />
				&nbsp;</td>
                 ...
                 <tr>
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicensePartnerChange.emailid" />:</span></td>
		
			<td><input type="text" class="form-control" style="width: 180px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${tradeLicencePartnerChange.email}"/>" /></td>

         <td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicensePartnerChange.mobileno" />:</span></td>
			<td><input type="text" class="form-control" style="width: 170px"
				id="changedHospitalNameAndAddress" maxlength="30"
				name="changedHospitalNameAndAddress"
				value="<c:out value="${tradeLicencePartnerChange.mobileNo}"/>" />
				&nbsp;</td>
			...
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicensePartnerChange.addressForCorre" />:</span></td>
			<td><input type="text" class="form-control" style="width: 170px"
				id="changedHospitalNameAndAddress" maxlength="30"
				name="changedHospitalNameAndAddress"
				value="<c:out value="${tradeLicencePartnerChange.address}"/>" />
				&nbsp;</td>
				
				<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicensePartnerChange.zoneno" /><span class="ClsRequiredFields"></span>:
			</td>
			<td><input type="text" class="form-control" style="width: 180px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${tradeLicencePartnerChange.zoneNo}"/>" /></td>
		...
		<tr>
			...
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicensePartnerChange.wardno" />:</span></td>
			<td><input type="text" class="form-control" style="width: 170px"
				id="changedHospitalNameAndAddress" maxlength="30"
				name="changedHospitalNameAndAddress"
				value="<c:out value="${tradeLicencePartnerChange.wardNo}"/>" />
				&nbsp;</td>

			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicensePartnerChange.nameofarea" /><span class="ClsRequiredFields"></span>:
			</td>
			<td><input type="text" class="form-control" style="width: 180px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${tradeLicencePartnerChange.areaName}"/>" /></td>
		...
		<tr>
			...
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicensePartnerChange.tradelicenseno" />:</span></td>
			<td><input type="text" class="form-control" style="width: 170px"
				id="changedHospitalNameAndAddress" maxlength="30"
				name="changedHospitalNameAndAddress"
				value="<c:out value="${tradeLicencePartnerChange.tradeLicenseNo}"/>" />
				&nbsp;</td>

			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicensePartnerChange.updatedtradename" /><span class="ClsRequiredFields"></span>:
			</td>
			<td><input type="text" class="form-control" style="width: 180px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${tradeLicencePartnerChange.updatedTradeName}"/>" /></td>
		...
		<tr>
			...
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicensePartnerChange.updatedtradetype" />:</span></td>
			<td><input type="text" class="form-control" style="width: 170px"
				id="changedHospitalNameAndAddress" maxlength="30"
				name="changedHospitalNameAndAddress"
				value="<c:out value="${tradeLicencePartnerChange.updatedTradeType}"/>" />
				&nbsp;</td>

			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicensePartnerChange.updatedownername" />:</span></td>
			<td><input type="text" class="form-control" style="width: 170px"
				id="changedHospitalNameAndAddress" maxlength="30"
				name="changedHospitalNameAndAddress"
				value="<c:out value="${tradeLicencePartnerChange.updatedOwnerName}"/>" />
				&nbsp;</td>
		</tr>			
		...
		<tr>
			...
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicensePartnerChange.updatedpartnercount" />:</span></td>
			<td><input type="text" class="form-control" style="width: 170px"
				id="changedHospitalNameAndAddress" maxlength="30"
				name="changedHospitalNameAndAddress"
				value="<c:out value="${tradeLicencePartnerChange.updatedPartnerCount}"/>" />
				&nbsp;</td>
				
				<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicensePartnerChange.applicableFee" />:</span></td>
			<td><input type="text" class="form-control" style="width: 170px"
				id="changedHospitalNameAndAddress" maxlength="30"
				name="changedHospitalNameAndAddress"
				value="<c:out value="${tradeLicencePartnerChange.applicableFee}"/>" />
				&nbsp;</td>
...
<tr>
	       <td colspan="6" align="center">
                      ...
                      <button class="ClsButton clsButtonUpload" onclick="download(${tradeLicencePartnerChange.rti_ref_id},'tradeLicensePartnerChnageCertificateReport.do')">GENERATE CERTIFICATE</button>
	...
	<c:if test="${requestScope.rtiApplication.workFlowStatus==2}">
				...
				<tr>
					<td colspan="6" align="center"><a
						...
						onclick="downloads('${tradeLicencePartnerChange.rti_ref_id}', 'tradeLicensePartnerChnageCertificateReport.do');"
						type="button" target="_blank"> <span class="download"
							style="display: flex; align-items: center;width: 160px;">Generate
								Certificate</span>
											...
											onclick="download1(${tradeLicencePartnerChange.rti_ref_id});return false;"><span
	...
	<table width="100%" border="0" cellpadding="2" cellspacing="2"
		class="container">
                     <tr>
                     <td colspan="5">
                      <span class="ClsLabel" style="font-size:14px"><fmt:message key="List of Documents (Attachment) For TradeLicence Partner Change" />:</span>
                     </td>
                     </tr>
                    ...
                    <span class="ClsLabel" style="font-size:14px"><fmt:message key="label.tradeLicensePartnerChange.nocforrelateddept" />:</span>
...
<a class="bg-button btn btn-primary bd-highlight action"
   ...
   <span class="download" style="align-items: center;color:white;">Download</span>
                    ...
                    <span class="ClsLabel" style="font-size:14px"><fmt:message key="label.tradeLicensePartnerChange.copyofformerlicnse" />:</span>
                     <c:if test="${requestScope.downloadCount>0}">
...
<a class="bg-button btn btn-primary bd-highlight action"
   ...
   <span class="download" style="align-items: center;color:white;">Download</span>
                     ...
                     <tr>
                     <td>
                    <span class="ClsLabel" style="font-size:14px"><fmt:message key="label.tradeLicensePartnerChange.propertynodue" />:</span>
                     <c:if test="${requestScope.downloadCount>0}">
...
<a class="bg-button btn btn-primary bd-highlight action"
   ...
   <span class="download" style="align-items: center;color:white;">Download</span>
                    ...
                    <span class="ClsLabel" style="font-size:14px"><fmt:message key="label.tradeLicensePartnerChange.buildingauthdocument" />:</span>
                     <c:if test="${requestScope.downloadCount>0}">
...
function saveEntity()
{
	onPageSubmit('<c:out value="${contextRoot}"/>/rtiapplication/createTradeLicencePartnerChangeWork.do');
}
