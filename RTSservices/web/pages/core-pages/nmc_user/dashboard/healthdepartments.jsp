...
.cards-container {
  ...
  grid-template-columns: repeat(auto-fit, minmax(350px, 1fr));
  gap: 24px;
  row-gap: 36px; /* Extra vertical row spacing */
  min-height: calc(100vh - 200px);
}
...
<body id="home" class="bg-grey">
	<div class="container-fluid">
		<div class="row p-2 border bg-blue d-flex align-items-center" id="xyz">
			...
			<div class="col-md-10">
				<!-- Modified column width to 10 -->
				<h3 class="m-0"
					style="color: white; align-content: end; font-size: 22;">नागपूर
					महानगरपालिका, नागपूर</h3>
				<h3 class="m-0" style="color: white; font-size: 22;">Right to
					Services</h3>
			</div>
			<div class="col-md-1">
			...
			<div class="row">
				<div class="col-md-6 d-flex align-items-center">
					<ol class="breadcrumb bg-white pb-0">
						<li class="breadcrumb-item" style="font-size: 16px;"><a
							href='<c:out value="${contextRoot}"/>/ws/nmc/dashboard.do'><strong>मुख्यपृष्ठ</strong></a></li>
						<li class="breadcrumb-item active" style="font-size: 16px;"><strong>आरोग्य
								विभाग</strong></li>
				...
				<div class="col-md-6 d-flex justify-content-end ">
					...
					<div class="dropdown-menu">
						<a class="dropdown-item"
							href='<c:out value="${contextRoot}"/>/ws/dashboard/myprofile.do'><i
							class="fa fa-user p-2"></i> My Account</a> <a class="dropdown-item"
							href="#" onclick="find()"><i class="fa fa-sticky-note-o p-2"></i>
							My Application</a>
						<div class="dropdown-divider"></div>
						<a class="dropdown-item"
							href='<c:out value="${contextRoot}"/>/ws/user/logout.do'><i
							class="fa fa-sign-out p-2"></i> Log out</a>
					</div>
					<!-- Basic dropdown -->
				</div>
			</div>
  ...
  <div class="cards-container">
	...
	<div
		...
		<div class="row ">
			...
			<div class="col-md-4">
				<div class="card shadow text-bg-warning1 mb-3 bbxx3">
					<div
				...
				<div class="card shadow text-bg-secondary1 mb-3 bbxx1">
					<div
						...
						<a class="lbleng zoom-text" href="#"> Tax & Assessment (कर व
							कर आकारणी विभाग)<span class="service-count">(13)</span> </a>
						<div class="wtt_">
					...
					<div class="card-body">
						<ol class="watermark-text1" type="1">
							...
							<li><a class="lbleng zoom-text" href='<c:out value="${contextRoot}"/>/ws/rtiapplication/newRTIPropertyTaxExemption.do'>Tax Waiver (कर
									माफी मिळणे/रहिवासी नसलेल्या मालमत्ता ना सूट मिळणे)</a></li>
							<li><a class="lbleng zoom-text" href="https://nmcnagpur.gov.in/pay-your-dues" target='_blank'>Sky Sign -
									New/Renewal License (आकाश चिन्ह नवीन जाहिरात आकाश चिन्ह पारवाना
									/ व परवाना नूतनीकरण)</a></li>
							<li><a class="lbleng zoom-text" href="https://nmcnagpur.gov.in/pay-your-dues"  target='_blank'>Filing a
							...
							<li><a class="lbleng zoom-text" href="https://nmcnagpur.gov.in/pay-your-dues" target='_blank'>Property
									Division in Subdivision (Duplicate) (उपविभाग मध्ये मालमत्ता
									विभाजन)</a></li>
						</ol>
					</div>
				</div>
			...
			<div class="col-md-4">
				<div class="card shadow text-bg-info1 mb-3 bbxx3">
					<div
						class="card-header pointer d-flex justify-content-between align-items-center">
					...
					<div class="card-body">
						<ol class="watermark-text1" type="1">
							...
							<li><a class="lbleng zoom-text" href="#">Building Permit
									(बांधकाम परवाना देणे)</a></li>
							<li><a class="lbleng zoom-text" href="#">Zote
									Certificate (झोते प्रमाणपात्र देणे)</a></li>
							<li><a class="lbleng zoom-text" href="#">Bhogavata
									Certificate (भोगावटा प्रमाणपत्र)</a></li>
							<li><a class="lbleng zoom-text" href="#">Mobile Tower
			...
			<div class="col-md-4">
				<div class="card shadow text-bg-primary1 mb-3 bbxx2">
					<div
						class="card-header pointer d-flex justify-content-between align-items-center">
			...
			<div class="col-md-4">
				<div class="card shadow text-bg-danger1 mb-3 bbxx1">
					<div
						class="card-header pointer d-flex justify-content-between align-items-center">
		...
		<div class="row ">
			...
			<!-- Estate Department -->
			<div class="col-md-4">
				<div class="card shadow text-bg-dark1 mb-3 bbxx2">
					<div
						class="card-header pointer d-flex justify-content-between align-items-center">
			...
			<!-- Garden Department -->
			<div class="col-md-4">
				<div class="card shadow text-bg-success1 mb-3 bbxx3">
					<div
						class="card-header pointer d-flex justify-content-between align-items-center">
		...
		<div class="row ">
			...
			<div class="col-md-4">
				<div class="card shadow text-bg-info1 mb-3 bbxx1">
					<div
						class="card-header pointer d-flex justify-content-between align-items-center">
			...
			<div class="col-md-4">
				<div class="card shadow text-bg-dark1 mb-3 bbxx2">
					<div
						class="card-header pointer d-flex justify-content-between align-items-center">
						<a class="lbleng zoom-text" href="#"> Hot mixed planned Department<span class="service-count">(3)</span></a>
						<div class="wtt_">
							<img src="<%=url%>img/estate.png" alt="Estate">
						</div>
					</div>
					<div class="card-body">
						<ol class="watermark-text1" type="1">
							<li><a class="lbleng zoom-text" href="https://www.nmcnagpur.gov.in/grievance/complaint_form.php"  target='_blank'>रस्त्यावरील खड्डे बुजवणे (HMP)</a></li>
							<li><a class="lbleng zoom-text" href="https://www.nmcnagpur.gov.in/grievance/complaint_form.php"  target='_blank'>गटारावरील झाकण सुस्तीत ठेवणे (PHE)</a></li>
							<li><a class="lbleng zoom-text" href="https://www.nmcnagpur.gov.in/grievance/complaint_form.php"  target='_blank'>शहरात स्वच्छता ठेवणे. (SWM)</a></li>
						</ol>
					</div>
				</div>
			</div>
