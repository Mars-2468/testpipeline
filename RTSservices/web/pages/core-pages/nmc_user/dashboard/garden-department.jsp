...
<div class="container-fluid my-3">
	<div class="container">
    	<div class="row mb-4">
           ...
           <div class="col-md-3 mb-4">
                <a class="card" style="width: 258px;height:89px" href='<c:out value="${contextRoot}"/>/ws/rtiapplication/newRTSTreeTrimmingApplication.do'>
                    <div class="card-body d-flex align-items-top justify-content-between">
                                  <span class="title-width platform-title" ><p class="h5 m-0"><strong>वृक्षांच्या फांद्या<br>कापण्यासाठी परवानगी</strong></p></span>
