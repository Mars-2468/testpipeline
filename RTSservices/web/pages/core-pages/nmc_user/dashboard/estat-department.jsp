    	...
    	<div class="row">
        	<div class="col-md-6 d-flex align-items-center">
            	<ol class="breadcrumb bg-white pb-0">
                    ...
                    <li class="breadcrumb-item active" style="font-size:16px;"><strong>स्थावर विभाग</strong></li>
...
<div class="container-fluid my-3">
	<div class="container">
    	<div class="row mb-4">
             <div class="col-md-3 ">
                            <a class="card border" style="width: 258px;height:96px" href='<c:out value="${contextRoot}"/>/ws/rtiapplication/newRTIMandapApplication.do'>
                    <div class="card-body d-flex align-items-top justify-content-between">                    			 
                                  <span class="title-width platform-title"><p class="h5 m-0"><strong>मंडपासाठी
 ना हरकत प्रमाणपत्र</strong></p></span>
								   <p class="image-icon d-inline-block m-0 mr-0 float-right"><img src="<%=url%>img/mandap.png"></p>	
...
गणेश मंडप<br> परवानगी</strong></p></span>
								   <p class="image-icon d-inline-block m-0 mr-0 float-right"><img src="<%=url%>img/ganesh.png"></p>	
             ...
             <div class="col-md-3 ">
                    ...
                    <div class="card-body d-flex align-items-top justify-content-between">                    			 
                                  <span class="title-width platform-title"><p class="h5"><strong>
दुर्गा उत्सव/गरबा मंडप परवानगी</strong></p></span>
								   <p class="image-icon d-inline-block m-0 mr-0 float-right"><img src="<%=url%>img/durga1.png"></p>	
          ...
          <%--    <div class="col-md-3 mb-4">
                            <a class="card" style="width: 260px;height:96px"
                                ...
                                <div class="card-body d-flex align-items-top justify-content-between">
                                    <span class="title-width platform-title">
                                        <p class="h5"><strong>फटाके दुकानाचा <br>परवाना</strong><br>
                                        </p>
                                    </span>
                                    <p class="image-icon d-inline-block m-0 mr-0 ms-1 float-right"><img
                                            src="<%=url%>img/diwaliCrackers.png"></p>
                                </div>
                            </a>
                        </div>
             --%>
             <div class="col-md-3 mb-4">
                <a class="card" style="width: 260px;height:96px" href='<c:out value="${contextRoot}"/>/ws/rtsapplication/newRTSDikshaBhoomiApplication.do'>
                    <div class="card-body d-flex align-items-top justify-content-between">
                                  <span class="title-width platform-title"><p class="h5"><strong>दीक्षा भूमी <br>मंडप परवानगी</strong><br></p></span>
                                   <p class="image-icon d-inline-block m-0 mr-0 ms-1 float-right"><img src="<%=url%>img/deekshabhoomi.jpg"></p>                               
                              </div>
                </a>
            </div>
...
/* function mandap(){
onPageSubmit('<c:out value="${contextRoot}"/>/ws/rtiapplication/newRTIMandapApplication.do');
}
