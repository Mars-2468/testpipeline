...
<link rel="stylesheet" type="text/css"
	href="<c:out value='${contextRoot}'/>/pages/core-pages/nmc_user/css/style1.css" />
...
#home {
	background-image:
		url('<c:out value=" ${contextRoot}" />/pages/core-pages/nmc_user/img/citizenbackground.jpg');
				...
				<div class="col-md-12 pl-md-0">
					<div class="row align-items-center justify-content-center">
							...
							<div class="sign-card">
								...
								<div class="input-group">
									<div>
										...
										<input id="fname"
											class="search form-control form-control-lg mb-3" type="text"
											pattern="[A-Za-z]+" style="width: 243px;"
                        ...
                        <c:otherwise>
								...
								<input id="email"
									class="search form-control form-control-lg mb-3" type="email"
                        ...
                        <c:otherwise>
								...
								<input id="mobile"
									class="search form-control form-control-lg mb-3"
                        ...
                        <c:otherwise>
								...
								<input type="hidden" name="originalMobileNo"
									id="originalMobileNo"
									value="<%= request.getParameter("mobileNo") %>">
	  ...
	  // Check every second
								...
								<c:choose>
									<c:when test="${not empty mobileNo}">
										<div>
											<input id="otp"
												class="search form-control form-control-lg mb-1" name="otp"
												placeholder="Enter OTP" type="text" pattern="[0-9]{6}"
												onblur="validateOTP()"> <input type="hidden"
												name="originalOtp" id="originalOtp" value="" onInput="this.value=this.value.slice(0,6) "/>
                            	   ...
                            	   otpInput.addEventListener('blur', validateOTP);
										...
										<div>
											<a class="bg-button btn btn-primary bd-highlight"
												onclick="javascript:submit(this.form);">Register</a> <a
												id="resendBtn"
												class="bg-button btn btn-primary bd-highlight"
												style="width: 120px;" onclick="resend(this.form)">Resend
												OTP</a> <span id="timer"
												style="display: none; color: black; margin-left: 80px; margin-top: 20px;"></span>
									...
									<c:otherwise>
										<div class="pt-4">
											<a class="bg-button btn btn-primary bd-highlight"
												onclick="javascript:save(this.form);">Send OTP</a> <a
												class="active float-right"
												onclick="javascript:login(this.form);">Login</a>
...
function resend() {
  ...
  for (var pair of formData.entries()) {
      console.log(pair[0] + ': ' + pair[1]);
       ...
       var mbno=$('#mobile').val();
       $.ajax({
    	   url: "/RTSservices/nmc/user/resendOtp.do?mobileNo="+mbno,
    	   type: "POST",
           dataType: "json",
