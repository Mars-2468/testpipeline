...
<div class="container-fluid"  style="">
	<div class="row p-2 border bg-blue d-flex align-items-center">
    	<div class="col-md-1"><img src="<%=url%>img/nagpur.png" class="img-fluid"></div>
          ...
          <div class="col-md-10 "><p class="h2 text-center text-white"><strong >नागपूर महानगरपालिका</strong></p></div>
                    	    	<div class="col-md-1"><img src="<%= url%>img/g21.png" class="img-fluid"></div>
                  <div class="col-md-10 "><p class="h3" style="padding-left: 532px; color:white;">Nagpur Municipal Corporation</p></div>
    	...
    	<div class="row">
        	<div class="col-md-6 d-flex align-items-center">
            	<ol class="breadcrumb bg-white pb-0">
                    <li class="breadcrumb-item"><a href='<c:out value="${contextRoot}"/>/ws/nmc/dashboard.do'>मुख्यपृष्ठ</a></li>
                    <li class="breadcrumb-item active">स्थावर विभाग</li>
    	...
    	<div class="row mb-4">
             <div class="col-md-3 ">
                    ...
                    <div class="card-body d-flex align-items-top justify-content-between">                    			 
                                  <span class="title-width platform-title"><p class="h5 m-0"><strong>मंडपांसाठी ना हरकत प्रमाणपत्र</strong><br><p class="h5 m-0">Mandap Permission</p></span>
...
गणेश मंडप परवानगी</strong><br><p class="h5 m-0">Ganesh Mandap Permission</p></span>
