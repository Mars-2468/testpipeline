...
.highcharts-data-table tr:hover {
    background: #f1f7ff;
        ...
        <div class="row">
                 ...
                 <a class="card" style="width: 263px" href='<c:out value="${contextRoot}"/>/pages/core-pages/dashboard/birth.do'>
                    <div class="card-body d-flex align-items-top justify-content-between">                    			 
                                  <span class="title-width platform-title"> <p class="h5 m-0">Birth<br>Certificate</p></span>
                                   <p class="image-icon d-inline-block m-0 mr-0 float-right"><img src="<%=url%>img/birth.png"></p>                               
                ...
                <a class="card" style="width: 263px" href='<c:out value="${contextRoot}"/>/ws/rtsapplication/death.do'>
                    <div class="card-body d-flex align-items-top justify-content-between">                    			 
                                  <span class="title-width platform-title"><p class="h5 m-0">Death<br>Certificate</p></span>
								   
                                   <p class="image-icon d-inline-block m-0 mr-0 float-right"><img src="<%=url%>img/death.png"></p>                               
...
<h2 style="text-align:center">Birth-Death Department Applications Data</h2>
