...
<hr>
<h2 style="text-align:center">Trade License Duplication Applications Data</h2>
...
/*  Highcharts.chart('container', {
 ...
 function getListOnCategory(category){
	 ...
	 onPageSubmit('<c:out value="${contextRoot}"/>/dashBoard/getTradeduplicationListOnCategory.do');
