...
<hr>
<h2 style="text-align:center">Trade License Type Change Applications Data</h2>
...
/*  Highcharts.chart('container', {
 ...
 function getListOnCategory(category){
	 ...
	 onPageSubmit('<c:out value="${contextRoot}"/>/dashBoard/getTradeLicenseTypeChangeListOnCategory.do');
