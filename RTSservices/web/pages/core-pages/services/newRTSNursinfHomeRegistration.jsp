...
$(window).on('load', function(){
	...
	<form class="needs-validation" novalidate>
		<div class="container-fluid mt-2" style="width: 1320px;">
			<div class="printable">
				<h3 class="text-center">Application for Nursing Home Registration
					(नर्सिंग होम नोंदणीसाठी अर्ज)</h3>
			</div>
...
<div class="mb-1" >
    ...
    <input type="date" class="form-control" style="background-image: none;" id=""  placeholder="" name="registrationDate" value="" required>
...
<div class="mb-3 mt-3">
    ...
    <input type="text" class="form-control" style="background-image: none;" id="" placeholder="" name="phone" value=""
...
<div class="row">
    ...
    <input type="email" class="form-control" style="background-image: none;" id="" placeholder="" name="email" value="" required>
...
<div class="row">
    ...
    <input type="text" class="form-control" style="background-image: none;" id="" onkeydown="return /[a-z ]/i.test(event.key)" placeholder="" name="name" value="" required>
...
<div class="mb-3 mt-0">
    ...
    <textarea class="form-control" style="background-image: none;" id="" placeholder="" name="applicantAddress" rows="3" required></textarea>
...
<input type="text" class="form-control" style="background-image: none;" id="" placeholder="" name="techQul" value="" required>
...
<div class="row">
   ...
   <select class="form-select" style="background-image: none;" name="nationality" required>
...
<div class="row">
    ...
    <textarea class="form-control" style="background-image: none;" rows="3" name="situationOf" required></textarea>
...
<div class="row">
    ...
    <input type="text" class="form-control" style="background-image: none;" id="" onkeydown="return /[a-z ]/i.test(event.key)" placeholder="" name="nameRegNursingHome" value="" required>
                <div class="invalid-feedback">Please Enter Valid  Name and Other particulars of the nursing home in respect of which the registration is applied for.
</div>
</div>
...
<div class="row">
    ...
    <input type="text" class="form-control" style="background-image: none;" id="" placeholder="" name="placeOfNStaff" value="" required>
...
<!-- <div class="row">
    ...
    <input type="text" class="form-control" style="background-image: none;" id="" onkeydown="return /[a-z ]/i.test(event.key)" placeholder="" name="autoCad" value="" required>
...
<div class="row">
    ...
    <input type="text" class="form-control" style="background-image: none;" id="" onkeydown="return /[a-z ]/i.test(event.key)" placeholder="" name="connectionOfPremises" value="" required>
...
<div class="row">
    ...
    <input type="number" class="form-control" style="background-image: none;" id="" placeholder=" " name="maternityPatients" value="" required>
...
<body>
 ...
 <label for="" class="form-label">10.Names,Ages and Qualification of the Resident or Visiting physicians or Surgeons in the Nursing Home (नर्सिंग  होममधील निवासी किंवा भेट देणारे डॉक्टर किंवा सर्जन यांची नावे, वय आणि पात्रता)<span class="text-danger" style="color: red;">*</span></label>
...
<table id="doctorTable">
    ...
    <tbody>
        ...
        <tr>
            <td>1</td>
            <td><input type="text" name="doctorName"  onkeydown="return /[a-z ]/i.test(event.key)" required/><div class="invalid-feedback">Please Enter Doctor Name</div></td>
            
            <td><input type="number" name="doctorAge" required/><div class="invalid-feedback">Please Enter Age</div></td>
            <td><input type="text" name="doctorEducation"  onkeydown="return /[a-z ]/i.test(event.key)" required/><div class="invalid-feedback">Please Enter Education</div></td>
            <td><input type="text" name="doctorRegNo" required/><div class="invalid-feedback">Medical Reg No</div></td>
            <td>
...
<table id="nursingTable">
    ...
    <tbody>
        ...
        <tr>
            <td>1</td>
            <td><input type="text" name="nurseName"  onkeydown="return /[a-z ]/i.test(event.key)" required/><div class="invalid-feedback">Please Enter Nurse Name</div></td>
            <td><input type="number" name="nurseAge" required/><div class="invalid-feedback">Please Enter Age</div></td>
            <td><input type="text" name="nurseEducation"  onkeydown="return /[a-z ]/i.test(event.key)" required/><div class="invalid-feedback">Please Enter Education</div></td>
            <td><input type="text" name="nurseRegNo" required/><div class="invalid-feedback">Please Enter Nursing Council Reg No</div></td>
            <td>
...
<div class="row">
    ...
    <label for="" class="form-label">12.Place Where Nursing Staff is Accommodated (नर्सिंग स्टाफ ला राहण्याची जागा)<span class="text-danger" style="color: red;">*</span></label>

    <input type="text" class="form-control" style="background-image: none;" id="" onkeydown="return /[a-z ]/i.test(event.key)" placeholder="" name="nursingStaffAccommodated" value="" required>
                <div class="invalid-feedback">Please Enter Valid  Place Where Nursing Staff is Accommodated.</div>
</div>
...
<div class="row">
    ...
    <div class="mb-3 ">
                    <label for="" class="form-label lbleng">13 (a).Whether the nursing
                        homes is under the supervision of qualified medical practitioner or a qualified nurse ,and if  qualifications (नर्सिंग होम पात्र वैद्यकीय व्यवसायी किंवा पात्र परिचारिका यांच्या देखरेखीखाली आहेत आणि पात्रता असल्यास) <span
...
<div class="row">
    ...
    <label for="" class="form-label">(b).Proportion of the qualified and unqualified  nurses  on the nursing staff (नर्सिंग कर्मचाऱ्यांवर पात्र आणि अपात्र परिचारिकांचे प्रमाण) <span class="text-danger" style="color: red;">*</span></label>

    <input type="text" class="form-control" style="background-image: none;" id="" placeholder="" name="unregMedUnquilNursingStaff" value="" required>
                    ...
                    <label for="" class="form-label">(b).Whether any unregistered medical practitioner or<br> unqualified midwife is employed for nursing of  patients <br> in the nursing home (नर्सिंग होममध्ये <br> रुग्णांच्या शुश्रुषेसाठी नोंदणीकृत नसलेले वैद्यकीय व्यवसायी किंवा अपात्र दाईची नियुक्ती केली आहे का.) <span class="text-danger" style="color: red;">*</span></label>
                      <select class="form-control" style="background-image: none;" id="unregistered_medical_practitionar" placeholder="" name="unregisteredMedicalPractitionar" value="" required>
                        ...
                        <option value="No">No</option>
                                         ...
                                         <div class="invalid-feedback">Please Select Unregistered medical practitionar .</div> 
...
<div class="invalid-feedback">Please Enter Valid Whether the applicant is
...
<div class="row"> 
    ...
    <div class="mb-3 ">
							<label for="" class="form-label ">17.Zone No(झोन क्र.)<span
								...
								id="iFunction" name="zoneNo" onchange="callHospitalList(this)" required>
				...
				<p style="color: red">
					...
					<strong>List of document to be attached :</strong>
                         ...
                         <ul>
                            ...
                            <li>1. Self  attested copy of Hospital/Nursing Home Map sanctioned by NMC/NIT (एनएमसी/एनआयटीने मंजूर केलेल्या हॉस्पिटल/नर्सिंग होम नकाशाची स्व-साक्षांकित प्रत)<span class="text-danger" style="color: red;">*</span></li>
<li>2. Autocad maps showing medical facilities with required space reserved for beds in sq.ft. (sq.ft मध्ये बेडसाठी आरक्षित आवश्यक जागेसह वैद्यकीय सुविधा दर्शवणारे ऑटोकॅड नकाशे.)<span class="text-danger" style="color: red;">*</span></li>
<li>3. Fire NOC/Fire audit of Hospital/Nursing home building. (हॉस्पिटल / नर्सिंग होम इमारतीचे फायर ऑडिट.)<span class="text-danger" style="color: red;">*</span></li>
<li>4. Structual audit of Hospital/Nursing home building. (रुग्णालय/ नर्सिंग होम इमारतीचे स्ट्रक्चरल ऑडिट.)<span class="text-danger" style="color: red;">*</span></li>
<li>5. Electrical audit of Hospital/Nursing home building. (हॉस्पिटल / नर्सिंग होम इमारतीचे इलेक्ट्रिकल ऑडिट.)<span class="text-danger" style="color: red;">*</span></li>
<li>6. Property tax receipt of place where Hospital/Nursing home is situated. (ज्या ठिकाणी हॉस्पिटल/ नर्सिंग होम आहे त्या ठिकाणची मालमत्ता कर पावती)<span class="text-danger" style="color: red;">*</span></li>
<li>7. Bio Medical waste registration receipt fromm authorized agency. (अधिकृत एजन्सीकडून जैव वैद्यकीय कचरा नोंदणीची पावती.)<span class="text-danger" style="color: red;">*</span></li>
<li>8. Documents of educational qualification of Consultant/Duty Medical Officers as per sr. no. 11 mentioned in application. (सल्लागार/ड्युटी वैद्यकीय अधिकाऱ्यांच्या शैक्षणिक पात्रतेची कागदपत्रे.)<span class="text-danger" style="color: red;">*</span></li>
<li>9. Nursing Council Registration Certificate of all nursing staff BSC Nursing/GNM/ANM. (सर्व नर्सिंग स्टाफचे नर्सिंग कौन्सिल नोंदणी प्रमाणपत्र BSC नर्सिंग/GNM/ANM.)<span class="text-danger" style="color: red;">*</span></li>
<li>10. Documents of ownership or tenancy related to Hospital/Nursing home building.(हॉस्पिटल/नर्सिंग होम इमारतीशी संबंधित मालकी किंवा भाडेकराराची कागदपत्रे.)<span class="text-danger" style="color: red;">*</span></li>
<li>11. List of major medical, surgical & diagnostic equipments & machinaries.(प्रमुख वैद्यकीय, शस्त्रक्रिया आणि निदान उपकरणे आणि यंत्रसामग्रीची यादी.)<span class="text-danger" style="color: red;">*</span></li>
<li>12. Concert to establishment from Maharashtra polution Control Board.(महाराष्ट्र प्रदूषण नियंत्रण मंडळाकडून स्थापनेची मैफल.)<span class="text-danger" style="color: red;">*</span></li>
<li>13. Affidavit (प्रतिज्ञापत्र)<span class="text-danger" style="color: red;">*</span></li>
