...
<h3 style="
    height: 30px;
		...
		<fmt:message key="Partition Of Property" />
		:
...
<div valign="top" id="SetFormHeight">
	<input type="hidden" name="id"
		value="${partitionOfProperty.partitionOfPropertyId}">
	<c:set var="doc"
	...
	<table width="100%" border="0" cellpadding="2" cellspacing="2">
		...
		<tr>
			...
			<td colspan="2"><input type="text" class="form-control"
				...
				value="<c:out value="${partitionOfProperty.name}"/>" disabled />
			<td colspan="1.5"><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="tax.label.appllicantEmaailId" />:</span></td>
			<td colspan="2"><input type="text" class="form-control"
				style="width: 250px" id="ph_no" maxlength="50" name="ph_no"
				value="<c:out value="${partitionOfProperty.emailid}"/>" disabled />
			</td>
		</tr>
		<tr>
			<td colspan="1.5"><span class="ClsLabel" style="font-size: 14px"><fmt:message
			...
			<td colspan="2"><input type="text" class="form-control"
				...
				value="<c:out value="${partitionOfProperty.mobileNo}"/>" disabled />
			</td>
			...
			<td colspan="2"><input type="text" class="form-control" id="dob"
				...
				value="<c:out value="${partitionOfProperty.propertyHolderName}"/>"
				disabled /></td>
		...
		<tr>
			...
			<td colspan="2"><input type="text" class="form-control"
				...
				name="childeName"
				value="<c:out value="${partitionOfProperty.zoneNo}"/>" disabled /></td>
			...
			<td colspan="2"><input type="text" class="form-control"
				...
				name="childeName"
				value="<c:out value="${partitionOfProperty.ownerName}"/>" disabled />
			</td>
</tr>
		...
		<tr>
			...
			<td colspan="1.5"><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="
Ward No. (प्रभाग क्र.)" />:</span></td>
			<td colspan="2"><input type="text" class="form-control"
				style="width: 180px" id="fatherName" maxlength="45" tabindex="4"
				name="fatherName"
				value="<c:out value="${partitionOfProperty.blockNo}"/>" disabled />
			</td>
<td colspan="1.5"><span class="ClsLabel" style="font-size: 14px"><fmt:message
			...
			<td colspan="2"><input type="text" class="form-control"
				style="width: 180px" id="childeName" maxlength="45" tabindex="3"
				name="childeName"
				value="<c:out value="${partitionOfProperty.blockName}"/>" disabled />
			</td>
		...
		<tr>
			...
			<td colspan="2"><input type="text" class="form-control"
				style="width: 180px" id="fatherName" maxlength="45" tabindex="4"
				name="fatherName"
				value="<c:out value="${partitionOfProperty.upinNo}"/>" disabled /></td>
			...
			<td colspan="2"><input type="text" class="form-control"
				style="width: 180px" id="childeName" maxlength="45" tabindex="3"
				name="childeName"
				value="<c:out value="${partitionOfProperty.taxPincode}"/>" disabled />
			</td>
		...
		<tr>
			...
			<td colspan="2"><input type="text" class="form-control"
				style="width: 180px" id="childeName" maxlength="45" tabindex="3"
				name="childeName"
				value="<c:out value="${partitionOfProperty.indexNo}"/>" disabled />
			</td>
			...
			<td colspan="2"><input type="text" class="form-control"
				style="width: 180px" id="childeName" maxlength="45" tabindex="3"
				name="childeName"
				value="<c:out value="${partitionOfProperty.address}"/>" disabled />
			</td>
		...
		<tr>
			...
			<td colspan="2"><input type="text" class="form-control"
				style="width: 180px" id="childeName" maxlength="45" tabindex="3"
				name="childeName"
				value="<c:out value="${partitionOfProperty.taxMobileNo}"/>" disabled />
			</td>
			...
			<td colspan="2"><input type="text" class="form-control"
				style="width: 180px" id="childeName" maxlength="45" tabindex="3"
				name="childeName"
				value="<c:out value="${partitionOfProperty.areasPending}"/>"
				disabled /></td>
</tr>
		...
		<tr>
			...
			<td colspan="2"><input type="text" class="form-control"
				style="width: 180px" id="childeName" maxlength="45" tabindex="3"
				name="childeName"
				value="<c:out value="${partitionOfProperty.areasPendingStatus}"/>"
				disabled /></td>
				</tr>
		<tr>
			<td colspan="1.5"><span class="ClsLabel" style="font-size: 14px"><fmt:message
			...
			<td colspan="2"><input type="text" class="form-control"
				style="width: 180px" id="childeName" maxlength="45" tabindex="3"
				name="childeName"
				value="<c:out value="${partitionOfProperty.duesAmt}"/>"
				disabled /></td>
...
<%--  <c:if test="${requestScope.rtiApplication.workFlowStatus==3 ||requestScope.rtiApplication.workFlowStatus==2 || requestScope.rtiApplication.workFlowStatus==1}">
     <tr >
			...
			<input type="file" class="imagefile" name="paymentReceiptidProof" id="paymentReceiptidProof" style="width: 220px" />
                   ...
                   <td>   
                      <c:if test="${ empty partitionOfProperty.paymentReceipt}">   
               
                <a class="bg-button btn btn-primary bd-highlight" style="color:white" id="paymentReceiptdocupload" type="button" target="_blank" onclick="paymentReceiptupload(${partitionOfProperty.rti_ref_id}); return false;"><span
							class="download" style="align-items: center">Upload</span></a>
               
                </c:if>
              <c:if test="${ not empty partitionOfProperty.paymentReceipt}">
              
               <a class="bg-button btn btn-success bd-highlight action" style="color:white" id="paymentReceiptdownload"  class="imagefile" type="button" target="_blank" href="<c:out value="${partitionOfProperty.paymentReceipt}"/>"><span
			...
			<tr>
				<td colspan="3.5"><span class="ClsLabel"
					style="font-size: 14px"><fmt:message
							key="Copy of Registered Sale Deed (नोंदणीकृत विक्री कराराची प्रत)" />:</span> 
   ...
   <span class="download" style="align-items: center;color:white;">Download</span>
		...
		<c:if test="${doc[1] != 'null'}">
			<tr>
				<td colspan="3.5"><span class="ClsLabel"
					style="font-size: 14px"><fmt:message
							key="Akhiv Patrika of City Land Survey Department (नगर भूमापन विभागाची आखीव पत्रिका)" />:</span> 
				<td style="text-align: center" colspan="3.5"><a class="bg-button btn btn-primary bd-highlight action"
   type="button"
   target="_blank"
   ...
   <span class="download" style="align-items: center;color:white;">Download</span>
		...
		<c:if test="${doc[2] != 'null'}">
			<tr>
				<td colspan="3.5"><span class="ClsLabel"
					style="font-size: 14px"><fmt:message
							key="Self Attested Applicant's Id Proof (स्वत: प्रमाणित अर्जदाराचा आयडी पुरावा)
" />:</span> 
				<td style="text-align: center" colspan="3.5"><a class="bg-button btn btn-primary bd-highlight action"
   type="button"
   target="_blank"
   ...
   <span class="download" style="align-items: center;color:white;">Download</span>
	...
	<c:if test="${doc[3] != 'null'}">
			<tr>
				<td colspan="3.5"><span class="ClsLabel"
					style="font-size: 14px"><fmt:message
							key="Regularization Letter (RL) (नियमितीकरण पत्र (RL))" />:</span> 
				<td style="text-align: center" colspan="3.5"><a class="bg-button btn btn-primary bd-highlight action"
   type="button"
   target="_blank"
   ...
   <span class="download" style="align-items: center;color:white;">Download</span>
		...
		<c:if test="${doc[5] != 'null'}">
			<tr>
				<td colspan="3.5"><span class="ClsLabel"
					style="font-size: 14px"><fmt:message
							key="Copy of Electric Bill (इलेक्ट्रिक बिलाची प्रत)" />:</span> 
				<td style="text-align: center" colspan="3.5"><a class="bg-button btn btn-primary bd-highlight action"
   type="button"
   target="_blank"
...
<%-- 		<c:if test="${partitionOfProperty.fees == 0.0}">
<tr>
...
<td colspan="4" align="center"><input type="button"
	...
	<input type="hidden" class="ClsTextbox_mr" style="width: 180px"
		...
		value="<c:out value="${partitionOfProperty.partitionOfPropertyId}"/>" />
	...
	<input type="hidden" id="rtiApplicationRefId"
		...
		value="${partitionOfProperty.rti_ref_id}" />
...
<script type="text/javascript">
	function saveEntity() {
		onPageSubmit('<c:out value="${contextRoot}"/>/rtiapplication/createPropertyTaxPartitionOfPropertyWork.do');
	}
	...
	function saveFees(){
		...
		onPageSubmit('<c:out value="${contextRoot}"/>/rtsapplication/savePropertyTaxPartitonOfPropertyFees.do?id='+refId);
		}else{
			return false;
		}
		}else{
	...
	function birthupload(id) {
  	  ...
  	  var receipt = "${partitionOfProperty.paymentReceipt}";
 ...
 /* 	
 	$(document).ready(function() {
 	    var paymentReceipt = '${partitionOfProperty.paymentReceipt}';
