...
<h3 style="
    height: 30px;
		...
		<fmt:message key="Property Tax No Due Certificate" />
		:
...
<div valign="top" id="SetFormHeight">
	<input type="hidden" name="id"
		value="${propertyTaxAssessment.propertyTaxNoDuesId}">
	<c:set var="doc"
...
<td colspan="1.5"><span class="ClsLabel" style="font-size: 14px"><fmt:message
		...
		<tr>
			...
			<td colspan="2"><input type="text" class="form-control"
				...
				name="childeName"
				value="<c:out value="${propertyTaxAssessment.zoneNo}"/>" disabled /></td>
			<td colspan="1.5"><span class="ClsLabel" style="font-size: 14px"><fmt:message
...
<td colspan="1.5"><span class="ClsLabel" style="font-size: 14px"><fmt:message
		...
		<tr>
			...
			<td colspan="2"><input type="text" class="form-control"
				style="width: 180px" id="childeName" maxlength="45" tabindex="3"
				name="childeName"
				value="<c:out value="${propertyTaxAssessment.duesAmt}"/>"
				disabled /></td>
			...
			<td colspan="2"><input type="text" class="form-control"
				style="width: 180px" id="childeName" maxlength="45" tabindex="3"
				name="childeName"
				value="<c:out value="${propertyTaxAssessment.houseNo}"/>"
				disabled /></td>
				
		</tr>
<c:if test="${userId == 3360}">
<tr>
	<td colspan="6" align="center"><a
		class="bg-button btn btn-success bd-highlight generateaction"
		id="genCerBtn" style="color: white"
		onclick="downloads('${propertyTaxAssessment.rti_ref_id}', 'taxNoduesCertificate.do');"
		type="button" target="_blank"> <span class="download"
			style="display: flex; align-items: center;width: 160px;">Generate
				Certificate</span>
							...
							onclick="download2(${propertyTaxAssessment.rti_ref_id});return false;"><span
   ...
   <span class="download" style="align-items: center;color:white;">Download</span>
		...
		<!--<c:if test="${doc[2] != 'null'}">
			<tr>
				<td colspan="3.5"><span class="ClsLabel"
					style="font-size: 14px"><fmt:message
							key="Copy of Demand Bill of
							Current Year (चालू वर्षाच्या मागणी बिलाची)" />:</span>
...
<input type="hidden" class="ClsTextbox_mr" style="width: 180px"
		id="propertyAssessmentID" maxlength="12" name="propertyAssessmentID" value="<c:out value="${propertyTaxAssessment.propertyTaxNoDuesId}"/>" /> 
...
<script type="text/javascript">
	function saveEntity() {
		onPageSubmit('<c:out value="${contextRoot}"/>/rtiapplication/createPropertyTaxNoDuesWork.do');
	}
