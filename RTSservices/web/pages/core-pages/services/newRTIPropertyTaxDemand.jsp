	...
	<form class="needs-validation" novalidate>
		<div class="container-fluid mt-2" style="width: 180vh">
			<div class="printable">
				...
				To Create Property Tax
						Demand Bill<br>(मालमत्ता कराची मागणी पत्र तयार करणे)
				</h3>
			</div>
			<hr class="custom-hr">
        ...
        <div class="invalid-feedback">Please Enter Valid Index No.</div>
				...
				<div class="col-md-3">
					<div class="mb-3 mt-3">
						...
						maxlength="80"	name="lastName" id="last_name" value="" pattern="[A-Za-z]+"
							onchange="Display(this.id)" required>
				...
				<div class="col-md-3">
					<div class="mb-3 mt-3">
						<label for="" class="form-label">Applicant's Name (अर्जदाराचे नाव)<span class="text-danger" style="color: red;">*</span></label>
...
<!-- 
				...
				<div class="col-md-3">
					<div class="mb-3 mt-3">
						...
						maxlength="80"	name="plotNo" value=""  pattern="^\s*\S.*$" required>
				...
				<div class="col-md-3">
					<div class="mb-3 mt-3">
						...
						maxlength="80"	style="background-image: none;" id="street_name" placeholder=""
				...
				<div class="col-md-3">
					<div class="mb-3 mt-3">
						<label for="" class="form-label"> Aadhaar No. (आधार क्र.)
							...
							name="aadharNo" value="" pattern="[0-9]{12}" maxlength="12">
			...
			<!--  <div class="col-md-12">
                            <div class="mb-3 mt-3">
                                ...
                                <textarea oninput="validateTextarea()" type=" text"  maxlength="80" class="form-control"  style="background-image: none;" id="myTextarea" placeholder="" name="addressForCorrespondence" value="" rows="2" required></textarea>                           
...
<input type="text" class="form-control"
				  		style="background-image: none;" name="nameOfProperyHolder" id="propertyHolderName" value=""
						 maxlength="255" pattern="^[A-Za-z ]+$" readonly />
			...
			<!-- 	<div class="col-md-3">
				...
				<div class="col-md-3 hospital_row" id="hos">
					<div class="mb-3 mt-4">
						...
						pattern="^\s*\S.*$" 	id="dependent-dropdown" name="wardNo"  disabled required>
				...
				<!-- <div class="col-md-3">
					<div class="mb-3 mt-4">
						<label for="" class="form-label lbleng">Name of Area
							(क्षेत्राचे नाव)</label> <input type="text" class="form-control"
						maxlength="80"	style="background-image: none;" id="" placeholder=""
							name="areaName" value="">
					</div>
				</div>
				<div class="col-md-3">
					<div class="mb-3 mt-3">
						<label for="" class="form-label lbleng">House No. (घर
							क्र.)<span class="text-danger" style="color: red;">*</span>
						</label> <input type="text" class="form-control"
							style="background-image: none;" id="" placeholder=""
					maxlength="80"		name="houseNo" value="" pattern="^\s*\S.*$"  required>
...
<script>
	...
	<!--		<br>
			...
			<div class="row">
					...
					<div class="col-md-3">
						<div class="mb-3 mt-4">
							<label for="" class="form-label">Self Attested Applicant's Id Proof (स्वत: प्रमाणित अर्जदाराचा आयडी पुरावा)<span class="text-danger"
								...
								style="background-image: none;" accept=".pdf" id="doc1" placeholder=""
			 		...
			 		<div class="col-md-3">
						<div class="mb-3 mt-4">
							<label for="" class="form-label lbleng">Property Tax
								Payment Receipt (मालमत्ता कर भरणा पावती)<span
								class="text-danger" style="color: red;">*</span>
							</label> <input type="file" class="form-control"
								style="background-image: none;" accept=".pdf" id="doc2" placeholder=""
								name="propertyTaxReceipt" required>
							<div class="invalid-feedback">File selected is either
								greater than 2Mb or not of type .pdf</div>
					...
					<div class="col-md-3">
						<div class="mb-3 mt-5">
							<label for="" class="form-label lbleng">Water Bill (पाणी
								बिल)</label> <input type="file" class="form-control"
					...
					<div class="col-md-3">
						<div class="mb-3 mt-4">
							<label for="" class="form-label lbleng"> Copy of Electric
								Bill (इलेक्ट्रिक बिलाची प्रत)<span class="text-danger"
								style="color: red;">*</span>
							</label> <input type="file" class="form-control"
								style="background-image: none;" accept=".pdf" id="doc4" placeholder=""
...
/*  
 $(function () {
     $("#upinNo, #indexNo").on('change', function (event) {
         ...
         $.ajax({
             type: "POST",
             url: "${pageContext.request.contextPath}/rtsapplication/propertyTaxTokenValidation.do?ptnNo="+ptnValue,
             dataType: "json",
             //async: false,
		        ...
		        Array.from(forms).forEach(form => {
		            form.addEventListener('submit', event => {
		                ...
		                if (!form.checkValidity() || !isFormValid) {
		                    ...
		                    onPageSubmit('<c:out value="${contextRoot}"/>/rtsapplication/savePropertyTaxDemand.do');
    ...
    data.append('idProof1', $("#doc1").get(0).files[0]);
            ...
            for (var i = 0; i < file.length; i++) {
       			...
       			const value = splitName + ".pdf";
                    ...
                    filesPath = filesPath + basePath + "PropertyTaxDemand/" + id + value + ","
                    isFileSelected = true;
                }
            }
            $.ajax({
                url: "<c:out value='${contextRoot}'/>/rtiapplication/uploadPropertyTaxDemand.do?id="+id,
                type: 'POST',
                data: data,
                cache: false,
                dataType: 'json',
