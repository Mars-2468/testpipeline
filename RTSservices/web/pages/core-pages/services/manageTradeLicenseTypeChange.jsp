...
<div class="container">
	<h3 style="font-size: 18px; font-weight: bold;">
		...
		<fmt:message key="Application Form For Trade License Type Change" />
		:
...
<div valign="top" id="SetFormHeight">
	<input type="hidden" name="id"
		value="${tradeLicenseTypeChange.tradeLicenseTypeID}">
	<table width="100%" border="0" cellpadding="2" cellspacing="2"
		...
		<tr>
			...
			<td><input type="text" class="form-control"
				...
				value="<c:out value="${tradeLicenseTypeChange.firstName}"/>" /></td>
			...
			<td><input type="text" class="form-control" style="width: 350px"
				...
				value="<c:out value="${tradeLicenseTypeChange.middleName}"/>" /></td>
		...
		<tr>
			...
			<td><input type="text" class="form-control"
				style="width: 350px;" id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${tradeLicenseTypeChange.lastName}"/>" /></td>

			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicenseTypeChange.fullname" />:</span><span
				class="ClsRequiredFields"></span></td>
			<td>
<input type="text" class="form-control" style="width: 350px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${tradeLicenseTypeChange.fullName}"/>" />
			</td>
		</tr>
		<tr>

			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicenseTypeChange.pincode" />:</span></td>
			<td><input type="text" class="form-control" style="width: 350px;"
					id="ownerAddress" maxlength="200" name="ownerAddress" value="<c:out value="${tradeLicenseTypeChange.pinCode}"/>"/></td>

			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicenseTypeChange.aadhaarno" /><span class="ClsRequiredFields"></span>: </td>
			<td><input type="text" class="form-control" style="width: 350px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${tradeLicenseTypeChange.aadhaarNo}"/>" /></td>

		</tr>
		<tr>

			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicenseTypeChange.emailid"/>:</span></td>
			<td><input type="text" class="form-control" style="width: 350px"
				id="changedHospitalNameAndAddress" maxlength="30"
				name="changedHospitalNameAndAddress"
				value="<c:out value="${tradeLicenseTypeChange.emailID}"/>" /></td>

			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicenseTypeChange.mobileno" /><span class="ClsRequiredFields"></span>: </td>
			<td><input type="text" class="form-control" style="width: 350px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${tradeLicenseTypeChange.mobileNumber}"/>" /></td>

		</tr>
		<tr>
		<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicenseTypeChange.addressForCorre" /><span class="ClsRequiredFields"></span>: </td>
			<td>
			<textarea class="form-control" style="width: 350px;"
					id="ownerAddress" maxlength="200" name="ownerAddress" rows="2">${tradeLicenseTypeChange.adressForCorrespondence}</textarea></td>
			
			</td>

			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicenseTypeChange.zoneno" />:</span></td>
			<td><input type="text" class="form-control" style="width: 350px"
				id="changedHospitalNameAndAddress" maxlength="30"
				name="changedHospitalNameAndAddress"
				value="<c:out value="${tradeLicenseTypeChange.zoneNo}"/>" /></td>
</tr>
<tr>
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicenseTypeChange.wardno" /><span class="ClsRequiredFields"></span>: </td>
			<td><input type="text" class="form-control" style="width: 350px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${tradeLicenseTypeChange.wardNo}"/>" /></td>

		
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicenseTypeChange.nameofarea" />:</span></td>
			<td><input type="text" class="form-control" style="width: 350px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${tradeLicenseTypeChange.nameOfArea}"/>" /></td>
</tr>
		<tr>
			<%-- <td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicenseTypeChange.tradelicenseno" />:</span><span class="ClsRequiredFields"></span></td>
			<td><input type="text" class="form-control" style="width: 350px"
					id="ownerAddress" maxlength="50"  name="ownerAddress" value="<c:out value="${tradeLicenseTypeChange.tradeLicenceNo}"/>"/>

			</td> --%>
		
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicenseTypeChange.updatedtradename" />:</span><span class="ClsRequiredFields"></span></td>
	
			<td><input type="text" class="form-control" style="width: 350px"
				id="changedHospitalNameAndAddress" maxlength="30"
				name="changedHospitalNameAndAddress"
				value="<c:out value="${tradeLicenseTypeChange.updateTradeName}"/>" /></td>
				<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicenseTypeChange.updatedtradetype" /><span class="ClsRequiredFields"></span>:
			</td>
			<td><input type="text" class="form-control" style="width: 350px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${tradeLicenseTypeChange.updatedTradeType}"/>" /></td>
		...
		<tr>
			...
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicenseTypeChange.updatedownername" />:</span></td>
			<td><input type="text" class="form-control" style="width: 350px"
				id="changedHospitalNameAndAddress" maxlength="30"
				name="changedHospitalNameAndAddress"
				value="<c:out value="${tradeLicenseTypeChange.updatedOwnerName}"/>" /></td>
				<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicenseTypeChange.updatedpartnercount" /><span class="ClsRequiredFields"></span>:
			</td>
			<td><input type="text" class="form-control" style="width: 350px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${tradeLicenseTypeChange.updatedPartnerCount}"/>" /></td>
</tr>
		<tr>
			...
			<td><input type="text" class="form-control" style="width: 350px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${tradeLicenseTypeChange.feesApplicable}"/>" /></td>
							<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
			...
			<td><input type="text" class="form-control" style="width: 300px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${tradeLicenseTypeChange.existingTradeName}"/>" /></td>
...
<tr>
	       <td colspan="6" align="center">
                      ...
                      <button class="ClsButton clsButtonUpload" onclick="download(${tradeLicenseTypeChange.rtiRefId},'tradeLicenseTypeChangeCertificateReport.do')">GENERATE CERTIFICATE</button>
	...
	<c:if test="${requestScope.rtiApplication.workFlowStatus==2}">
				...
				<tr>
					<td colspan="6" align="center"><a
						...
						onclick="downloads('${tradeLicenseTypeChange.rtiRefId}', 'tradeLicenseTypeChangeCertificateReport.do');"
						type="button" target="_blank"> <span class="download"
							style="display: flex; align-items: center;width: 160px;">Generate
								Certificate</span>
											...
											onclick="download1(${tradeLicenseTypeChange.rtiRefId});return false;"><span
...
<tr>
			<td colspan="5"><span class="ClsLabel"
				style="font-size: 15px; font-weight: bold;"><fmt:message
						key="List of Documents (Attachment) For Trade License Type Change" />:</span></td>
						                     		<c:if test="${doc[0] != 'null'}">
						
		<tr>
			<td style="width: 600px; height: 30px"><span class="ClsLabel"
				style="font-size: 14px;"><fmt:message
						key="label.tradeLicenseTypeChange.nocforrelateddept" />:</span></td>
...
<a class="bg-button btn btn-primary bd-highlight action"
   ...
   <span class="download" style="align-items: center;color:white;">Download</span>
		...
		<tr>
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicenseTypeChange.copyofformerlicnse" />:</span></td>
<td style="text-align: center"> <a class="bg-button btn btn-primary bd-highlight action"
   ...
   <span class="download" style="align-items: center;color:white;">Download</span>
		...
		<tr>
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicenseTypeChange.propertynodue" />:</span></td>
<td style="text-align: center"> <a class="bg-button btn btn-primary bd-highlight action"
   type="button"
   target="_blank"
   ...
   <span class="download" style="align-items: center;color:white;">Download</span>
		...
		<tr>
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicenseTypeChange.buildingauthdocument" />:</span></td>
<td style="text-align: center"><a class="bg-button btn btn-primary bd-highlight action"
   type="button"
   target="_blank"
 ...
 <input type="hidden" class="ClsTextbox" id="tradeLicenseTypeID" style="width:180px"  name="tradeLicenseTypeID" value="<c:out value="${tradeLicenseTypeChange.tradeLicenseTypeID}"/>" />
    <input type="hidden" id="rtiApplicationRefId" name="rtiApplicationRefId" value="" />
                			  			  <input type="hidden" id="rtiApplicationRefIds" name="rtiApplicationRefIds" value="${tradeLicenseTypeChange.rtiRefId}" />
...
<script type="text/javascript">
	function saveEntity() {
		onPageSubmit('<c:out value="${contextRoot}"/>/rtiapplication/createTradeLicenseTypeChangeWork.do');
	}
