...
<div class="mainHdr">
    ...
    height: 30px;
        font-size: 15px;color:#01293d">
			...
			<fmt:message key="Renewal for Nursing Home Registration"/> 				
		...
		<tr>
		 ...
		 <tr>
			<td colspan="5" style="background-color: #fcfdfe;"><span
				class="ClsLabel"
				style="height: 37px; font-size: 17px; color: #01293d;font-style: italic;"><fmt:message
						key="Names,Ages and Qualification of the Members of the Nursing Staff in the Nursing Home(नर्सिंग होममधील नर्सिंग स्टाफच्या सदस्यांची नावे, वय आणि पात्रता)" />:</span>
		</tr>
		<tr>
...
जेथे असे नर्सिंग होम आहे किंवा जेथे असा व्यवसाय केला जातो)" />:</span></td>
        <td style="border: 1px solid lightgray; padding: 8px; text-align: left;"><input type="text" class="ClsTextbox" style="width: 180px"
            id="title" maxlength="50" name="title"
            value="<c:out value="${nursingHomes.applicantInterestE}"/>" /></td>
								...
								<c:if test="${requestScope.rtiApplication.workFlowStatus==2}">
									...
									<tr>
										<td colspan="4" align="center"><a
											...
											onclick="downloads('${nursingHomes.rtiRefId}', 'renewalNurisngRegistration.do');"
...
function saveEntity()
{
	onPageSubmit('<c:out value="${contextRoot}"/>/rtsapplication/createNursingHomeRenewal.do');
}
