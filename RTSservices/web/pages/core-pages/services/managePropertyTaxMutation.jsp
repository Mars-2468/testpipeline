...
<%-- <h3 style="
    height: 30px;
        ...
        <c:if test="${propertyTaxMutation.myDropdown eq 3}">
		<fmt:message key="New Assesment of Tax" /></c:if>
		 <c:if test="${propertyTaxMutation.myDropdown eq 4}">
		<fmt:message key="New Assesment with Mutation" /></c:if>
		:
    ...
    height: 30px;
        font-size: 15px;color:#01293d">
	<fmt:message key="New Assesment of Tax" /> : <c:out value="${requestScope.rtiApplication.rtiApplnNumber}"></c:out>
	
	</h3>
</div>
<div valign="top" id="SetFormHeight">
	<input type="hidden" name="id"
		value="${propertyTaxMutation.propertyTaxMutationId}">
	<c:set var="doc"
	...
	<table width="100%" border="0" cellpadding="2" cellspacing="2">
		...
		<tr>
			...
			<td colspan="2"><input type="text" class="form-control"
				...
				value="<c:out value="${propertyTaxMutation.name}"/>" disabled />
			<td colspan="1.5"><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="tax.label.appllicantEmaailId" />:</span></td>
			<td colspan="2"><input type="text" class="form-control"
				style="width: 250px" id="ph_no" maxlength="50" name="ph_no"
				value="<c:out value="${propertyTaxMutation.emailid}"/>" disabled />
			</td>
		</tr>
		<tr>
			<td colspan="1.5"><span class="ClsLabel" style="font-size: 14px"><fmt:message
			...
			<td colspan="2"><input type="text" class="form-control"
				...
				value="<c:out value="${propertyTaxMutation.mobileNo}"/>" disabled />
			</td>
			...
			<td colspan="2"><input type="text" class="form-control" id="dob"
				...
				value="<c:out value="${propertyTaxMutation.propertyHolderName}"/>"
				disabled /></td>
		...
		<tr>
			...
			<td colspan="2"><input type="text" class="form-control"
				...
				name="childeName"
				value="<c:out value="${propertyTaxMutation.zoneNo}"/>" disabled /></td>
			...
			<td colspan="2"><input type="text" class="form-control"
				...
				name="childeName"
				value="<c:out value="${propertyTaxMutation.wardNo}"/>" disabled />
			</td>
</tr>
		...
		<tr>
			...
			<td colspan="2"><input type="text" class="form-control"
				...
				name="fatherName"
				value="<c:out value="${propertyTaxMutation.taxPincode}"/>" disabled />
			</td>
<td colspan="1.5"><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="House No.(घर क्र.)" />:</span></td>
			<td colspan="2"><input type="text" class="form-control"
				style="width: 180px" id="childeName" maxlength="45" tabindex="3"
				name="childeName"
				value="<c:out value="${propertyTaxMutation.houseNo}"/>" disabled />
			</td>
		...
		<tr>
			<td colspan="1.5"><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="Khasra No.(खसरा क्र.)" />:</span></td>
			<td colspan="2"><input type="text" class="form-control"
				style="width: 180px" id="fatherName" maxlength="45" tabindex="4"
				name="fatherName"
				value="<c:out value="${propertyTaxMutation.measleNo}"/>" disabled /></td>
			...
			<td colspan="2"><input type="text" class="form-control"
				style="width: 180px" id="childeName" maxlength="45" tabindex="3"
				name="childeName"
				value="<c:out value="${propertyTaxMutation.mouje}"/>" disabled />
			</td>
		...
		<tr>
			...
			<td colspan="1.5"><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="Land/Plot No.(जमीन/प्लॉट क्र)" />:</span></td>
			<td colspan="2"><input type="text" class="form-control"
				style="width: 180px" id="childeName" maxlength="45" tabindex="3"
				name="childeName"
				value="<c:out value="${propertyTaxMutation.plotNo}"/>" disabled />
			</td>
			...
			<td colspan="2"><input type="text" class="form-control"
				style="width: 180px" id="childeName" maxlength="45" tabindex="3"
				name="childeName"
				value="<c:out value="${propertyTaxMutation.address}"/>" disabled />
			</td>
		...
		<!--  <tr>
			...
			<td colspan="2"><input type="text" class="form-control"
				style="width: 180px" id="childeName" maxlength="45" tabindex="3"
				name="childeName"
				value="<c:out value="${propertyTaxMutation.taxMobileNo}"/>" disabled />
			</td>
			...
			<td colspan="2"><input type="text" class="form-control"
				style="width: 180px" id="childeName" maxlength="45" tabindex="3"
				name="childeName"
				value="<c:out value="${propertyTaxMutation.areasPending}"/>"
				disabled /></td>
</tr>
		...
		<tr>
			<td colspan="1.5"><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="BLock Name (ब्लॉक नाव)" />:</span></td>
			<td colspan="2"><input type="text" class="form-control"
				style="width: 180px" id="childeName" maxlength="45" tabindex="3"
				name="childeName"
				value="<c:out value="${propertyTaxMutation.blockName}"/>" disabled />
			</td>
			...
			<td colspan="2"><input type="text" class="form-control"
				style="width: 180px" id="childeName" maxlength="45" tabindex="3"
				name="childeName"
				value="<c:out value="${propertyTaxMutation.areasPendingStatus}"/>"
				disabled /></td>
				</tr>
		<tr>
			<td colspan="1.5"><span class="ClsLabel" style="font-size: 14px"><fmt:message
			...
			<td colspan="2"><input type="text" class="form-control"
				style="width: 180px" id="childeName" maxlength="45" tabindex="3"
				name="childeName"
				value="<c:out value="${propertyTaxMutation.total_demand}"/>"
				disabled /></td>
			...
			<td colspan="2"><input type="text" class="form-control"
				...
				name="fees"
				value="<c:out value="${propertyTaxMutation.fees}"/>"
				disabled /></td>
...
<%--  <c:if test="${requestScope.rtiApplication.workFlowStatus==3 ||requestScope.rtiApplication.workFlowStatus==2 || requestScope.rtiApplication.workFlowStatus==1}">
     <tr >
			...
			<input type="file" class="imagefile" name="paymentReceiptidProof" id="paymentReceiptidProof" style="width: 220px" />
                   ...
                   <td>   
                      <c:if test="${ empty propertyTaxMutation.paymentReceipt}">   
               
                <a class="bg-button btn btn-primary bd-highlight" style="color:white" id="paymentReceiptdocupload" type="button" target="_blank" onclick="paymentReceiptupload(${propertyTaxMutation.rti_ref_id}); return false;"><span
							class="download" style="align-items: center">Upload</span></a>
               
                </c:if>
              <c:if test="${ not empty propertyTaxMutation.paymentReceipt}">
              
               <a class="bg-button btn btn-success bd-highlight action" style="color:white" id="paymentReceiptdownload"  class="imagefile" type="button" target="_blank" href="<c:out value="${propertyTaxMutation.paymentReceipt}"/>"><span
		...
		<%--<tr>
			...
			<td><c:if
					...
					<a class="bg-button btn btn-primary bd-highlight"
						...
						target="_blank"
						onclick="birthupload(${propertyTaxMutation.rti_ref_id}); return false;"><span
						class="download" style="align-items: center">Upload</span></a>
   ...
   <span class="download" style="align-items: center;color:white;">Download</span>
		...
		<c:if test="${doc[1] != 'null'}">
			<tr>
				<td colspan="3.5"><span class="ClsLabel"
					style="font-size: 14px"><fmt:message
							key="Copy of Registered Sale Deed (नोंदणीकृत विक्री कराराची प्रत)/Gift Deed, will dead ,Death certificate , Partition Deed, Inheritance Document, NIT/Nazul/Lease of Municipal Corporation Document(गिफ्ट डीड, डेथ डीड, पार्टीशन डीड, वारसा दस्तऐवज, एनआयटी/नझुल/महापालिकेचे लीज दस्तऐवज)" />:</span>
				<td style="text-align: center" colspan="3.5"><a class="bg-button btn btn-primary bd-highlight action"
   type="button"
   target="_blank"
   ...
   <span class="download" style="align-items: center;color:white;">Download</span>
		...
		<c:if test="${doc[2] != 'null'}">
			<tr>
				<td colspan="3.5"><span class="ClsLabel"
					style="font-size: 14px"><fmt:message
							key=" Akhiva Patrika of City Land Survey Department(नगर भूमापन विभागाची आखीव पत्रिका)" />:</span>
				<td style="text-align: center" colspan="3.5"><a class="bg-button btn btn-primary bd-highlight action"
   type="button"
   target="_blank"
   ...
   <span class="download" style="align-items: center;color:white;">Download</span>
		...
		<c:if test="${doc[3] != 'null'}">
			<tr>
				<td colspan="3.5"><span class="ClsLabel"
					style="font-size: 14px"><fmt:message
							key=" Building Map (इमारतीचा  नकाशा)" />:</span>
				<td style="text-align: center" colspan="3.5"><a class="bg-button btn btn-primary bd-highlight action"
   type="button"
   target="_blank"
   ...
   <span class="download" style="align-items: center;color:white;">Download</span>
		...
		<c:if test="${doc[5] != 'null'}">
			<tr>
				<td colspan="3.5"><span class="ClsLabel"
					style="font-size: 14px"><fmt:message
							key="Regularization Letter (RL) (NIT) (नियमितीकरण पत्र (RL))" />:</span>
				<td style="text-align: center" colspan="3.5"><a class="bg-button btn btn-primary bd-highlight action"
   type="button"
   target="_blank"
...
<%-- 		<c:if test="${propertyTaxMutation.fees == 0.0}">
<tr>
...
<td colspan="4" align="center"><input type="button"
	...
	<input type="hidden" class="ClsTextbox_mr" style="width: 180px"
		...
		value="<c:out value="${propertyTaxMutation.propertyTaxMutationId}"/>" />
	...
	<input type="hidden" id="rtiApplicationRefId"
		...
		value="${propertyTaxMutation.rti_ref_id}" />
...
<script type="text/javascript">
	function saveEntity() {
		onPageSubmit('<c:out value="${contextRoot}"/>/rtiapplication/createPropertyTaxMutationWork.do');
	}
	...
	function saveFees(){
		...
		onPageSubmit('<c:out value="${contextRoot}"/>/rtiapplication/savePropertyTaxMutationFees.do?id='+refId);
		}else{
			return false;
		}
		}else{
...
/* 	$(document).ready(function() {
	...
	function birthupload(id) {
 	  ...
 	  var receipt = "${propertyTaxMutation.paymentReceipt}";
