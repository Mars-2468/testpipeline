 ...
 form.addEventListener('submit', event => {
   if (!form.checkValidity()) {
     ...
     event.stopPropagation()
       ...
       onPageSubmit('<c:out value="${contextRoot}"/>/rtsapplication/saveTradeLicenceRenewal.do');
   }
...
<body>
    ...
    <form class="needs-validation" novalidate>
          <div class="container-fluid mt-2" style="width: 180vh">
           <div class="printable">
               <h3 class="text-center">Application Form For Trade Licence Renewal (व्यापार परवाना नूतनीकरणासाठी अर्ज)	
            </h3>
           </div>
    ...
    <div class="col-md-3">
        <div class="mb-3 mt-3">
            ...
            <input type="text" class="form-control" style="background-image: none;" id="first_name" placeholder="" name="firstName"
                value="" maxlength="40" pattern="[A-Za-z]+" onchange="Display(this.id)" required>
            <div class="invalid-feedback">
    ...
    <div class="col-md-3">
        <div class="mb-3 mt-3">
            ...
            <input type="email" class="form-control" style="background-image: none;" id="email" placeholder="" name="email" value=""
...
function validateTextarea() {
  ...
  if (regex.test(text)) {
                ...
                <div class="row">
                    <!-- <div class="row">
                        <div>
                           <div class="col-md-4">
                               <div class="mb-2" >
                                   <label for="" class=" form-label "> Application For (अर्ज): <span class=" text-danger" style="color: red;">
                                   *</span></label>
           
                                   <div class="d-flex mt-2 border rounded  p-2">
                                       <div class="form-check ms-3">
                                           <input type="radio" class="form-check-input" id="hide" name="applicationFor" value="New Trade Licence (नवीन व्यापार परवाना)"
                                               >New Trade Licence (नवीन व्यापार परवाना)
                                           <label class="form-check-label" for="radio1"></label>
                                       </div>
           
                                       <div class="form-check ms-3">
                                           <input type="radio" class="form-check-input" id="show" name="applicationFor" value="Renewal Trade Licence (नूतनीकरण व्यापार परवाना)"
                                               >Renewal Trade Licence (नूतनीकरण व्यापार परवाना)
                                              
                                           <label class="form-check-label" for="radio1"></label>
                                           <div class="invalid-feedback">
                                            Please Select Valid Application For.
                                        </div>
                                </div>
                                       </div>
                           ...
                           <div class="col-md-3">
                               <div class="mb-3 mt-5">
                                   <label for="" class="form-label lbleng"> Name of Business (व्यवसायाचे नाव)<span class="text-danger"
                                       style="color: red;">*</span></label>
           
                                       <input type="text" class="form-control" style="background-image: none;" name="nameOfBusiness" pattern="^\s*\S.*$" maxlength="255" value=""
                                       pattern="[A-Za-z]+" required>
                                       <div class="invalid-feedback">
                                   Please Enter Valid Name of Business.
                               </div>
                               </div>
                           </div>
                           ...
                           <div class="col-md-3">
                               <div class="mb-3 mt-5">
                                   <label for="" class="form-label lbleng"> Business Details (व्यवसाय तपशील)<span class="text-danger"
                                       style="color: red;">*</span></label>
           
                                       <input type="text" class="form-control" style="background-image: none;" pattern="^\s*\S.*$" maxlength="255" name="businessDetails" value=""
                                       pattern="[A-Za-z]+" required>
                                       <div class="invalid-feedback">
                           ...
                           <div class="col-md-3">
                               <div class="mb-3 mt-0">
                                   <label for="" class="form-label ">Estimate date to start new business (नवीन व्यवसाय सुरू करण्यासाठी अंदाजे तारीख)<span
                                           class="text-danger">*</span></label>
                                   <input type="date" class="form-control" style="background-image: none;" id=""pattern="^\s*\S.*$" placeholder="" name="businesDoneDate" value=""
                                       required="true">
                                       <div class="invalid-feedback">
    ...
    const businessDateInput = document.querySelector('[name="businesDoneDate"]');

    // Function to handle the date input change and input events
    function validateDateInput() {
        const selectedDate = new Date(businessDateInput.value);
        const currentDate = new Date();

        // Compare selected date with current date
        if (selectedDate < currentDate) {
            businessDateInput.setCustomValidity("Please select a future date.");
        } else {
            businessDateInput.setCustomValidity("");
        }
    }

    // Add event listeners to trigger validation on change and input
    businessDateInput.addEventListener("change", validateDateInput);
    businessDateInput.addEventListener("input", validateDateInput);
</script>
           
                           <div class="col-md-3">
                               <div class="mb-3 mt-5">
                                   <label for="" class="form-label lbleng" style="font-size: 16px;">Space Type (जागा प्रकार)<span
                                           class="text-danger">*</span></label>

                               <select class="form-select" style="background-image: none;" id="space" name="spaceType" required>
                                   <option value="">-Select-</option>
                                   <option value="Shed (शेड)">Shed (शेड)</option>
                                   <option value="Shop (दुकान)">Shop (दुकान)</option>
                                   <option value="Godown (खाली जा)">Godown (खाली जा)</option>
                                   <option value="WorkShop (कार्यशाळा)">WorkShop (कार्यशाळा)</option>
                                   <option value="Free Space (मोकळी जागा)">Free Space (मोकळी जागा)</option>
                                 
                               </select>
                               <div class="invalid-feedback">
                                   Please Select Valid Space Type.
                                </div>
                           </div>
                           </div>
                           <div class="mt-2">
                               <strong>Area for Business Usage(In Meter)  <span
                                       class="text-danger"  pattern="^\s*\S.*$" style="color: red;"">*</span> </strong>   
                               </div>
           
                           <div class=" col-md-3">
                                       <div class="mb-3 mt-3">
                                           <label for="" class="form-label ">Length (लांबी)<span class="text-danger">*</span></label>
                                           <input type="number" class="form-control" style="background-image: none;"  pattern="^\s*\S.*$"id="" placeholder="mtr" name="length"
                           ...
                           <div class="col-md-3">
                               <div class="mb-3 mt-3">
                                   <label for="" class="form-label ">Height (उंची)<span class="text-danger"
                                   >*</span></label>
                                   <input type="number" class="form-control" style="background-image: none;" id="" placeholder="mtr" name="height"
                                     pattern="^\s*\S.*$"  value="" pattern="[0-9]+" required>
                                       <div class="invalid-feedback">
                           ...
                           <div class="col-md-3">
                               <div class="mb-3 mt-3">
                                   <label for="" class="form-label ">Width (रुंदी)<span class="text-danger"
                                          >*</span></label>
                                   <input type="number" class="form-control" style="background-image: none;" id="" placeholder="mtr" name="width"
                                   pattern="^\s*\S.*$"    value="" pattern="[0-9]+" required>
                                       <div class="invalid-feedback">
            ...
            <label for="" class="form-label lbleng"> Name of the Area (क्षेत्राचे नाव)<span class="text-danger"
                                       style="color: red;">*</span></label>
           
                                       <input type="text" class="form-control" maxlength="100" style="background-image: none;" name="areaName" value=""
                                ...
                                <div class="col-md-3">
                               <div class="mb-3 mt-4">
                                   <label for="" class="form-label lbleng"> Trade Licence No. (व्यापार परवाना क्र.)<span class="text-danger"
                                       style="color: red;">*</span></label>
           
                                       <input type="text" class="form-control" maxlength="100" style="background-image: none;" name="tradeLicenseNo" value=""
                                    pattern="^\s*\S.*$"  maxlength="100"   required>
                                       <div class="invalid-feedback">
                           ...
                           <!-- <div class="col-md-3" id="b1">
                               <div class="mb-3 mt-3">
                                   ...
                                   <input type="text" class="form-control" style="background-image: none;" name="tradeLicenseNo" value=""
                                       >
                                       <div class="invalid-feedback">
                           ...
                           <div class="col-md-12">
                               <div class="mb-3 mt-3 ">
                                   <label for="primary_full_address" class="form-label lbleng">Addresss of Place Usage for Business (व्यवसायासाठी ठिकाणाच्या वापराचा पत्ता)<span class="text-danger" >*</span></label>
           
                                   <textarea class="form-control" style="background-image: none;" rows="2" id="" pattern="^\s*\S.*$" name="businessUsagePlace" required></textarea>
                                   <div class="invalid-feedback">
                                       Please Enter Valid Address.
                                   </div>
                               </div>
    ...
    <div class="mb-3 mt-0 style= margin-top: 88px">
...
<div class="col-md-3">
    <div class="mb-3 mt-4">
        <label for="" class="form-label lbleng">
            Fees Applicable (शुल्क लागू)<span class="text-danger" style="color: red;">*</span>
        </label>
        <input type="text" class="form-control" style="background-image: none;" id="fees" placeholder="" name="fees" value="" required readonly>
        <div class="invalid-feedback">Please Enter Valid Fees.
        </div>
    </div>
</div>
			...
			<div class="alert alert-info mb-2 p-2 mb-4 ms-2">
                ...
                <div class="col-md-3">
                    <div class="mb-3 mt-0">
                        <label for="" class="form-label">1.NOC for the related department issued from the NMC/Department Officer/Govt/Semi Govt. Officer (NMC/ विभाग अधिकारी/शासकीय/निमशासकीय अधिकारी कडून जारी केलेल्या संबंधित विभागासाठी NOC)<span class="text-danger"
                                style="color: red;">*</span> 
    </label>
                        <input type="file" class="form-control" style="background-image: none;" id="city_survey" accept = ".pdf" placeholder=""
                             name="NOC" required>
                             <div class="invalid-feedback">
               ...
               <!--  <div class="col-md-3" id="c1">
                    <div class="mb-3" style="margin-top: 65px;">
                        <label for="" class="form-label">Copy of the Former Licence (In case of Renewal the Licence) (पूर्वीच्या परवान्याची प्रत (परवाना नूतनीकरणाच्या बाबतीत))<span class="text-danger"
                                style="color: red;">*</span> 
    </label>
                        <input type="file" class="form-control" style="background-image: none;" id="city_survey1" placeholder=""
           ...
           <div class="col-md-3">
                    <div class="mb-3 mt-5">
                        <label for="" class="form-label lbleng">Copy of the Former Licence (In case of Renewal the Licence) (पूर्वीच्या परवान्याची प्रत (परवाना नूतनीकरणाच्या बाबतीत))<span
                            class="text-danger" style="color: red;"  >*</span></label>
    
                        <input type="file" class="form-control" style="background-image: none;" id="city_survey1" accept = ".pdf" placeholder="" name="CopyOfTheFormerLicence" required >
                        <div class="invalid-feedback">
                            File selected is either greater than 2Mb or not of type .pdf.
                        </div>
                ...
                <div class="col-md-3">
                    <div class="mb-3 " style="margin-top:95px;">
                        <label for="" class="form-label lbleng">No Dues Certificate for Property Tax (मालमत्ता करासाठी ना हरकत प्रमाणपत्र)<span
                            class="text-danger" style="color: red;"  >*</span></label>
    
                        <input type="file" class="form-control" style="background-image: none;" id="city_survey2"  accept = ".pdf" placeholder="" name="NoDuesCertificate" required >
                        <div class="invalid-feedback">
                            File selected is either greater than 2Mb or not of type .pdf.
                        </div>
                ...
                <div class="col-md-3">
                    <div class="mb-3"style="margin-top: 95px">
                        <label for="" class="form-label lbleng"> Building Authorization Document (इमारत अधिकृतता दस्तऐवज)</label>
    
    
                        <input type="file" class="form-control" style="background-image: none;" id="city_survey3" accept = ".pdf" placeholder="" name="BuildingAuthorizationDocument ">
        ...
        $('#main-dropdown').on('change', function () {
         ...
         <script>
            function tradeLicense() {
                var getvalue = $("#trade").val();
                if (getvalue == "All kinds of metal and work business (सर्व प्रकारच्या धातूचा औत कामाचा व्यवसाय )" || getvalue == "Preparation and packing of spices (मसाल्याचे पदार्थ तयार करणे व पॅकिंग करणे)" || getvalue == "Manufacturing of cement and cement products (सिमेंट व सिमेंट वस्तू तयार करणे)" || getvalue == "Asphalt and Manufacturing of asphalt products (डांबर व डांबरापासून वस्तू तयार करणे)" || getvalue == "Ornamental liquor and Manufacturing of articles thereof (शोभेची दारू व त्यापासून वस्तू तयार करणे)" || getvalue == "Preparation of lime and Manufacturing of products from Plaster of Paris (चुना तयार करणे व प्लास्टर ऑफ पॅरिस पासून वस्तू तयार करणे)" || getvalue == "Manufacturing, storage and sale of boxes of sticks (काड्यांच्या पेट्या तयार करणे ,साठा व विक्री)" || getvalue == "Manufacturing, storage and sale of paper and paper products (कागद व कागदापासून वस्तू तयार करणे, साठा व विक्री)" || getvalue == "Manufacturing of rubber and rubber products (रबर व रबर वस्तूचे उत्पादन)" || getvalue == "Cleaning of cotton, Manufacturing of goods from cotton (Cotton not exceeding Rs. 200 kg stored in residential premises) (कापूस साफ करणे , कापसापासून वस्तूची निर्मिती करणे (निवासी जागेत रु. २०० किलो पेक्षा जास्त कापूस साठवता येणार नाही))" || getvalue == "Manufacturing of Aluminium goods, their production and sale as well as Manufacturing, storage and sale of metals and articles thereof (जर्मनच्या वस्तू तयार करणे त्यांचे उत्पादन व विक्री तसेच धातू व त्यापासून उत्पादित वस्तूची निर्मिती साठा व विक्री)" || getvalue == "Aluminium, Tarman, Silver, Hindoly Steel etc. Sale of metal, production of stone from quarry, mechanical fragmentation, mechanical cutting and polishing of stone (अॅल्युमिनियम, तरमन, सिल्वर ,हिंडोलीयं स्टील इ. धातूची विक्री करणे, खाणीतून दगडाचे उत्पादन करणे ,यंत्राचे साहाय्याने खंडीकरण करणे ,यांत्रिक शक्तीने दगडाची कटाई व पोलिश करणे)" || getvalue == "Preparation, storage and sale of milk, butter and products thereof apart from domestic consumption (घरगुती वापरा व्यतिरिक्त दूध ,लोणी व त्यापासून पदार्थ तयार करणे ,साठा व विक्री)" || getvalue == "Processing and canning of fruits and vegetables (फळे व भाजीपाला यावर प्रक्रिया करून डबा बंद करणे)" || getvalue == "Liquefied Gas Cylinder Stock and Sales and LPG Gas Supply Agency (द्रवरुप गॅस सिलेंडर साठा व विक्री व एलपीजी गॅस पुरवठा एजन्सी)" || getvalue == "Hosiery Goods retail seller (होजियरी गुड्स चिल्लर विक्रेते)" || getvalue == "All types of machinery sales and service (सर्व प्रकारच्या मशिनरी विक्री व सेवा)" || getvalue == "Money Landers registered (सावकारी ( Money Landers) नोंदणीकृत)" || getvalue == "Money Exchange (चलन बदलविणे ( Money Exchange))" || getvalue == "Antique shop (जुन्या वापलेल्या वास्तूचे दुकान)" || getvalue == "Brokers/ All Kinds of Brokers (ब्रोकर्स/ सर्व प्रकारचे ब्रोकर्स ( संपत्ती अडत))" || getvalue == "Old automatic vehicles and repair(जुनी स्वयंचलित वाहने व दुरुस्ती)" || getvalue == "Wholesaler of utensil (भांडे विक्रते ठोक व्यवसायीक)" || getvalue == "Big store selling audio/video cassettes (ऑडीओ / व्हिडीओ कॅसेट विक्री मोठे दुकान)" || getvalue == "Preparation and packing of spices (मसाल्याचे पदार्थ तयार करणे व पॅकिंग करणे)" || getvalue == "Iron wholesale (लोखंड ठोक)" || getvalue == "Cloth business wholesalers (कापड व्यवसाय ठोक विक्रेते)" || getvalue == "Repair of automatic  four wheeler vehicles (चार चाकी स्वयंचलित वाहने दुरुस्ती)" || getvalue == "Cosmetics (Agency) (सोंदर्य प्रसाधने (एजन्सी))" || getvalue == "Electrical Goods  wholesale (इलेक्ट्रीक गुड्स ठोक)" || getvalue == "Sale of Gun ammo weapon (बंदूक बारुद शस्त्र विक्री)" || getvalue == "Manufacturing and sale of glossine board and steel letters (ग्लोसाईन बोर्ड व स्टील अक्षरे बनविणे व विक्री)" || getvalue == "Wholesale of Foam Coir Sales (Foam Mattress & Related Products Sales) (फोम क्वायर विक्री ठोक (फोम गादी व संबंधित वस्तू विक्री))" || getvalue == "Wholesale of Old Bardana Sale  (जुना बारदाना विक्री ठोक)" || getvalue == "Wholesale grain sales (grain) (ठोक अनाज विक्री (धान्य))" || getvalue == "Computer training class (संगणक प्रशिक्षण वर्ग)" || getvalue == "Mobile tower (मोबाईल टॉवर)" || getvalue == "Flex Printing Shop (फ्लेक्स प्रिंटिग शॉप)" || getvalue == "Beer shop (बियर शॉपी)" || getvalue == "Beer Bar and Restaurant (बियर बार अॅंड रेस्टॉरेंट)" || getvalue == "Birthday Hall (बर्थ डे हॉल)" || getvalue == "Processing and canning of fruits and vegetables (फळे व भाजीपाला यावर प्रक्रिया करून डबा बंद करणे)" || getvalue == "Co-Co Chocolate, Preparation of sweets and other products from sugar, Sugar and granulated sugar (को-को चॉकलेट,साखरेपासून मिठाई व इतर पदार्थ तयार करणे ,साखर व खडी साखर)" || getvalue == "Textiles and textile Manufacturing goods handloom and powerloom (कापड व कापड उत्पादित वस्तू हातमाग व वीजमाग)" || getvalue == "Manufacturing and sale of rubber and plastic articles, rubber and plastic (रबरच्या व प्लास्टिकच्या वस्तू ,रबर व प्लास्टिक तयार करणे व त्याची विक्री करणे)" || getvalue == "Retrending and Vulcanizing works (रिट्रेंडिंग व व्हॅकलनायझिंगची कामे)" || getvalue == "Cement stock, sales and production (सिमेंट साठा, विक्री व उत्पादन)" || getvalue == "Conducting Cable Operating Business Main Distributor (केबल ऑपरेटींगचा व्यवसाय चालविणे मुख्य वितरक)" || getvalue == "Alcohol production (wineries) (मद्यार्क उत्पादन (वाईनरीज))") {

                    var fee = 1000;
                    $("#fees").val(fee);
                } else if (getvalue == "-Select Trade-") {
                    var fee = 0;
                    $("#fees").val(fee);

                } else if (getvalue == "Yarn dyeing business (सुत कापड रंगविण्याचा व्यवसाय)" || getvalue == "Making goods from waste clothes (वेस्ट कापडापासून वस्तू तयार करणे)" || getvalue == "Coal and coal, manufacturing of coal products,  its sale and firewood (कोळसा व दगडी कोळसा ,कोळशाच्या वस्तू तयार करणे ,त्याची विक्री व जळाऊ लाकूड)" || getvalue == "Stock, Manufacturing and sale of soap, liquid soap, washing powder (साबण ,द्रवरूप साबण , धुण्याची पावडर यांचा साठा ,उत्पादन व विक्री)" || getvalue == "Making an kunku(Vermelion) (कुंकू तयार करणे)" || getvalue == "Silver, gold, precious metals business (चांदी ,सोने,मौल्यवान धातू)" || getvalue == "1 to 9 labours Businesses registered under the Labor Factories Act (१ ते ९ कामगार फॅक्टरी ऍक्ट प्रमाणे नोंदणी झालेले व्यवसाय)" || getvalue == "Lubricating and oil storage and grease storage (लुब्रीकेटींग व ऑईल साठा व ग्रिस साठा)" || getvalue == "Crude oil reserves (क्रुड ऑईल साठा)" || getvalue == "All types of wax (सर्व प्रकारचे मोम (मेण))" || getvalue == "Preparation of camphor stock and sale (कापूर तयार करणे साठा व विक्री)" || getvalue == "Turpentine, Color Varnish, Paint Stock and Sale (टर्पेंटाईन, रंग वॉर्निश, पेंट साठा व विक्री)" || getvalue == "Film stock (चलचित्रपट साठा)" || getvalue == "Ice, ice candy, ice cream sales and stock (बर्फ, आईस कॅन्डी, आईसक्रीम विक्री व साठा)" || getvalue == "Coconut rope (नारळाची दोरी)" || getvalue == "Sandal wood/powder (चंदनाचे लाकुड/पावडर)" || getvalue == "Office of Freight Business (Transport) (माल वाहतुक व्यवसाय कार्यालय (ट्रांसपोर्ट))" || getvalue == "All Kinds of Textile Sales (Chiller) (सर्व प्रकारचे कापड विक्री (चिल्लर))" || getvalue == "Cement and iron roofing sheets (सिमेंट व लोखंडाचे छताचे पत्रे)" || getvalue == "Granite/Marble Stone, Tiles, Marble Dealers (ग्रेनाईट/संगमरवरी दगड, टाईल्स, मार्बल विक्रेते)" || getvalue == "Processing bones and hides into powder (wet/dry) (हाडे व चामडे यांच्यावर प्रक्रिया करुन पावडर तयार करणे (ओली/सुखी))" || getvalue == "Departmental store (डिपर्टमेंटल स्टोअर)" || getvalue == "Lathe machine, polishing machine (लेथ मशिन, पॉलिश मशिन)" || getvalue == "Taxis, cars, buses, trucks Contractual vehicles used for carrying goods or passengers (टॅक्सी, कार, बस, ट्रक करारावर आधारीत वाहने माल वाहतुक किंवा प्रवासी वाहुन नेण्याकरीता वापरात येणा)" || getvalue == "Photo Color Lab Coaching Classes (Academic) (फोटो कलर लॅब कोचिंग क्लासेस (शैक्षणिक))" || getvalue == "Coaching Class (Academic) (कोचिंग क्लास (शैक्षणिक))" || getvalue == "Video games (व्हिडीओ गेम्स)" || getvalue == "Theater house (नाट्य गृह)" || getvalue == "Social Hall (सामाजिक सभागृह)" || getvalue == "Grocery retail seller (किराणा चिल्लर विक्रेते)" || getvalue == "Obstrected shopkeepers and commission agents (अडत दुकानदार व कमिशन एजन्ट)" || getvalue == "Tea and coffee Wholesale seller (चहा आणि कॉफी ठोक विक्रेते)" || getvalue == "Fruits (including coconut) Wholesale seller (फळे ( समाविष्ट नारळ ) ठोक विक्रेते)" || getvalue == "Onions, dry chillies, garlic, potatoes Wholesale seller (कांदे, सुकी मिरची, लसूण, आलु ठोक विक्रेते)" || getvalue === "Jaggery sugar Wholesale seller (गुळ साखर ठोक विक्रेते)" || getvalue == "Hardware retail seller (हार्डवेअर चिल्लर विक्रेते)" || getvalue == "Egg Wholesale seller (अंडे ठोक विक्रेते)" || getvalue == "Hosiery Goods retail seller (होजियरी गुड्स चिल्लर विक्रेते)" || getvalue == "Automobile shop (ऑटोमोबाईल चे दुकान)" || getvalue == "Sale by carving on metal or wood (Engraving) (धातू अथवा लाकडावर नक्षीकाम करून विक्री (Engraving))" || getvalue == "Sanitary Fitting Goods (सेनेटरी फिटिंग गुड्स)" || getvalue == "Glassware shop (काचेच्या वस्तूचे दुकान)" || getvalue == "Registered Co-operative Societies (नोंदणीकृत सहकारी संस्था)" || getvalue == "Radiologist (रेडियोलॉजिस्ट)" || getvalue == "Pathological laboratories (पॅथालॉजिकल लॅबोरेटरीज)" || getvalue == "Electric Decoration, Sound Service (इलेक्ट्रिक डेकोरेशन, साउंड सर्विस)" || getvalue == "Video, CD library (व्हिडिओ, सी डी लायब्ररी)" || getvalue == "Airline/ Railway Booking, Luxury Buses Booking, Office (विमान वाहतूक/ रेल्वे बुकिंग, लक्झरी बसेसचे बुकिंग, कायार्लय)" || getvalue == "Seller of shoes (जोडे/ चपलांचे विक्रेते)" || getvalue == "Retailer of utensil (भांडे विक्रते चिल्लर व्यवसायीक)" || getvalue == "Selling/remolding old tire tubes (जुने टायर टयूब विक्री/ रिमोल्डींग करणे)" || getvalue == "Flour Mill, Rice Grinding Mill, Groundnut Oil machine, Chili grinding mill, Kadvakuti and Wet Pulses Grinding (पीठ गिरणी ,तांदूळ दळन्याची गिरणी ,शेंगदाणे तेलघाणी ,मिरची कांडप ,कडवाकुटी व ओल्या डाळी दळणे)" || getvalue == "Bakery &Preparation bakery products (बेकरी व बेकरीचे पदार्थ तयार करणे)" || getvalue == "Dining hall and mess/canteen business (डायनिंग हॉल व जेवणावळीचा व्यवसाय)" || getvalue == "Ice Manifacturing (बर्फ निर्मिती)" || getvalue == "Textile shops (कापडाची दुकाने)" || getvalue == "Tailoring, making and selling readymate garments (शिलाई काम ,रेडिमेट गारमेंट्स तयार करणे व विक्री करणे)" || getvalue == "Mattress factories (गादी कारखाने)" || getvalue == "Dyeing the yarn (सुताला रंग देणे)" || getvalue == "Printing on cloth (कापडावर छपाई)" || getvalue == "Stocking and selling of all types of textile, sackcloth, caste, jute (कापडनिर्मिती ,गोणपाट ,जाते,ताग सर्व प्रकारचे वार्दाने यांचा साठा व विक्री)" || getvalue == "Manufacturing of wood and wood products Wooden furniture (लाकूड व लाकूड उत्पादित वस्तू लाकडी फर्निचर तयार करणे)" || getvalue == "Manufacturing of Doors, Windows, Frames, Bamboo Stock, Timber Stock and Sale (दरवाजे ,खिडक्या ,फ्रेम्स तयार करणे ,बांबू साठा ,इमारती लाकूड साठा व विक्री)" || getvalue == "Making wooden boxes (लाकडी खोके तयार करणे)" || getvalue == "Manufacturing of wooden toys, printing and publishing and Manufacturing of paper goods (लाकडी खेळणी तयार करणे ,मुद्रण व प्रकाशन व कागदाच्या वस्तू तयार करणे)" || getvalue == "Printing Press, Photo Studio (प्रिंटिंग प्रेस ,फोटो स्टुडिओ)" || getvalue == "Paper and paper products, notebooks, books, binding work, envelopes, pamphlets, gifts and presentations (कागद व कागदापासून वस्तू तयार करणे ,वह्या ,पुस्तके ,बाइंडिंग वर्क लिफाफे पत्रिका गिफ्ट व प्रेझेंटेशन)" || getvalue == "Manufacturing, stock and sale of non-metallic mineral goods, metal furniture, stationary goods (नॉन मेटॅलीक खनिज वस्तु, धातुचे फर्निचर, स्थिर वस्तु यांची निर्मिती साठा व विक्री)" || getvalue == "Plating, polishing, sharpening, welding and fabrication of metals, fabrication of gratings and windows (धातुंना मुलामा देणे, चकाकी आणणे, धार करणे, वेल्डींग अँड फेब्रीकेशन, लोखंडी जाळ्या व खिडक्या तयार करणे)" || getvalue == "Manufacturing, selling and stocking as well as repairing and selling electronic goods (इलेक्ट्रानिक वस्तु निर्मिती विक्री व साठा तसेच त्यांची दुरुस्ती व विक्री करणे)" || getvalue == "Repair and sale of electrical appliances, radio, TV, fridge, fans etc (विजेची उपकरणे, रेडिओ, टि.व्ही, फ्रिज, पंखे इत्यादीची दुरुस्ती व विक्री)" || getvalue == "Battery charging and repair (बॅटरी प्रभरण व दुरुस्ती)" || getvalue == "Maintenance Sales and Repair of Cars, Motorcycles, Spray Print (मोटारी, मोटार सायकल यांची देखभाल विक्री व दुरुस्ती, स्प्रे प्रिंट)" || getvalue == "Manufacturing, repair and sale of sports and exercise equipment (क्रिडा व व्यायाम साधनांची निर्मिती, दुरुस्ती व विक्री)" || getvalue == "Musical instrument making and repair (वाद्य निर्मिती व दुरुस्ती)" || getvalue == "Xerox Machine Repair & Sales, Computer Repair & Sales (झेरॉक्स मशिन दुरुस्ती व विक्री कॉम्प्युटर दुरुस्ती व विक्री)" || getvalue == "All kinds of poultry farms (सर्व प्रकारचे कुकुटपालन)" || getvalue == "Business of Lodging and Boarding (लॉजिंग बोर्डींगचा व्यवसाय)" || getvalue == "Sub distributor carrying on the business of cable operating (केबल ऑपरेटींगचा व्यवसाय चालविणे उप वितरक)" || getvalue == "Storage and sale of foodgrains and sale and storage of oilseeds (अन्नधान्य साठा व विक्री तसेच तेलबिया विक्री व साठा)" || getvalue == "Private Postal Service, Courier Service, Angadia Service (खाजगी टपाल सर्विस, कुरीयर सर्विस, आंगडीया सेवा)" || getvalue == "Manufacturing, storage and sale of all types of beverages, sale of all types of aerated beverages (सर्व प्रकारचे पेय तयार करणे, साठा करणे व विक्री करणे, सर्व प्रकारचे वायु मिश्रीत पेयांची विक्री)" || getvalue == "Private Medical Services And Related laboratory (INDOOR) (खाजगी वैद्यकीय सेवा व त्या संबंधीच्या प्रयोग शाळा (इनडोअर))" || getvalue == "Stock and sale of potable and denatured (poisoned) spirits (अपेय व डिसेचर्ड (विषकृत) स्पिरीट साठा व विक्री)" || getvalue == "Acid stock and sale (ॲसीड साठा व विक्री)" || getvalue == "Chemicals and All Kinds of Medicine Stock and Sale (Medical) (केमिकल्स व सर्व प्रकारची औषधी साठा व विक्री (मेडिकल))" || getvalue == "Florist (Flower Showroom) (फ्लोरीस्ट (फुलाचे शोरूम))" || getvalue == "Video Pull Parlour (व्हिडीओ पुल  पार्लर )" || getvalue == "Small shop selling audio/video cassettes (ऑडीओ / व्हिडीओ कॅसेट विक्री छोटे दुकान)" || getvalue == "Supervisors/Architects (सुपरवायझर्स/आर्किटेक्ट)" || getvalue == "Supply of building materials (excluding ballast, sand, gravel, mud, bricks, cement and iron) (इमारतीचे लागणारे साहित्य पुरवठा करणे (गिट्टी, रेती, खडी, मुरुम, विटा, सिमेंट व लोहा सोडून))" || getvalue == "Dubbing Editing Studio (डबिंग एडिटिंग स्टूडियो)" || getvalue == "Snookers and Billiards Parlour (स्नुकर्स अॅंड बिलीयर्ड्स पार्लर)" || getvalue == "A shop selling of  bags/purses (बॅग/पर्स विक्रीचे दुकान)" || getvalue == "Internet/Cyber Cafe (इंटरनेट/सायबर कॅफे)" || getvalue == "Saw machine (आरा मशीन)" || getvalue == "Iron Retail (लोखंड चिल्लर)" || getvalue == "Electrical Contractor (इलेक्ट्रीक कॉन्ट्रॅक्टर)" || getvalue == "LIC Agent Franchise Collection Center (एल.आय.सी. एजंट फ्रेंचाईजी कलेक्शन सेंटर)" || getvalue == "Mobile Fee Franchise Collection Center (इंजिनीयर्स)" || getvalue == "Mobile Fee Franchise Collection Center (इंजिनीयर्स)" || getvalue == "Selling of  new tires (नविन टायर विक्री)" || getvalue == "Cosmetics (Retail) (सोंदर्य प्रसाधने (चिल्लर))" || getvalue == "Edible Oil Sales (wholesale) (खाद्य तेल विक्री (ठोक))" || getvalue == "Water filter and packaged water sellers (वॉटर फिल्टर व पॅकबंद पाणी विक्रेते)" || getvalue == "Scientific Equipment and Sales (वैज्ञानीक उपकरणे व विक्री)" || getvalue == "Shoes, Sandal  Small Shop (250 Sq.ft.) (जोडे चप्पल लहान दुकान (250 चौ. फुट जागेत))" || getvalue == "Grain, stationery and other items to Government and Semi-Government offices through Multi-Purpose Register Institute (बहूउद्देशिय रजिस्टर संस्थाद्वारे शासकीय व निमशासकीय कार्यालयांना धान्य स्टेशनरी व इतर वस्तू)" || getvalue == "Foam Coir Sales and Retail (फोम क्वायर विक्री व चिल्लर)" || getvalue == "Old Bardana Sale and retail (जुना बारदाना विक्री व चिल्लर)" || getvalue == "P.U.C. Center (पी.यु.सी. सेंटर)" || getvalue == "Sale of Mobile Recharge and Vouchers  (मोबाईल रिचार्ज व्हाऊचर्स विक्री)" || getvalue == "Computer Graphics (कॉम्प्युटर ग्राफिक्स)" || getvalue == "cotton pinjai reche (कापूस पिंजाई रेचे)" || getvalue == "Tarpaulin sales (ताडपत्री विक्री)" || getvalue == "Tea, coffee, milk, hotel (चहा, कॉफी, दुध, हॉटेल)" || getvalue == "Gym (Spa) (व्यायाम शाळा (जिम) (स्पा))" || getvalue == "Puffed Rice  /Pohe factories (मुरमुरे /पोहे कारखाने)" || getvalue == "Making bricks and mortar (विटा व कौले तयार करणे)") {
                    var fee = 500;
                    $("#fees").val(fee);

                } else if (getvalue == "Fire Box Stock and Sale (आगपेटी साठा व विक्री)" || getvalue == "All occupations other than those not covered above (वर समाविष्ट नसलेल्या व्यवसायाव्यतिरिक्त इतर सर्व व्यवसाय)" || getvalue == "Agricultural Service Centre (कृषी सेवा केंद्र)" || getvalue == "Book Sellers/ Magazine Centre (बुक सेलर्स/ मॅगझीन सेंटर)" || getvalue == "Tea and coffee retail seller (चहा आणि कॉफी चिल्लर विक्रेते)" || getvalue == "Fruits (including coconut) retail seller (फळे ( समाविष्ट नारळ ) चिल्लर विक्रेते)" || getvalue == "Onions, dry chillies, garlic, potatoes retail seller (कांदे, सुकी मिरची, लसूण, आलु चिल्लर विक्रेते)" || getvalue == "Tobacco Wholesale seller (तंबाखू ठोक विक्रेते)" || getvalue == "Tobacco retail seller (तंबाखू चिल्लर विक्रेते)" || getvalue == "Plastic items retail seller (प्लास्टिक वस्तू चिल्लर विक्रेते)" || getvalue == "Manufacturing and sale of clay artwork (मातीच्या कलाकृती वस्तू तयार व विक्री (Earthen Post))" || getvalue == "Two wheeler Garage (गॅरेज टू व्हीलर)" || getvalue == "Three wheeler Garage (गॅरेजथ्री व्हीलर)" || getvalue == "Allopathic, Homeopathy, Ayurvedic Dispensary (ऍलोपॅथिक, होमिओपॅथी, आयुर्वेदिक डिस्पेन्सरी)" || getvalue == "Toy sellers (खेळणी विक्रेते)" || getvalue == "To sell cloth or other goods by putting up an exhibition every day (प्रति दिवस प्रदर्शनी लावून कापड किंवा अन्य वस्तू विक्री करणे)" || getvalue == "By Setting up shops (small box shops selling different items) (दुकाने लावून (छोटे खोकी दुकाने वेगवेगळ्या वस्तू विक्री))" || getvalue == "Milk shops and milk products (दुध विक्रीचे दुकान व दुधजन्य पदार्थ)" || getvalue == "Fish aquariums (फीश एक्वेरियम्स)" || getvalue == "Wet Bridge (Dharamkata) (वेट ब्रिज (धर्मकाटा))" || getvalue == " All types of small scale industries (सर्व प्रकारचे लघु उद्योग)" || getvalue == " Edible Oil Sales(Retail) (खाद्य तेल विक्री (चिल्लर))" || getvalue == "Driving School  (ड्रायव्हिंग शाळा (स्कुल))" || getvalue == " Ayurvedic herbs (आयुर्वेदीक जडीबुटी)" || getvalue == "Newspaper printing and publishing (वर्तमानपत्र मुद्रण व प्रकाशन)" || getvalue == "Book binding and paper cutting (बुक बाइंडिंग व पेपर कटिंग)" || getvalue == "Manufacturing of leather and leather goods,Stock and Sales (चामडे व चामड्याच्या वस्तू तयार करणे ,साठा व विक्री)" || getvalue == "Leather making, selling and stocking of leather goods (चामडे कमविणे ,चामड्याच्या वस्तू विक्री व साठा)" || getvalue == "Clock repair and sales (घड्याळ दुरुस्ती व विक्री)" || getvalue == "Manufacturing, repair and sale of household items such as locks, stoves, sewing machines etc (कुलपे, स्टो, शिवणयंत्रे इत्यादी घरघुती वस्तुंची निर्मिती, दुरुस्ती व विक्री)" || getvalue == "Sale and repair of glasses (चष्म्याची विक्री व दुरुस्ती)" || getvalue == "Laundry business (लाँड्री व्यवसाय)" || getvalue == "Laboratory, Repair and Sale of Photographic Equipment (प्रयोग शाळा, फोटोग्राफीक समानाची दुरुस्ती व विक्री)" || getvalue == "Conducting classes of embroidery, sewing etc (भरतकाम, शिवणकाम इत्यादी वर्ग चालविणे)" || getvalue == "Conducting all types of private classes (except academic) (सर्व प्रकारचे खाजगी वर्ग चालविणे (शैक्षणिक वगळता व्यावसायीक))" || getvalue == "To carry out carpentry business by mechanical means (कडबाकुटृी व्यवसाय यांत्रिक पध्दतीने करणे)" || getvalue == "Hairdresser, beauty parlour (केश कर्तनालय, ब्युटी पार्लर)" || getvalue == "Video shooting business (व्हिडीओ श्युटींगचा व्यवसाय)" || getvalue == "Stock and sale of compound fertilizers, pesticides (मिश्र खते, जंतुनाशके यांचा साठा व विक्री)") {
                    var fee = 250;
                    $("#fees").val(fee);

                } else if (getvalue == "grass (गवत)" || getvalue == "weed (तणस)" || getvalue == "Animal horns and bones (जनावराची शिंगे व हाडे)" || getvalue == "Photo framing (फोटो फ्रेमिंग)" || getvalue == "Flower shop (फुलाचे दुकान)" || getvalue == "Nursery / Plant seller (नर्सरी/ रोपविक्री)" || getvalue == "Old book Seller (जुने पुस्तक विक्रेते)" || getvalue == "Mold Making / Rubber Stamp / Die Making (साचे तयार करणे/ रबर स्टॅम्प/ डाई बनविणे)" || getvalue == "Making of Clay, Plaster of Paris, Cement Statues and Statues (मातीचे, प्लास्टर ऑफ पॅरीसचे, सिमेंटचे पुतळे व मुर्ती तयार करणे)" || getvalue == "Stock and sale of lime (चुना साठा व विक्री)" || getvalue == "Stocking and sale of animal feed (जनावराचे खाद्य साठा व विक्री)" || getvalue == "Old idle scrap stocks and sales (जुने निकामी स्क्रॅप साठा व विक्री)" || getvalue == "Selling  of registered imported items  (Customs Goods Sales Centre) (नोंदणीकृत आयात केलेली वस्तू विक्री (कस्टम माल विक्री केन्द्र))" || getvalue == "Share Broker/Stock Exchange/Share Consultancy (शेअर ब्रोकर्स/स्टाप इक्स्चेंज /शेअर कन्सल्टंसी)" || getvalue == " Builders (बिल्डर्स)" || getvalue == " Advertising hoarding agency (जहिराती (अॅडव्हरटायझींग) होडींग एजन्सी)" || getvalue == " Four Wheeler Showroom (फोर व्हिलर शोरुम)" || getvalue == " Two Wheeler Showroom (टु व्हिलर शोरुम)") {
                    var fee = 200;
                    $("#fees").val(fee);

                } else if (getvalue == "Stock, Manufacturing and sale of soap, liquid soap, washing powder (साबण ,द्रवरूप साबण , धुण्याची पावडर यांचा साठा ,उत्पादन व विक्री)" || getvalue == "Juice bars and sugarcane bars (रस बार व उसाची गुन्हाळी)" || getvalue == "All types of general stores (सर्व प्रकारचे जनरल स्टोअर्स)") {
                    var fee = 300;
                    $("#fees").val(fee);

                } else if (getvalue == "Breeding centers (बिछायत केंद्रे)") {
                    var fee = 400;
                    $("#fees").val(fee);
                } else if (getvalue == "10 to 20 labours Businesses registered under the Labor Factories Act (१० ते २० कामगार)") {
                    var fee = 1500;
                    $("#fees").val(fee);
                } else if (getvalue == "Assembly and Manufacturing of electronic goods (इलेक्ट्रॉनिक वस्तूची जुळवणी व उत्पादन)" || getvalue == "Electro Plating (इलेकट्रो प्लेटिंग)" || getvalue == "Manufacturing of dynamite and their storage (डायनामाइट साठविणे व त्यापासून वस्तू तयार करणे)" || getvalue == "21 to 100 labours Businesses registered under the Labor Factories Act (२१ ते १०० कामगार)" || getvalue == "Petrol and Diesel Pump Stock and Sale (as defined in the Petroleum Act, 1934)(पेट्रोल व डिझेल पंप साठा व विक्री (पेट्रोलियम अधि. 1934 मध्ये व्याख्या केल्याप्रमाणे))" || getvalue == "Selling  of registered imported items  (Customs Goods Sales Centre) (नोंदणीकृत आयात केलेली वस्तू विक्री (कस्टम माल विक्री केन्द्र))" || getvalue == "Share Broker/Stock Exchange/Share Consultancy (शेअर ब्रोकर्स/स्टाप इक्स्चेंज /शेअर कन्सल्टंसी)" || getvalue == " Builders (बिल्डर्स)" || getvalue == " Advertising hoarding agency (जहिराती (अॅडव्हरटायझींग) होडींग एजन्सी)" || getvalue == " Four Wheeler Showroom (फोर व्हिलर शोरुम)" || getvalue == " Two Wheeler Showroom (टु व्हिलर शोरुम)" || getvalue == "Petrol and Diesel Pump Stock and Sale (as defined in the Petroleum Act, 1934)(पेट्रोल व डिझेल पंप साठा व विक्री (पेट्रोलियम अधि. 1934 मध्ये व्याख्या केल्याप्रमाणे))") {
                    var fee = 2000;
                    $("#fees").val(fee);

                } else if (getvalue == "Sutikagriha (Maternity Home) (सुतिकागृह (मॅटर्निटी होम))") {
                    var fee = 2500;
                    $("#fees").val(fee);
                } else if (getvalue == "Sale of Super market wholesale (सुपर मार्केट होलसेल विक्री)" || getvalue == "Star Hotel (स्टार हॉटेल)" || getvalue == "Hotel with Lodging / Boarding (हॉटेल विथ लॉजिंग / बोर्डिग)" || getvalue == "Hospital (दवाखाना (हॉस्पीटल))" || getvalue == "Super market(सुपर मार्केट)" || getvalue == "Retailer of country liquor (देशी दारूचे चिल्लर विक्रेते)" || getvalue == "Retailer of foreign liquor (विदेशी दारूचे चिल्लर विक्रेते)") {
                    var fee = 5000;
                    $("#fees").val(fee);
                } else if (getvalue == "Lawns to be used for wedding parties (लग्न पार्टिसाठी वापरण्याचे लॉन्स)" || getvalue == "Wholesaler of country liquor(देशी दारूचे ठोक विक्रेते)" || getvalue == "Wholesaler of foreign liquor (विदेशी दारूचे ठोक विक्रेते)") {
                    var fee = 10000;
                    $("#fees").val(fee);

                } else if (getvalue == "Star Hotel (स्टार हॉटेल)" || getvalue == "Marriage office (मंगल कार्यालय)") {
                    var fee = 15000;
                    $("#trade").val(fee)

                } else if (getvalue == "Star Hotel (स्टार हॉटेल)") {
                    var fee = 25000;
                    $("#trade").val(fee)
                } else if (getvalue == "Workers above 501 (Occupations not registered under Factories Act as well as occupations related to foodstuff) (५०१ त्या पुढील कामगार (फॅक्टरी ऍक्ट खाली नोंदणी न झालेले व्यवसाय तसेच अन्नपदार्थ संबंधीचे व्यवसाय ))") {
                    var fee = 7000;
                    $("#trade").val(fee)
                } else if (getvalue == "Stock and sale of industrial grasses (औद्यागिक घासलेट साठा व विक्री)") {
                    var fee = 600;
                    $("#trade").val(fee)
                } else if (getvalue == "Newspapers, Libraries, Book Depots, Magazines, Magazines, Junk Sales and Stocks (वृत्तपत्रे, वाचनालये, बुकडेपो, नियतकालीके, मासिके, रद्दी विक्री व साठा)") {
                    var fee = 50;
                    $("#fees").val(fee);

                } else if (getvalue == "Means of transport eg. Goods train, Handcart etc. Manufacturing, repair and sale of goods (वाहतुकीची साधन उदा. मालगाडी, हातगाडी इ. वस्तुची निर्मिती, दुरुस्ती व विक्री)" || getvalue == "Repair, sale and rental of bicycles, cycle rickshaws.Manufacturing, repair, maintenance and sale of goods other than those listed above (सायकली, सायकल रिक्षा यांची दुरुस्ती विक्री व भाड्याने देणे, वरील यादी शिवाय इतर वस्तुंची निर्मिती, दुरुस्ती देखभाल विक्री)" || getvalue == "PCO and STD Run the booth (पी.सी.ओ. व एस.टी.डी. बुथ चालविणे)" || getvalue == "Selling or offering for sale fur, whether or not for human consumption (no public place or public road shall be used for the purpose) (मानवी आहारासाठी असो किंवा नसो फरीने विकण्याचा किंवा विक्रीसाठी मांडण्याचा (प्रयोजनासाठी कोणत्याही सार्वजनिक जागेचा किंवा सार्वजनिक रस्त्याचा उपयोग करता येणार नाही))") {
                    var fee = 100;
                    $("#fees").val(fee);
...
<li>4.Copy of the Former Licence (In case of Renewal the Licence)(पूर्वीच्या परवान्याची प्रत (परवाना नूतनीकरणाच्या बाबतीत))<span
	...
	$(document).ready(function () {
        ...
        function upload(callback) {
    		...
    		data.append('idProof3', $("#city_survey3").get(0).files[0]);
            ...
            for (var i = 0; i < file.length; i++) {
       			...
       			const value = splitName + ".pdf";
                    ...
                    filesPath = filesPath + basePath + "tradeRenewal/" + id + value + ","
                    isFileSelected = true;
                }
            }
            $.ajax({
                url: "<c:out value='${contextRoot}'/>/rtiapplication/uploadTradeLicenceRenewal.do?id="+id,
                type: 'POST',
                data: data,
                cache: false,
                dataType: 'json',
