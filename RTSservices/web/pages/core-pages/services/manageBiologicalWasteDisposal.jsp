...
<script type="text/javascript">
	...
	function savebiologicalWasteDisposalCertificate() {

		onPageSubmit('<c:out value="${contextRoot}"/>/rtiapplication/saveBiologicalWasteDisposal.do');
	}
...
<div class="mainHdr">
	<h3>
		<fmt:message key="Application for Biological Waste Disposal" />
	</h3>
</div>
<div valign="top" id="SetFormHeight">
	<table width="98%" border="0" cellpadding="2" cellspacing="2"
		...
		<tr>
			...
			<td><span class="ClsLabel"
				style="font-size: 14px"><fmt:message key="Name and Address" />:</span></td>
			<td><input type="text" class="ClsTextbox" style="width: 180px"
				id="nameAndAddress" maxlength="50" name="nameAndAddress"
				value="<c:out value="${biologicalWasteDisposal.nameAndAddress}"/>" /></td>

			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="Education" />:</span><span class="ClsRequiredFields"></span></td>
			<td><select name="education" class="ClsTextbox"
				style="width: 180px">
		...
		<tr>
			...
			<td><textarea class="ClsTextbox" style="width: 170px"
					id="hospitalName" maxlength="30" name="hospitalName">${biologicalWasteDisposal.hospitalName}</textarea>
				&nbsp;</td>

			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="Hospital Address" /></span><span class="ClsRequiredFields"></span></td>
			<td><input type="text" class="ClsTextbox" style="width: 180px"
				id="hospitalAddress" maxlength="50" name="hospitalAddress"
				value="<c:out value="${biologicalWasteDisposal.hospitalAddress}"/>" />
				&nbsp;</td>
		</tr>
		<tr>
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
			...
			<td><input type="text" class="ClsTextbox" id="mobileNumber"
				...
				value="<c:out value="${biologicalWasteDisposal.mobileNumber}"/>" /></td>

			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="No of beds" />:</span></td>
			<td><input type="text" class="ClsTextbox" style="width: 170px"
				id="numberOfBeds" maxlength="30" name="numberOfBeds"
				value="<c:out value="${biologicalWasteDisposal.numberOfBeds}"/>" />
				&nbsp;</td>
		</tr>
		<tr>

			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="Medical Council Reg Number" />:</span></td>
			<td><input type="text" class="ClsTextbox" style="width: 170px"
				id="medicalCouncilRegNumber" maxlength="30"
				name="medicalCouncilRegNumber"
				value="<c:out value="${biologicalWasteDisposal.medicalCouncilRegNumber}"/>" />
				&nbsp;</td>

			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="Nursing Home Municipal Reg Number" /><span
					class="ClsRequiredFields"></span>: </td>
			<td><textarea class="ClsTextbox" style="width: 170px"
					id="nursingHomeMunicipalRegNumber" maxlength="30"
					name="nursingHomeMunicipalRegNumber">${biologicalWasteDisposal.nursingHomeMunicipalRegNumber}</textarea>
				&nbsp;</td>

		</tr>
		<tr>
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="Medical Profession Type" /><span class="ClsRequiredFields"></span>:
			</td>
			<td><select name="medicalProfessionType" class="ClsTextbox"
				style="width: 180px">
		...
		<tr>
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="Other Professional Details" /><span
					class="ClsRequiredFields"></span>: </td>
			<td><textarea class="ClsTextbox" style="width: 170px"
					id="otherProfessionalsDetails" maxlength="30"
					name="otherProfessionalsDetails">${biologicalWasteDisposal.otherProfessionalsDetails}</textarea>
				&nbsp;</td>


			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="Biological Waste Description" /><span
					class="ClsRequiredFields"></span>: </td>
			<td><textarea class="ClsTextbox" style="width: 170px"
					id="biologicalWasteDescription" maxlength="30"
					name="biologicalWasteDescription">${biologicalWasteDisposal.biologicalWasteDescription}</textarea>
				&nbsp;</td>
		</tr>
		<tr>
     ...
     <%@include file="/pages/common-pages/dms/fileUpload.jsp"%>    
		...
		<tr>
			<td colspan="6" align="center"><input type="button"
				...
				onclick="javascript:savebiologicalWasteDisposalCertificate(this.form);"
	...
	<input type="hidden" class="ClsTextbox_mr" style="width: 180px"
		id="bwdId" maxlength="12" name="bwdId"
		value="<c:out value="${biologicalWasteDisposal.bwdId}"/>" /> 
