...
<div class="container">
	<h3 style="font-size: 18px; font-weight: bold;">
		...
		<fmt:message key="Application Form For Trade License Outdated Renewal Notice" />
		:
...
<div valign="top" id="SetFormHeight">
	<input type="hidden" name="id"
		value="${tradeLicenseOutdatedRenewalNotice.tradeLicenseOutdatedRenewalID}">
	<table width="100%" border="0" cellpadding="2" cellspacing="2"
		...
		<tr>
			...
			<td><input type="text" class="form-control"
				...
				value="<c:out value="${tradeLicenseOutdatedRenewalNotice.firstName}"/>" /></td>
			...
			<td><input type="text" class="form-control" style="width: 350px"
				...
				value="<c:out value="${tradeLicenseOutdatedRenewalNotice.middleName}"/>" /></td>
		...
		<tr>
			...
			<td><input type="text" class="form-control"
				style="width: 350px;" id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${tradeLicenseOutdatedRenewalNotice.lastName}"/>" /></td>

			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicenseOutdatedRenewalNotice.fullname" />:</span><span
				class="ClsRequiredFields"></span></td>
			<td>
<input type="text" class="form-control" style="width: 350px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${tradeLicenseOutdatedRenewalNotice.fullName}"/>" />
			</td>
		</tr>
		<tr>

			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicenseOutdatedRenewalNotice.pincode" />:</span></td>
			<td><input type="text" class="form-control" style="width: 350px;"
					id="ownerAddress" maxlength="200" name="ownerAddress" value="<c:out value="${tradeLicenseOutdatedRenewalNotice.pinCode}"/>"/></td>

			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicenseOutdatedRenewalNotice.aadhaarno" /><span class="ClsRequiredFields"></span>: </td>
			<td><input type="text" class="form-control" style="width: 350px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${tradeLicenseOutdatedRenewalNotice.aadhaarNo}"/>" /></td>

		</tr>
		<tr>

			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicenseOutdatedRenewalNotice.emailid" />:</span></td>
			<td><input type="text" class="form-control" style="width: 350px"
				id="changedHospitalNameAndAddress" maxlength="30"
				name="changedHospitalNameAndAddress"
				value="<c:out value="${tradeLicenseOutdatedRenewalNotice.emailID}"/>" /></td>

			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicenseOutdatedRenewalNotice.mobileno" /><span class="ClsRequiredFields"></span>: </td>
			<td><input type="text" class="form-control" style="width: 350px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${tradeLicenseOutdatedRenewalNotice.mobileNumber}"/>" /></td>

		</tr>
		<tr>
		<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicenseOutdatedRenewalNotice.addressForCorre" /><span class="ClsRequiredFields"></span>: </td>
			<td><textarea class="form-control" style="width: 350px;"
					id="ownerAddress" maxlength="200" name="ownerAddress" rows="2">${tradeLicenseOutdatedRenewalNotice.adressForCorrespondence}</textarea></td>
			
			
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicenseOutdatedRenewalNotice.zoneno" />:</span></td>
			<td><input type="text" class="form-control" style="width: 350px"
				id="changedHospitalNameAndAddress" maxlength="30"
				name="changedHospitalNameAndAddress"
				value="<c:out value="${tradeLicenseOutdatedRenewalNotice.zoneNo}"/>" /></td>
</tr>
<tr>
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicenseOutdatedRenewalNotice.wardno" /><span class="ClsRequiredFields"></span>: </td>
			<td><input type="text" class="form-control" style="width: 350px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${tradeLicenseOutdatedRenewalNotice.wardNo}"/>" /></td>

		
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicenseOutdatedRenewalNotice.nameofarea" />:</span></td>
			<td><input type="text" class="form-control" style="width: 350px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${tradeLicenseOutdatedRenewalNotice.nameOfArea}"/>" /></td>
</tr>
		<tr>
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicenseOutdatedRenewalNotice.tradelicenseno" />:</span><span class="ClsRequiredFields"></span></td>
			<td><input type="text" class="form-control" style="width: 350px"
					id="ownerAddress" maxlength="200" name="ownerAddress" value="<c:out value="${tradeLicenseOutdatedRenewalNotice.tradeLicenceNo}"/>"/>

			</td>
		

			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicenseOutdatedRenewalNotice.updatedtradename" />:</span></td>
			<td><input type="text" class="form-control" style="width: 350px"
				id="changedHospitalNameAndAddress" maxlength="30"
				name="changedHospitalNameAndAddress"
				value="<c:out value="${tradeLicenseOutdatedRenewalNotice.updateTradeName}"/>" /></td>
</tr>
		<tr>
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicenseOutdatedRenewalNotice.updatedtradetype" /><span class="ClsRequiredFields"></span>:
			</td>
			<td><input type="text" class="form-control" style="width: 350px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${tradeLicenseOutdatedRenewalNotice.updatedTradeType}"/>" /></td>

		

			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicenseOutdatedRenewalNotice.updatedownername" />:</span></td>
			<td><input type="text" class="form-control" style="width: 350px"
				id="changedHospitalNameAndAddress" maxlength="30"
				name="changedHospitalNameAndAddress"
				value="<c:out value="${tradeLicenseOutdatedRenewalNotice.updatedOwnerName}"/>" /></td>
</tr>
		<tr>
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicenseOutdatedRenewalNotice.updatedpartnercount" /><span class="ClsRequiredFields"></span>:
			</td>
			<td><input type="text" class="form-control" style="width: 350px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${tradeLicenseOutdatedRenewalNotice.updatedPartnerCount}"/>" /></td>
				
				<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicenseOutdatedRenewalNotice.feesApplicable" /><span class="ClsRequiredFields"></span>:
			</td>
			<td><input type="text" class="form-control" style="width: 350px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${tradeLicenseOutdatedRenewalNotice.feesApplicable}"/>" /></td>
...
<tr>
	       <td colspan="6" align="center">
                      ...
                      <button class="ClsButton clsButtonUpload" onclick="download(${tradeLicenseOutdatedRenewalNotice.rtiRefId},'tradeLicenseOutdatedRenewalReport.do')">GENERATE CERTIFICATE</button>
...
<c:if test="${requestScope.rtiApplication.workFlowStatus==2}">
				...
				<tr>
					<td colspan="6" align="center"><a
						...
						onclick="downloads('${tradeLicenseOutdatedRenewalNotice.rtiRefId}', 'tradeLicenseOutdatedRenewalReport.do');"
						type="button" target="_blank"> <span class="download"
							style="display: flex; align-items: center;width: 160px;">Generate
								Certificate</span>
											...
											onclick="download1(${tradeLicenseOutdatedRenewalNotice.rtiRefId});return false;"><span
...
<tr>
			<td colspan="5"><span class="ClsLabel"
				style="font-size: 15px; font-weight: bold;"><fmt:message
						key="List of Documents (Attachment) For Trade License Outdated Renewal Notice" />:</span></td>
						                                         		<c:if test="${doc[0] != 'null'}">
						
		<tr>
			<td style="width: 600px; height: 30px"><span class="ClsLabel"
				style="font-size: 14px;"><fmt:message
						key="label.tradeLicenseOutdatedRenewalNotice.nocforrelateddept" />:</span></td>
...
<a class="bg-button btn btn-primary bd-highlight action"
   ...
   <span class="download" style="align-items: center;color:white;">Download</span>
		...
		<tr>
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicenseOutdatedRenewalNotice.copyofformerlicnse" />:</span></td>
<td style="text-align: center"> <a class="bg-button btn btn-primary bd-highlight action"
   ...
   <span class="download" style="align-items: center;color:white;">Download</span>
		...
		<tr>
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicenseOutdatedRenewalNotice.propertynodue" />:</span></td>
<td style="text-align: center"> <a class="bg-button btn btn-primary bd-highlight action"
   type="button"
   target="_blank"
   ...
   <span class="download" style="align-items: center;color:white;">Download</span>
		...
		<tr>
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicenseOutdatedRenewalNotice.buildingauthdocument" />:</span></td>
<td style="text-align: center"> <a class="bg-button btn btn-primary bd-highlight action"
   type="button"
   target="_blank"
 ...
 <input type="hidden" class="ClsTextbox" id="tradeLicenseOutdatedRenewalID" style="width:180px"  name="tradeLicenseOutdatedRenewalID" value="<c:out value="${tradeLicenseOutdatedRenewalNotice.tradeLicenseOutdatedRenewalID}"/>" />
    <input type="hidden" id="rtiApplicationRefId" name="rtiApplicationRefId" value="" />
        			  			  <input type="hidden" id="rtiApplicationRefIds" name="rtiApplicationRefIds" value="${tradeLicenseOutdatedRenewalNotice.rtiRefId}" />
...
<script type="text/javascript">
	function saveEntity() {
		onPageSubmit('<c:out value="${contextRoot}"/>/rtiapplication/createTradeLicenseOutdatedRenewalWork.do');
	}
