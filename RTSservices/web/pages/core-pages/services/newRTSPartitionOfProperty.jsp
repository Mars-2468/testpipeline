...
<li>1. Copy of Registered Sale Deed (नोंदणीकृत विक्री कराराची प्रत)<span class="text-danger" style="color: red;">*</span></li>
    ...
    <li>6. Copy of Electric Bill (इलेक्ट्रिक बिलाची प्रत)<span class="text-danger" style="color: red;">*</span></li>
		...
		<div class="container-fluid mt-2" style="width: 180vh">
			<div class="printable">
				<h3 class="text-center">Partition Of Property (उपविभागामध्ये मालमत्ता विभाजन)</h3>
			</div>
			 <hr class="custom-hr">
           <!-- 
        ...
        if (!form.checkValidity()) {
			...
			<div class="row">
				...
				<div class="">
					...
					<div class="col-md-3">
						<div class="mb-3 mt-5">
							<label for="" class="form-label lbleng">Self Attested Applicant's Id Proof (स्वत: प्रमाणित अर्जदाराचा आयडी पुरावा)<span class="text-danger"
								style="color: red;">*</span>
							</label> <input type="file" class="form-control"
					...
					<div class="col-md-3">
						<div class="mb-3 mt-5">
							<label for="" class="form-label lbleng">Regularization Letter (RL) (नियमितीकरण पत्र (RL)) </label> <input type="file"
								class="form-control" style="background-image: none;" id="doc4"
								placeholder="" name="rLetter">
						</div>
					</div>
					<div class="col-md-3">
						<div class="mb-3 mt-4">
							<label for="" class="form-label lbleng"> Water Bill (पाणी बिल) Water Bill (पाणी बिल)</label> <input type="file" class="form-control"
            ...
            Array.from(forms).forEach(form => {
                form.addEventListener('submit', event => {
                    ...
                    if (!form.checkValidity() || !isFormValid) {
                     ...
                     onPageSubmit('<c:out value="${contextRoot}"/>/rtsapplication/savePartitionOfProperty.do');
                   	    } else {
        ...
        function upload(callback) {
            ...
            for (var i = 0; i < file.length; i++) {
       			...
       			const value = splitName + ".pdf";
                    ...
                    filesPath = filesPath + basePath + "PartitionOfProperty/" + id + value + ","
                    isFileSelected = true;
                }
            }
            $.ajax({
                url: "<c:out value='${contextRoot}'/>/rtsapplication/uploadDocumentPartitionOfProperty.do?id="+id,
                type: 'POST',
                data: data,
                cache: false,
                dataType: 'json',
