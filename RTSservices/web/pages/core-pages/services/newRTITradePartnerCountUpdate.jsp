...
<body>
    ...
    <form>
   <div class="container-fluid mt-3" style="width: 180vh">
           <div class="printable">
               <h3 class="text-center">Application Form For Trade Licence Partner Count Update <br>(भागीदाराची संख्येत बदल (वाढ/कमी ) करण्याबाबत अर्ज)							
            </h3>
           </div>
    ...
    <div class="col-md-3">
                    ...
                    <input type=" number" class="form-control" style="background-image: none;" pattern="^\s*\S.*$"   id="plot_no" placeholder="" name="applicantPlotNo" value=""
        ...
        <div class="col-md-3">
            <div class="mb-3 mt-3">
                ...
                maxlength="6" id="pin_code" onchange="change(this.id)" required>
                <div class="invalid-feedback">
...
function validateTextarea() {
  ...
  if (regex.test(text)) {
    ...
    errorFeedback.style.display = 'block';
                ...
                <h6 style="background-color:#dce2e8; padding:10px;" class=" mt-3 rounded-2">			<strong> Application Form Details (अर्जाचा तपशील)</strong>
                </h6>
                <div class="row">
                ...
                $('#dependent-dropdown').append('<option value="' + (options[i] === '-Select Ward-' ? '' : options[i]) + '">' + options[i] + '</option>');
                        ...
                        <div class="col-md-3">
                            <div class="mb-3 mt-3">
                                ...
                                <input type="text" class="form-control" style="background-image: none;" id="" placeholder="" name="areaName" maxlength="100" value=""  >
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="mb-3 mt-3">
                                ...
                                <input type="text" class="form-control" style="background-image: none;" id=""pattern="^\s*\S.*$" placeholder="" name="tradeLicenseNo"maxlength="100" value="" required>
                                <div class="invalid-feedback">
                        ...
                        <div class="col-md-3">
                            <div class="mb-3 mt-2" style="margin-top: 40px;">
                                <label for="" class="form-label lbleng">Updated Trade Name (अद्यतनित व्यापार नाव)</label>
            
                                <input type="text" class="form-control" style="background-image: none;"pattern="^\s*\S.*$" id=""maxlength="100" placeholder="" name="UpdatedTradeName" pattern="^([A-Za-z]{0,})([A-Za-z]{1,}\s?)+$" value="" >
    ...
    <div class="mb-3 mt-2">
        ...
        <select class="form-select" style="background-image: none;" id="trade" name="updatedTradeType" onchange="tradeLicense(this.id)" required>
         ...
         <div class="invalid-feedback">Please Enter Valid Updated Trade Type.
                        ...
                        <div class="col-md-3">
                            <div class="mb-3 mt-2">
                                <label for="" class="form-label lbleng">Updated Owner/Partner Name (अद्यतनित केलेले मालक/भागीदाराचे नाव)<span class="text-danger"
                                        style="color: red;">*</span></label>
            
                                <input type="text" class="form-control" style="background-image: none;"pattern="^\s*\S.*$" id="" placeholder="" name="updatedOwnerName" maxlength="100"value=""  pattern="^([A-Za-z]{0,})([A-Za-z]{1,}\s?)+$" required>
                                <div class="invalid-feedback">
    ...
    function validateInputLength(input) {
        if (input.value.length > parseInt(input.getAttribute('maxlength'))) {
            input.value = input.value.slice(0, parseInt(input.getAttribute('maxlength')));
                        ...
                        <div class="col-md-3">
                            <div class="mb-3 mt-3">
                                <label for="" class="form-label lbleng">Applicable Fee (भरावयाचा शुल्क) </label>
            
                                <input type="text" value ="1000" class="form-control" style="background-image: none;" id="" placeholder="" name="applicableFee" readonly>
                            </div>
                        </div> 
                                                </div>
			...
			<div class="alert alert-info mb-2 p-2 mb-4 ms-2">
                <small class="form-label "><strong class="form-label ">Note(नोंद): </strong> Upload below files only
			...
			<div class="col-md-3">
                <div class="mb-3" style="margin-top:-10px;">
                    <label for="" class="form-label">NOC for the related department issued from the NMC/Department Officer/Govt/Semi Govt. Officer (एनएमसी/विभाग अधिकारी/शासकीय/निमशासकीयांकडून जारी केलेल्या संबंधित विभागासाठी एनओसी. अधिकारी)<span class="text-danger"
                            style="color: red;">*</span> 
</label>
                    <input type="file" class="form-control" accept=".pdf" style="background-image: none;" id="doc1" placeholder=""
            ...
            <div class="col-md-3">
                <div class="mb-3 " style="margin-top: 62px;">
                    ...
                    <input type="file" class="form-control" accept=".pdf" style="background-image: none;" id="doc2" placeholder="" name="CopyOfTheFormerLicence " required>
                    <div class="invalid-feedback">
                        File selected is either greater than 2Mb or not of type .pdf.
                    </div>
            ...
            <div class="col-md-3">
                <div class="mb-3 "style="margin-top: 85px;">
                    <label for="" class="form-label lbleng">No Dues Certificate for Property Tax (मालमत्ता करासाठी ना हरकत  प्रमाणपत्र)</label>

                    <input type="file" class="form-control" style="background-image: none;" id="doc3" placeholder="" name="NoDuesCertificate" >
                </div>
            </div>
			<div class="col-md-3">
                <div class="mb-3"style="margin-top: 84px">
                    <label for="" class="form-label lbleng"> Building Authorization Document (इमारत अधिकृतता दस्तऐवज)<span
                            class="text-danger" style="color: red;"  >*</span></label>


                    <input type="file" class="form-control" accept=".pdf" style="background-image: none;" id="doc4" placeholder="" name=" BuildingAuthorizationDocument" required >
                    <div class="invalid-feedback">
                        File selected is either greater than 2Mb or not of type .pdf.
                    </div>
                    ...
                    <div class="modal-body" style="color:green">
                      ...
                      <p style="color:red">
                        ...
                        <ul style="color:rgb(3, 125, 76)">
                            ...
                            <li>1.NOC for the related department issued from the NMC/Department Officer/Govt/Semi Govt. Officer (एनएमसी/विभाग अधिकारी/शासकीय/निमशासकीयांकडून जारी केलेल्या संबंधित विभागासाठी एनओसी. अधिकारी)</li>
                            <li>2.Copy of the Former Licence (In case of Renewal the Licence) (पूर्वीच्या परवान्याची प्रत (परवाना नूतनीकरणाच्या बाबतीत))<span class="text-danger"  style="color: red;">*</span> </li>
                            <li>3.No Dues Certificate for Property Tax (मालमत्ता करासाठी ना हरकत  प्रमाणपत्र)</li>
                            <li>4. Building Authorization Document (इमारत अधिकृतता दस्तऐवज)<span class="text-danger" style="color: red;">*</span> </li>
   	               ...
   	               if (!form.checkValidity() || !isFormValid) {
   	              	...
   	              	upload(function(status) {
   	              	    ...
   	              	    if (status === true || status === 'true') {
   	                		...
   	                		onPageSubmit('<c:out value="${contextRoot}"/>/rtsapplication/saveTradeLicencePartnerCountUpdate.do');
   	              	    } 
	 ...
	 function upload(callback) {
	       ...
	       for (var i = 0; i < file.length; i++) {
	  			...
	  			const value = splitName + ".pdf";
	               ...
	               filesPath = filesPath + basePath + "tradeLicensePartnerCountUpdate/" + id + value + ","
	               isFileSelected = true;
	           }
	       }
	       $.ajax({
	                url: "<c:out value='${contextRoot}'/>/rtiapplication/uploadDocumentTradeLicensePartnerCountUpdate.do?id="+id,
	           type: 'POST',
	           data: data,
	           cache: false,
	           dataType: 'json',
