...
<div class="mainHdr">
	<h3>
		...
		<fmt:message
			key="Application form for Trade Licence Partner Count update" />
...
<div valign="top" id="SetFormHeight">
	<input type="hidden" name="id"
		value="${tradeLicencePartnerCountUpdate.tradeLicencePartnerCountUpdateId}">
	<table width="98%" border="0" cellpadding="2" cellspacing="2"
		...
		<tr>
			...
			<td><input type="text" class="form-control" style="width: 180px"
				...
				value="<c:out value="${tradeLicencePartnerCountUpdate.firstName}"/>" /></td>
			...
			<td><input type="text" class="form-control" style="width: 180px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${tradeLicencePartnerCountUpdate.middleName}"/>" /></td>
		...
		<tr>
			...
			<td><input type="text" class="form-control" style="width: 180px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${tradeLicencePartnerCountUpdate.lastName}"/>" /></td>


			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicensePartnerCountUpdate.fullname" />:</span></td>
			<td><input type="text" class="form-control" style="width: 180px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${tradeLicencePartnerCountUpdate.fullName}"/>" /></td>
		...
		<tr>
			...
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicensePartnerCountUpdate.pincode" />:</span></td>
			<td><input type="text" class="form-control" style="width: 170px"
				...
				value="<c:out value="${tradeLicencePartnerCountUpdate.pinCode}"/>" />
				&nbsp;</td>


			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicensePartnerCountUpdate.aadhaarno" />:</span></td>
			<td><input type="text" class="form-control" style="width: 170px"
				id="changedHospitalNameAndAddress" maxlength="30"
				name="changedHospitalNameAndAddress"
				value="<c:out value="${tradeLicencePartnerCountUpdate.aadhaarNo}"/>" />
				&nbsp;</td>
		...
		<tr>
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicensePartnerCountUpdate.email" />:</span></td>

			<td><input type="text" class="form-control" style="width: 180px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${tradeLicencePartnerCountUpdate.email}"/>" /></td>

			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicensePartnerCountUpdate.mobileno" />:</span></td>
			<td><input type="text" class="form-control" style="width: 170px"
				id="changedHospitalNameAndAddress" maxlength="30"
				name="changedHospitalNameAndAddress"
				value="<c:out value="${tradeLicencePartnerCountUpdate.mobileNo}"/>" />
				&nbsp;</td>
		...
		<tr>
			...
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicensePartnerCountUpdate.address" />:</span></td>
			<td><input type="text" class="form-control" style="width: 170px"
				id="changedHospitalNameAndAddress" maxlength="30"
				name="changedHospitalNameAndAddress"
				value="<c:out value="${tradeLicencePartnerCountUpdate.address}"/>" />
				&nbsp;</td>

			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicensePartnerCountUpdate.zoneno" /><span
					class="ClsRequiredFields"></span>: </td>
			<td><input type="text" class="form-control" style="width: 180px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${tradeLicencePartnerCountUpdate.zoneNo}"/>" /></td>
		...
		<tr>
			...
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicensePartnerCountUpdate.wardno" />:</span></td>
			<td><input type="text" class="form-control" style="width: 170px"
				id="changedHospitalNameAndAddress" maxlength="30"
				name="changedHospitalNameAndAddress"
				value="<c:out value="${tradeLicencePartnerCountUpdate.wardNo}"/>" />
				&nbsp;</td>

			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicensePartnerCountUpdate.nameofarea" /><span
					class="ClsRequiredFields"></span>: </td>
			<td><input type="text" class="form-control" style="width: 180px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${tradeLicencePartnerCountUpdate.areaName}"/>" /></td>
		...
		<tr>
			...
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicensePartnerCountUpdate.licenseno" />:</span></td>
			<td><input type="text" class="form-control" style="width: 170px"
				id="changedHospitalNameAndAddress" maxlength="30"
				name="changedHospitalNameAndAddress"
				value="<c:out value="${tradeLicencePartnerCountUpdate.tradeLicenseNo}"/>" />
				&nbsp;</td>

			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicensePartnerCountUpdate.updatedtradename" /><span
					class="ClsRequiredFields"></span>: </td>
			<td><input type="text" class="form-control" style="width: 180px"
				id="ownerName" maxlength="50" name="ownerName"
				value="<c:out value="${tradeLicencePartnerCountUpdate.updatedTradeName}"/>" /></td>
		...
		<tr>
			...
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicensePartnerCountUpdate.updatedtradetype" />:</span></td>
			<td><input type="text" class="form-control" style="width: 170px"
				id="changedHospitalNameAndAddress" maxlength="30"
				name="changedHospitalNameAndAddress"
				value="<c:out value="${tradeLicencePartnerCountUpdate.updatedTradeType}"/>" />
				&nbsp;</td>

			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicensePartnerCountUpdate.partnername" />:</span></td>
			<td><input type="text" class="form-control" style="width: 170px"
				id="changedHospitalNameAndAddress" maxlength="30"
				name="changedHospitalNameAndAddress"
				value="<c:out value="${tradeLicencePartnerCountUpdate.updatedOwnerName}"/>" />
				&nbsp;</td>
		</tr>
		...
		<tr>
			...
			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicensePartnerCountUpdate.updatedpartnercount" />:</span></td>
			<td><input type="text" class="form-control" style="width: 170px"
				id="changedHospitalNameAndAddress" maxlength="30"
				name="changedHospitalNameAndAddress"
				value="<c:out value="${tradeLicencePartnerCountUpdate.updatedPartnerCount}"/>" />
				&nbsp;</td>

			<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="label.tradeLicensePartnerCountUpdate.ApplicableFee" />:</span></td>
			<td><input type="text" class="form-control" style="width: 170px"
				id="changedHospitalNameAndAddress" maxlength="30"
				name="changedHospitalNameAndAddress"
				value="<c:out value="${tradeLicencePartnerCountUpdate.applicableFee}"/>" />
				&nbsp;</td>
		...
		<!--<c:if test="${requestScope.rtiApplication.workFlowStatus==2}">
			...
			<tr>
				<td colspan="6" align="center"><a target="_blank" href=""
					id="genCerBtn">

						<button class="ClsButton clsButtonUpload"
							onclick="download(${tradeLicencePartnerCountUpdate.rti_ref_id},'tradeLicensePartnerCountUpdateReport.do')">GENERATE
							CERTIFICATE</button>
		...
		<c:if test="${requestScope.rtiApplication.workFlowStatus==2}">
				...
				<tr>
					<td colspan="6" align="center"><a
						...
						onclick="downloads('${tradeLicencePartnerCountUpdate.rti_ref_id}', 'tradeLicensePartnerCountUpdateReport.do');"
						type="button" target="_blank"> <span class="download"
							style="display: flex; align-items: center;width: 160px;">Generate
								Certificate</span>
											...
											onclick="download1(${tradeLicencePartnerCountUpdate.rti_ref_id});return false;"><span
	...
	<table width="100%" border="0" cellpadding="2" cellspacing="2"
		...
		<tr>
			...
			<td><span class="ClsLabel" style="font-size: 14px"> <c:if
	...
	<table width="100%" border="0" cellpadding="2" cellspacing="2"
		class="container">
		<tr>
			<td colspan="5"><span class="ClsLabel" style="font-size: 14px"><fmt:message
						key="List of Documents (Attachment) For Trade Licence Partner Count Update" />:</span>
			</td>
		</tr>
		...
		<c:if test="${doc[0] != 'null'}">
			...
			<tr>
				<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
							key="label.tradeLicensePartnerCountUpdate.nocdoc1" />:</span> <c:if
   ...
   <span class="download" style="align-items: center;color:white;">Download</span>
		...
		<c:if test="${doc[1] != 'null'}">
			...
			<tr>
				<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
							key="label.tradeLicensePartnerCountUpdate.licensedoc2" />:</span> <c:if
						test="${requestScope.downloadCount>0}">
						<a target="_blank"
   ...
   <span class="download" style="align-items: center;color:white;">Download</span>
		...
		<c:if test="${doc[2] != 'null'}">
			...
			<tr>
				<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
							key="label.tradeLicensePartnerCountUpdate.noduesdoc3" />:</span> <c:if
						test="${requestScope.downloadCount>0}">
						<a target="_blank"
   ...
   <span class="download" style="align-items: center;color:white;">Download</span>
		...
		<c:if test="${doc[3] != 'null'}">
			...
			<tr>
				<td><span class="ClsLabel" style="font-size: 14px"><fmt:message
							key="label.tradeLicensePartnerCountUpdate.buildingauthorizationdoc4" />:</span>
...
<input type="hidden" class="ClsTextbox"
	id="tradeLicencePartnerCountUpdateId" style="width: 180px"
	name="tradeLicencePartnerCountUpdateId"
	value="<c:out value="${tradeLicencePartnerCountUpdate.tradeLicencePartnerCountUpdateId}"/>" />
<input type="hidden" id="rtiApplicationRefId" name="rtiApplicationRefId"
	value="" />
				  			  <input type="hidden" id="rtiApplicationRefIds" name="rtiApplicationRefIds" value="${tradeLicencePartnerCountUpdate.rti_ref_id}" />
...
function saveEntity()
{
	onPageSubmit('<c:out value="${contextRoot}"/>/rtiapplication/createTradeLicencePartnerCountUpdateWork.do');
}
