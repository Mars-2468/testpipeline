...
<body>
	...
	<form>
		...
		<div class="container-fluid mt-2" style="width: 180vh">
			<div class="printable">
				<h3 class="text-center">	<div class="class"><img src="<%=urls%>img/DurgaImg.png"></div>
				
				Application Form for Durga Utsav / Garba Mandap Permission (दुर्गा उत्सव/गरबा मंडप परवानगी)</h3>
			</div>
...
<div class="col-md-3">
					<div class="mb-3" style="margin-top: 28px;">
						<label for="" class="form-label lbleng">Durga Idol is made of which material (दुर्गा मूर्ती कुठल्या प्रकारची आहे)</label> <input type="text"
							class="form-control" 
...
एकावेळी मंडपात उपस्थित राहू शकणार्‍या एकूण भाविकांची संख्या)</label> <input type="number"
				...
				<div class="col-md-3">
					<div class="mb-3" style="margin-top:73px;">
						<label for="" class="form-label lbleng">Height(उंची))<span
							class="text-danger">*</span></label> <input type="text"
							class="form-control" 
        ...
        $("#gatetotalSize").val(totalSize.toFixed(2) + " ft");
				...
				<div class="row">
					...
					<div class="mb-3" style="margin-top: 15px;">
						<label for="" class="form-label lbleng">Place of Durga Visarjan (दुर्गा विसर्जनाचे ठिकाण)</label> 
						
						<!-- <input type="text"
							class="form-control" 
							style="background-image: none;" name="durgaUtsavVisarjan" value=""
							maxlength="80"  >-->
							
<select class="form-control" id="durgaUtsavVisarjan" name="durgaUtsavVisarjan" style="background-image: none;" >
...
<div class="invalid-feedback">
					...
					<div class="col-md-3">
					<div class="mb-3 mt-3">
						<label for="" class="form-label lbleng">Date of Durga immersion (दुर्गा विसर्जनाची तारीख)</label> <input type="date"
							class="form-control" 
							style="background-image: none;" name="durgaUtsavImmersion" value=""
							  />
...
<select class="form-select " style="background-image: none;"
							id="main-dropdown" name="policeStation" required>    
														<option value="select-zone" selected="">-Select Police Station-</option>
...
<!----------------------------->
 ...
 <span class="me-3">Will the members of committee be trained for First-aid,  fire fighting equipment and safe evacuation of people in emergency situations?</span><br>
          ...
          <span class="me-3">आपत्कालीन जनरेटरच्या स्वरूपात पर्यायी वीज व्यवस्था उपलब्ध करून दिली जाईल का?</span>
          </td>
          <td>
            <div class="form-check form-check-inline">
          ...
          <span class="me-3"> आग विझवण्यासाठी 5 किलोचे अग्निशामक यंत्र आणि 200 लिटर क्षमतेचे पाण्याचे ड्रम मंडपात 2 युनिट्स अग्निशमनासाठी ठेवल्या जातील का?</span>
          </td>
          <td>
            <div class="form-check form-check-inline">
          ...
          <span class="me-3">मंडळातील कामगारांना अग्निशमन उपकरणांचा प्रथमोपचार आणि आपत्कालीन परिस्थितीत लोकांना सुरक्षितपणे बाहेर काढण्याचे प्रशिक्षण दिले जाईल का?</span>
          </td>
          <td>
            <div class="form-check form-check-inline">
          ...
          <span class="me-3">अग्निशमनासाठी 5 किलो क्षमतेची A B C प्रकारची अग्निशामक यंत्रे आणि 200 लिटर क्षमतेचे पाण्याचे ड्रम पॅव्हेलियनमध्ये ठेवण्यात येणार आहेत?</span>
          </td>
          <td>
            <div class="form-check form-check-inline">
  ...
  <!--   <div class="col-md-3">
						<div class="mb-3 mt-3" style="margin-top: 38px;">
							<label for="" class="form-label">NOC From Police
								...
								style="background-image: none;" name="policeDepartment" required>
							<div class="invalid-feedback">File selected is either
					...
					<div class="col-md-3">
						<div class="mb-3 mt-3">
							<label for="" class="form-label">NOC From Traffic
								...
								style="background-image: none;" name="trafficDepartment"
								required>
							<div class="invalid-feedback">File selected is either
								greater than 5Mb or not of type .pdf.</div>
					...
					<div class="col-md-3">
						<div class="mb-3 mt-3">
							<label for="" class="form-label">NOC From Fire Department
								...
								style="background-image: none;" id="doc4" name="fireDepartment"
								required>
							<div class="invalid-feedback">File selected is either
								greater than 5Mb or not of type .pdf.</div>
...
स्वाक्षरी केलेले प्रतिज्ञापत्र डाउनलोड आणि अपलोड करा) <span class="text-danger"
				...
				<div class="col-md-3">
					<div class="mb-3 mt-0">
						<label for="" class="form-label"> Affidavit as per High Court order
(मा. उच्च न्यायालयाच्या नागपुर खडंपीठ आदेशानुसार प्रतिज्ञापत्र)  <span class="text-danger"
							style="color: red;">*</span> <a class="fa fa-download"
...
$('.printMe').on('click', function () {
                   	...
                   	upload(function(status) {
                   	    ...
                   	    if (status === true || status === 'true') {
                   	        $("#submit").attr("disabled", true);
                                onPageSubmit('<c:out value="${contextRoot}"/>/rtsapplication/saveDurgaUtsavMandapPermission.do');
                   	    } 
        ...
        function upload(callback) {
            ...
            for (var i = 0; i < file.length; i++) {
       			...
       			const value = splitName + ".pdf";
                    ...
                    filesPath = filesPath + basePath + "durgaUtsavPermission/" + id + value + ","
                    isFileSelected = true;
                }
            }
            $.ajax({
                url: "<c:out value='${contextRoot}'/>/rtsapplication/uploadDocumentdurgaUtsav.do?id="+id,
                type: 'POST',
                data: data,
                cache: false,
                dataType: 'json',
    ...
    function downloadFile() {
        var fileUrl = "<c:out value="${contextRoot}"/>/pages/citizendocument/DurgaAffidavit.pdf";
        var fileName = "DurgaAffidavit.pdf";
    ...
    function downloadFiles() {
        var fileUrl = "<c:out value="${contextRoot}"/>/pages/citizendocument/DurgaAffidavit2.pdf";
        var fileName = "DurgaHighCourtAffidavit.pdf";
