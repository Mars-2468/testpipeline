...
<body>
    ...
    <form class="needs-validation" novalidate>
          <div class="container-fluid mt-2" style="width: 180vh">
           <div class="printable">
               <h3 class="text-center">Application Form For Trade License Type Change (व्यवसाय बदलण्यासाठी अर्ज)						
    ...
    errorFeedback.style.display = 'block';
          ...
          <br>
                ...
                <div class="row">
                              ...
                              <div class="col-md-3">
            <div class="mb-3 mt-4">
                <label for="" class="form-label"> Existing Trade Name(विद्यमान व्यापार नाव)<span class="text-danger"
                    style="color: red;">*</span>
                </label>
                <input type="text" class="form-control"  style="background-image: none;" id="existingTradeName" placeholder="" name="existingTradeName" value=""
                
                maxlength="10" required>
             <div class="invalid-feedback">
                Please Enter Valid Existing Trade Name
            </div>
            </div>
        </div>
        ...
        $('#main-dropdown').on('change', function () {
            ...
            for (var i = 0; i < options.length; i++) {
                $('#dependent-dropdown').append('<option value="' + (options[i] === '-Select Ward-' ? '' : options[i]) + '">' + options[i] + '</option>');
                        ...
                        <div class="col-md-3">
                            <div class="mb-3 mt-3">
                                <label for="" class="form-label lbleng">Updated Trade Name <br>(अद्यतनित व्यापार नाव)</label>
            
                                <input type="text" class="form-control"  style="background-image: none;"id=""pattern="^\s*\S.*$" placeholder="" maxlength="100" name="updateTradeName" pattern="^([A-Za-z]{0,})([A-Za-z]{1,}\s?)+$" value="">
         ...
         <div class="invalid-feedback">Please Enter Valid Updated Trade Type.
                        ...
                        <div class="col-md-3">
                            <div class="mb-3 mt-3">
                                ...
                                <input type="text" class="form-control"  style="background-image: none;"id="" pattern="^\s*\S.*$"maxlength="100" placeholder="" name="updatedOwnerName" value="" pattern="^([A-Za-z]{0,})([A-Za-z]{1,}\s?)+$" required>
                                <div class="invalid-feedback">
...
<script>
 ...
 .
			...
			<div class="alert alert-info mb-2 p-2 mb-4 ms-2">
                <small class="form-label "><strong class="form-label ">Note(नोंद): </strong> Upload below files in .pdf(Max upto 2 MB)(खालील फाइल .pdf मध्ये अपलोड करा (कमाल 2MB पर्यंत))</small>
			</div>
    	...
    	<script type="text/javascript">
    	   ...
    	   $(document).ready(function () {
    		   ...
    		   $("#submit").click(function (event) {
    	  		...
    	  		onPageSubmit('<c:out value="${contextRoot}"/>/rtsapplication/saveTradeLicenseTypeChange.do');
    		              	    } 
      	    ...
      	    data.append('idProof4', $("#doc4").get(0).files[0]);
      	       ...
      	       for (var i = 0; i < file.length; i++) {
      	  			...
      	  			const value = splitName + ".pdf";
      	               ...
      	               filesPath = filesPath + basePath + "tradeLicenseTypeChange/" + id + value + ","
      	               isFileSelected = true;
      	           }
      	       }
      	       $.ajax({
      	        url: "<c:out value='${contextRoot}'/>/rtiapplication/uploadDocumentTradeLicenseTypeChange.do?id="+id,
      	           type: 'POST',
      	           data: data,
      	           cache: false,
      	           dataType: 'json',
