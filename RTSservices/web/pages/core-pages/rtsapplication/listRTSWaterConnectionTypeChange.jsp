...
<script type="text/javascript">
	function editRTIApplication(id) {
		...
		onPageSubmit('<c:out value="${contextRoot}"/>/rtsapplication/editWaterConnectionTypeChange.do');
	}
 ...
 <c:if test="${rtiApplnList.workFlowStatus==2}">
					...
					<c:if test="${rtiApplnList.workFlowStatus==5}">
						...
						<c:if test="${rtiApplnList.workFlowStatus==9}">
												<b style="color:green;">Under Approval Authourity</b>

					</c:if>
						<c:if test="${rtiApplnList.workFlowStatus==10}">
<b style="color:red !important;">Under Higher Approval Authority</b>
					</c:if>
