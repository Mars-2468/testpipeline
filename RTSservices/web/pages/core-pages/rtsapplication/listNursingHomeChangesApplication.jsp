...
<script type="text/javascript">
	function editRTIApplication(id) {
		...
		onPageSubmit('<c:out value="${contextRoot}"/>/rtsapplication/editNursingHomeChangesApplication.do');
	}
	function searchRTIApplication() {
		onPageSubmit('<c:out value="${contextRoot}"/>/rtsapplication/listNursingHomeChangesApplication.do');
	}
</script>
<style type="text/css">
.btn-success { -
