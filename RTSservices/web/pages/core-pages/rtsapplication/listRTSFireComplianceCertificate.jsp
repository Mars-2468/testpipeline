...
<script type="text/javascript">
	function editRTIApplication(id) {
		...
		onPageSubmit('<c:out value="${contextRoot}"/>/rtiapplication/editFireComplianceCertificate.do');
	}
...
<div class="mainHdr">
	<%-- <h3>
		 <a
			href="<c:out value="${contextRoot}"/>/rtiapplication/newRTIMandapApplication.do">
			New Mandap Application
		</a>
