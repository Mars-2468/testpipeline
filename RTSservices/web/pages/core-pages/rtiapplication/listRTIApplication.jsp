...
<script type="text/javascript">
	function editRTIApplication(id) {
		...
		onPageSubmit('<c:out value="${contextRoot}"/>/rtiapplication/editBirthRegistrationCertificate.do');
	}
...
<div class="mainHdr">
	<h3>
		<!--  <a
			href="<c:out value="${contextRoot}"/>/rtiapplication/editRTIApplication.do">
		...
		<tbody>
			...
			<c:forEach var="rtiApplnList"
				...
				<tr>
					...
					<td><input type="hidden" id="rtiApplicationRefId" name="rtiApplicationRefId" value="<c:out value="${rtiApplnList.rtiApplicationRefId}" />" /></td>
				</tr>
			</c:forEach>
