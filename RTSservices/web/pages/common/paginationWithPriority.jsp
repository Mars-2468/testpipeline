...
<c:if test="${requestScope.maximumPages > 0 && requestScope.currentPage>0}">
	...
	<td style="font-weight: normal;color: navy;">
			<img
				src="<c:out value="${contextRoot}"/>/images/orangeflag.gif"
				alt="Low Priority" title="Low Priority" /> <span style="padding-right: 10px;">Low Priority</span>
		
			<img src="<c:out value="${contextRoot}"/>/images/greenflag.gif"
				alt="Medium Priority" title="Medium Priority"/> <span style="padding-right: 10px;"> Medium Priority</span>	
					
			<img src="<c:out value="${contextRoot}"/>/images/redflag.gif"
				alt="High Priority" title="High Priority" /> <span style="padding-right: 10px;"> High Priority</span>
				
	        <img src="<c:out value="${contextRoot}"/>/images/Ico_Close.gif"
				alt="File Is Closed" title="File is Closed"/><span style="padding-right: 10px;"> File Is Closed</span>
		    
		     <img src="<c:out value="${contextRoot}"/>/images/parked.jpg"
				alt="File Is Closed" title="Parked"/><span style="padding-right: 10px;"> File Is Parked</span>		
