...
@Service
public class MarketDeptDashboardServiceImpl implements MarketDeptDashboardService{
				private static final Log log = LogFactory.getLog(MarketDeptDashboardServiceImpl.class);
			
			@Autowired
			private MarketDeptDashboardDAO marketDeptDashboardDAO;
			...
			public long getPieChartOrBarChartData() {
				...
				return marketDeptDashboardDAO.getPieChartOrBarChartData();
			}
			@Override
			public long getPieChartOrBarChartData(String condValue) {
				...
				return marketDeptDashboardDAO.getPieChartOrBarChartData(condValue);
			}
			@Override
			public long getPieChartOrBarChartData(String condValue1,
				...
				return marketDeptDashboardDAO.getPieChartOrBarChartData(condValue1, condValue2,condValue3);
			}
			...
			public List<BigInteger> getPieChartOrBarChartBasedOnSearch(
				...
				return marketDeptDashboardDAO.getPieChartOrBarChartBasedOnSearch(registrtionFromDate, registrtionToDate, category);
			}
			...
			public List<RTIApplication> getRTIApplicationListByLabel(
				...
				return marketDeptDashboardDAO.getRTIApplicationListByLabel(dashBoardLabelSearch);
			}
			...
			public long getRTIApplicationCountByLabel(
				...
				return marketDeptDashboardDAO.getRTIApplicationCountByLabel(dashBoardLabelSearch);
			}
			@Override
			public double getPieChartOrBarChartDatas(){
				...
				// TODO Auto-generated method stub
					...
					return marketDeptDashboardDAO.getPieChartOrBarChartDatas();
