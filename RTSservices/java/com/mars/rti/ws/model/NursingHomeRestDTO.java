...
@JsonPropertyOrder({ "title", "fullname", "name", "fathername", "surname", "plot", "building", "street", "city", "zone",
		...
		"opd", "ipd", "outwardNo", "zoneNo", "fees", "result", "responseCode", "responseStatus", "status",
		"qualifiedNuerseDoc", "pdetailsnuringdoc", "qulnursemidwifedoc", "unregmedunquilnursingDoc",
		"certificate_of_medical_file", "mmc_file", "mnc_file", "bio_medical_file", "fire_noc_file", "pollution_file",
		"water_tax_file", "permission_map_file", "occupancy_file", "notarized_file", "registered_rent_agreement",
		"trust_registration_file", "sign_and_date_file", "userMobileNumber","a","b","c","d","e" })
public class NursingHomeRestDTO implements Serializable {
	...
	private String certificate_of_medical_file;
	...
	private String permission_map_file;
//
//	private String occupancy_file;
//
//	private String notarized_file;
//
//	private String registered_rent_agreement;
//
//	private String trust_registration_file;
//
//	private String sign_and_date_file;
	...
	public String getCertificate_of_medical_file() {
		return certificate_of_medical_file;
	}

	public void setCertificate_of_medical_file(String certificate_of_medical_file) {
		this.certificate_of_medical_file = certificate_of_medical_file;
	}
	...
	public String getPermission_map_file() {
		return permission_map_file;
	}

	public void setPermission_map_file(String permission_map_file) {
		this.permission_map_file = permission_map_file;
	}
