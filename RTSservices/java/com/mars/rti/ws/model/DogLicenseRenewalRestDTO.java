...
@JsonPropertyOrder({"title", "name", "fatherName",
		...
		"dogDetails","result", "responseCode","renewaldogId",
		"responseStatus", "status", "userMobileNumber", "operatedPdf",
		"firstVaccinationCertificate", "secondVaccinationCertificate",
		"dogOwnerIdProof", "dogOwnerAddressproof","renewaldogIdProof","noOfDog","nocNeighbour","placeDetail"})
public class DogLicenseRenewalRestDTO implements Serializable {
	...
	private String renewaldogIdProof;
	...
	@XmlElement(name = "renewaldogId")
	public String getRenewaldogId() {
		return renewaldogId;
	}

	public void setRenewaldogId(String renewaldogId) {
		this.renewaldogId = renewaldogId;
	}
	...
	@XmlElement(name = "dogOwnerAddressproof")
	public String getRenewaldogIdProof() {
		return renewaldogIdProof;
	}

	public void setRenewaldogIdProof(String renewaldogIdProof) {
		this.renewaldogIdProof = renewaldogIdProof;
	}
