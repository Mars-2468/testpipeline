...
@Entity
@Table(name = "tradelicense_namechange", schema = "egovrti")
public class TradeLicenseNameChange {

	@Id
	@Column(name = "tradeLicenseName_id", nullable = false, unique = true)
	@SequenceGenerator(name = "tradeLicensename_seq", sequenceName = "tradeLicensename_seq")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "tradeLicensename_seq")
	private long tradeLicenseNameID;
	...
	@Column(name = "fees_applicable")
	private double feesApplicable;
	
	
	@Column(name="existing_trade_name")
	private String existingTradeName;
	...
	public long getTradeLicenseNameID() {
		return tradeLicenseNameID;
	}

	public void setTradeLicenseNameID(long tradeLicenseNameID) {
		this.tradeLicenseNameID = tradeLicenseNameID;
	}
	...
	public String getExistingTradeName() {
		return existingTradeName;
	}

	public void setExistingTradeName(String existingTradeName) {
		this.existingTradeName = existingTradeName;
	}
