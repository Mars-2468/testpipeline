...
@Entity
@Table(name="trade_licence_partner_change", schema= "egovrti")


public class TradeLicencePartnerChange {

	@Id
	@Column(name = "trade_partner_id", nullable = false, unique = true)
	@SequenceGenerator(name = "trade_partner_ser_seq", sequenceName = "trade_partner_ser_seq",  allocationSize=1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "trade_partner_ser_seq")
