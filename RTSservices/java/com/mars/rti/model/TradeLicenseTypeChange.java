...
@Entity
@Table(name = "tradelicense_typechange", schema = "egovrti")
public class TradeLicenseTypeChange {
	
	@Id
	@Column(name = "tradelicense_typeid", nullable = false, unique = true)
	@SequenceGenerator(name = "tradeLicensetype_seq", sequenceName = "tradeLicensetype_seq")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "tradeLicensetype_seq")
	private long tradeLicenseTypeID;
	...
	public long getTradeLicenseTypeID() {
		return tradeLicenseTypeID;
	}

	public void setTradeLicenseTypeID(long tradeLicenseTypeID) {
