...
@Entity
@Table(name="tax_exemption_non_residential", schema= "egovrti")


public class TaxExemptionNonResidential {

	@Id
	@Column(name = "tax_exemption_id", nullable = false, unique = true)
	@SequenceGenerator(name = "property_tax_exemption_non_residential_seq", sequenceName = "property_tax_exemption_non_residential_seq", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "property_tax_exemption_non_residential_seq")
