...
@Entity
@Table(name = "partition_of_property", schema = "egovrti")
public class PartitionOfProperty {

	@Id
	@Column(name = "partition_of_property_id", nullable = false, unique = true)
	@SequenceGenerator(name = "partition_of_property_seq", sequenceName = "partition_of_property_seq")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "partition_of_property_seq")
	private long partitionOfPropertyId;
	...
	public long getPartitionOfPropertyId() {
		return partitionOfPropertyId;
	}

	public void setPartitionOfPropertyId(long partitionOfPropertyId) {
		this.partitionOfPropertyId = partitionOfPropertyId;
	}
