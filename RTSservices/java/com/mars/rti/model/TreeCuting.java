...
@Entity
@Table(name = "tree_cuting", schema = "egovrti")
public class TreeCuting {
   
	@Id
	@Column(name = "tree_cuting_id", nullable = false, unique = true)
	@SequenceGenerator(name = "treecuting_seq", sequenceName = "treecuting_seq", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "treecuting_seq")
	private long treecutingId;
	...
	public long getTreecutingId() {
		return treecutingId;
	}

	public void setTreecutingId(long treecutingId) {
		this.treecutingId = treecutingId;
	}
	...
	public String getResonetreecuting() {
		return resonetreecuting;
	}

	public void setResonetreecuting(String resonetreecuting) {
		this.resonetreecuting = resonetreecuting;
	}
	...
	public String getApprovaloftreeauthoritycommittee() {
		return approvaloftreeauthoritycommittee;
	}

	public void setApprovaloftreeauthoritycommittee(String approvaloftreeauthoritycommittee) {
		this.approvaloftreeauthoritycommittee = approvaloftreeauthoritycommittee;
	}
	...
	@Column(name ="resone_tree_cuting",nullable = true)
	private String resonetreecuting;
	

	@Column(name ="number_of_tree_cuting",nullable = true)
	...
	@Column(name ="approval_of_tree_authority_committee",nullable = true)
	private String approvaloftreeauthoritycommittee;
	...
	public String getTotalFeesUptoCha() {
		return totalFeesUptoCha;
	}




	public void setTotalFeesUptoCha(String totalFeesUptoCha) {
		this.totalFeesUptoCha = totalFeesUptoCha;
	}




	public String getNoOfTreeUptoPercentage() {
		return noOfTreeUptoPercentage;
	}




	public void setNoOfTreeUptoPercentage(String noOfTreeUptoPercentage) {
		this.noOfTreeUptoPercentage = noOfTreeUptoPercentage;
	}
	...
	@Column(name ="pachanamaletter",nullable = true)
	private String pachanamaletter;
	...
	public String getPachanamaletter() {
		return pachanamaletter;
	}




	public void setPachanamaletter(String pachanamaletter) {
		this.pachanamaletter = pachanamaletter;
	}
	...
	@Column(name = "missing_docs")
	private String missingDocs;

	public String getMissingDocs() {
	    return missingDocs;
	}
	public void setMissingDocs(String missingDocs) {
	    this.missingDocs = missingDocs;
	}

	
	@Column(name = "plantationletter")
	...
	@Column(name = "advertisement_notice")
	private String advertisementNotice;
	...
	public String getAdvertisementNotice() {
	...
	public void setAdvertisementNotice(String advertisementNotice) {
		this.advertisementNotice = advertisementNotice;
	}
