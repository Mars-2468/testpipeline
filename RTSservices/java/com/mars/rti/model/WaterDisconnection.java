...
@Table(name="water_disconnection")
@Entity
public class WaterDisconnection {
	
			@Id
			@Column(name = "water_disconnection_id", nullable = false, unique = true)
			@SequenceGenerator(name = "water_disconnection_seq", sequenceName = "water_disconnection_seq")
			@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "water_disconnection_seq")
			
			private long waterDisconnectionId;
			...
			@Column(name = "disconnection_type", nullable = true)
			...
			@Column(name = "copyOf_fir", nullable = true)
...
//			private String consumerSign;
			...
			public long getWaterDisconnectionId() {
				return waterDisconnectionId;
			}

			public void setWaterDisconnectionId(long waterDisconnectionId) {
				this.waterDisconnectionId = waterDisconnectionId;
			}
