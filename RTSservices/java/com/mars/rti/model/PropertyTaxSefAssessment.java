...
@Entity
@Table(name = "property_tax_self_assessment", schema = "egovrti")
public class PropertyTaxSefAssessment {
	
	@Id
	@Column(name = "property_tax_self_assesssment_id", nullable = false, unique = true)
	@SequenceGenerator(name = "property_tax_self_assesssment_seq", sequenceName = "property_tax_self_assesssment_seq", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "property_tax_self_assesssment_seq")
	private long propertyTaxSelfAssessmentId;
	...
	public long getPropertyTaxSelfAssessmentId() {
		return propertyTaxSelfAssessmentId;
	}

	public void setPropertyTaxSelfAssessmentId(long propertyTaxSelfAssessmentId) {
		this.propertyTaxSelfAssessmentId = propertyTaxSelfAssessmentId;
	}
