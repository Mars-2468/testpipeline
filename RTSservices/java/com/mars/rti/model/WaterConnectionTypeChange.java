...
@Entity
@Table(name = "water_connection_change_type", schema = "egovrti")
public class WaterConnectionTypeChange {

	@Id
	@Column(name = "waterconnection_id", nullable = false, unique = true)
	@SequenceGenerator(name = "water_connection_change_type_seq", sequenceName = "water_connection_change_type_seq", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "water_connection_change_type_seq")
   ...
   private long waterConnectionId;
	...
	@Column(name = "purpose_of_connection", nullable = true)
	...
	@Column(name = "proposed_tapsize")
	private String proposedTapSize;

	public String getProposedTapSize() {
		return proposedTapSize;
	}

	public void setProposedTapSize(String proposedTapSize) {
