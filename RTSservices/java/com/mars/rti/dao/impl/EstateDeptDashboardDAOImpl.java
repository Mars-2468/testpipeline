...
@Repository
public class EstateDeptDashboardDAOImpl extends HibernateDaoSupport implements EstateDeptDashboardDAO{


		
			private static final Log log = LogFactory.getLog(EstateDeptDashboardDAOImpl.class);
			...
			public long getPieChartOrBarChartData() {
				...
				try{
					...
					String fromClause="select count(r) from RTIApplication r where rti_service_id=23";
			...
			public long getPieChartOrBarChartData(String condValue) {
				...
				try{
					...
					StringBuffer sql=new StringBuffer();
					String fromClause="select count(r) from RTIApplication r where r.finalStatus='"+condValue+"' and (rti_service_id=23)";
			...
			public long getPieChartOrBarChartData(String condValue1,
				...
				try{
					...
					StringBuffer sql=new StringBuffer();
					String fromClause="select count(r) from RTIApplication r where r.finalStatus not in ('"+condValue1+"','"+condValue2+"','"+condValue3+"')and (rti_service_id=23)";
		...
		public long getRTIApplicationCountByLabel(
			...
			try{
				...
				StringBuffer sql=new StringBuffer();
				String fromClause="select count(r) from RTIApplication r where department='ESTATE-DEPARTMENT'";
				List list=null;
				boolean flag=false;
		...
		public double getPieChartOrBarChartDatas() {
			...
			try {
				...
				String sqlString = "select sum(applicationCost) from RTIApplication rtiApplication where workFlowStatus in(2,1) and (rti_service_id=23)";
