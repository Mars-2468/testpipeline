...
@Repository
public class WaterDeptDashboardDAOImpl extends HibernateDaoSupport implements WaterDeptDashboardDAO{


		
			private static final Log log = LogFactory.getLog(WaterDeptDashboardDAOImpl.class);
			...
			public long getPieChartOrBarChartData() {
				...
				try{
					...
					String fromClause="select count(r) from RTIApplication r where rti_service_id=47 or rti_service_id=48 or rti_service_id=49 or rti_service_id=50 or rti_service_id=51 or rti_service_id=61 or rti_service_id=62 or rti_service_id=63 or rti_service_id=64 or rti_service_id=6 or rti_service_id=68";
			...
			public long getPieChartOrBarChartData(String condValue) {
				...
				try{
					...
					StringBuffer sql=new StringBuffer();
					String fromClause="select count(r) from RTIApplication r where r.finalStatus='"+condValue+"' and ( rti_service_id=47 or rti_service_id=48 or rti_service_id=49 or rti_service_id=50 or rti_service_id=51 or rti_service_id=61 or rti_service_id=62 or rti_service_id=63 or rti_service_id=64 or rti_service_id=6 or rti_service_id=68)";
			...
			public long getPieChartOrBarChartData(String condValue1,
				...
				try{
					...
					StringBuffer sql=new StringBuffer();
					String fromClause="select count(r) from RTIApplication r where r.finalStatus not in ('"+condValue1+"','"+condValue2+"','"+condValue3+"')and ( rti_service_id=47 or rti_service_id=48 or rti_service_id=49 or rti_service_id=50 or rti_service_id=51 or rti_service_id=61 or rti_service_id=62 or rti_service_id=63 or rti_service_id=64 or rti_service_id=6 or rti_service_id=68)";
		...
		public long getRTIApplicationCountByLabel(
			...
			try{
				...
				StringBuffer sql=new StringBuffer();
				String fromClause="select count(r) from RTIApplication r";
				List list=null;
				boolean flag=false;
		...
		public double getPieChartOrBarChartDatas() {
			...
			try {
				...
				String sqlString = "select sum(applicationCost) from RTIApplication rtiApplication where workFlowStatus in(2,1) and ( rti_service_id=47 or rti_service_id=48 or rti_service_id=49 or rti_service_id=50 or rti_service_id=51 or rti_service_id=61 or rti_service_id=62 or rti_service_id=63 or rti_service_id=64 or rti_service_id=6 or rti_service_id=68)";
