...
@Repository("deathRegistrationDAO")
public class DeathRegistrationDAOImpl extends HibernateDaoSupport implements DeathRegistrationDAO {
	
	
	private static final Log log = LogFactory.getLog(DeathRegistrationDAOImpl.class);
	...
	public void deathRegistrationCertificate(DeathRegistration deathRegistration) {
		// TODO Auto-generated method stub
				...
				try
				{
				    ...
				    getHibernateTemplate().saveOrUpdate(deathRegistration);
	...
	public DeathRegistration deathRegistrationSave(DeathRegistration deathRegistration) {
		// TODO Auto-generated method stub
		 DeathRegistration deathRegitration=null;
				try
				{
				    if (log.isDebugEnabled())
				    {
				    ...
				    deathRegitration=(DeathRegistration)getHibernateTemplate().merge(deathRegistration);
				} catch (NullPointerException nullpointerexception)
				{
				    log.error(nullpointerexception.getStackTrace());
				    throw new NullPointerException();
	...
	public List<DeathRegistration> getDeathRegistrationList(RTIApplicationSearch rTIApplicationSearch){
		try {
			...
			String sqlString = "select deathRegistration from DeathRegistration deathRegistration";
			...
			List<DeathRegistration> list = query.list();
	...
	public DeathRegistration get(long id) {
		try {
			...
			return (DeathRegistration) getHibernateTemplate().get(DeathRegistration.class, new Long(id));
		} catch (Exception exception) {
			log.error(exception.getStackTrace(), exception);
			exception.printStackTrace();
		}
