...
@Repository
public class BloodRelationDAOImpl extends HibernateDaoSupport implements BloodRelationDAO{
		...
		public List<BloodRelation> getBloodrelation() {
		    ...
		    return (List<BloodRelation>) getHibernateTemplate().loadAll(BloodRelation.class);
