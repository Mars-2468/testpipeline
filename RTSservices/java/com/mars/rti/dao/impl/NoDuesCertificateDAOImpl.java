...
@Repository("noDuesCertificateDAO")
public class NoDuesCertificateDAOImpl extends HibernateDaoSupport implements
		NoDuesCertificateDAO {

	private static final Log log = LogFactory
			.getLog(NoDuesCertificateDAOImpl.class);
	...
	public void save(NoDuesCertificate noDuesCertificate) {
		try {
			getHibernateTemplate().saveOrUpdate(noDuesCertificate);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public List<NoDuesCertificate> getList(
		...
		try {
			...
			String sqlString = "select noDuesCertificate from NoDuesCertificate noDuesCertificate";
			...
			List<NoDuesCertificate> list = query.list();
	...
	public NoDuesCertificate get(long id) {
		try {
			...
			return (NoDuesCertificate) getHibernateTemplate().get(
					NoDuesCertificate.class, id);
		} catch (Exception exception) {
			log.error(exception.getStackTrace(), exception);
			exception.printStackTrace();
		}
	...
	public NoDuesCertificate findFromRTIRefNum(String rtiapplrefno) {
		NoDuesCertificate d = null;

		String sqlquery = "select noDuesCertificate from NoDuesCertificate noDuesCertificate where noDuesCertificate.rtiapplrefno ="
				+ "'" + rtiapplrefno + "'";
		List<NoDuesCertificate> list = null;
