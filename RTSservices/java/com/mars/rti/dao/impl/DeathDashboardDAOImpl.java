...
@Repository
public class DeathDashboardDAOImpl extends HibernateDaoSupport implements DeathDashboardDAO{
		
		private static final Log log = LogFactory.getLog(DeathDashboardDAOImpl.class);
		...
		public long getPieChartOrBarChartData() {
			...
			try{
				...
				String fromClause="select count(r) from RTIApplication r where r.subject='DEATH-CERTIFICATE'";
		...
		public long getPieChartOrBarChartData(String condValue) {
			...
			try{
				...
				StringBuffer sql=new StringBuffer();
				String fromClause="select count(r) from RTIApplication r where r.subject='DEATH-CERTIFICATE' and r.finalStatus='"+condValue+"'";
		...
		public long getPieChartOrBarChartData(String condValue1,
			...
			try{
				...
				StringBuffer sql=new StringBuffer();
				String fromClause="select count(r) from RTIApplication r where r.finalStatus not in ('"+condValue1+"','"+condValue2+"','"+condValue3+"','New') and rti_service_id=2";
