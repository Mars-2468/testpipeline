...
@Repository
public class BirthDashboardDAOImpl extends HibernateDaoSupport implements BirthDashboardDAO{
	...
	public long getPieChartOrBarChartData() {
		...
		try{
			...
			String fromClause="select count(r) from RTIApplication r where r.subject='BIRTH-CERTIFICATE'";
	...
	public long getPieChartOrBarChartData(String condValue) {
		...
		try{
			...
			StringBuffer sql=new StringBuffer();
			String fromClause="select count(r) from RTIApplication r where r.subject='BIRTH-CERTIFICATE' and r.finalStatus='"+condValue+"'";
	...
	public long getPieChartOrBarChartData(String condValue1,
		...
		try{
			...
			StringBuffer sql=new StringBuffer();
			String fromClause="select count(r) from RTIApplication r where r.finalStatus not in ('"+condValue1+"','"+condValue2+"','"+condValue3+"') and rti_service_id=1";
