...
import com.mars.rti.dao.SolidWasteDeptDashboardDAO;
import com.mars.rti.model.RTIApplication;
import com.mars.rti.search.DashBoardLabelSearch;
@Repository

public class SolidWasteDeptDashboardDAOImpl extends HibernateDaoSupport implements SolidWasteDeptDashboardDAO{


		
			private static final Log log = LogFactory.getLog(SolidWasteDeptDashboardDAOImpl.class);
			...
			public long getPieChartOrBarChartData() {
				...
				try{
					...
					String fromClause="select count(r) from RTIApplication r where r.subject='DOGLICENCE-CERTIFICATE'";
			...
			public long getPieChartOrBarChartData(String condValue) {
				...
				try{
					...
					StringBuffer sql=new StringBuffer();
					String fromClause="select count(r) from RTIApplication r where r.subject='DOGLICENCE-CERTIFICATE' and r.finalStatus='"+condValue+"'";
			...
			public long getPieChartOrBarChartData(String condValue1,
				...
				try{
					...
					StringBuffer sql=new StringBuffer();
					String fromClause="select count(r) from RTIApplication r where r.finalStatus not in ('"+condValue1+"','"+condValue2+"','"+condValue3+"') and rti_service_id=3";
		...
		public double getPieChartOrBarChartDatas() {
			...
			//	String sqlString = "select sum(application_Cost) from RTIApplication rtiApplication where workflow_status in(2,1)";
			//	String sqlString="select count(r) from RTIApplication r where r.subject='TRADE-LICENCE-RENEWAL'";
				String sqlString = "select sum(applicationCost) from RTIApplication rtiApplication where workFlowStatus in(2,1) and rti_service_id="+serviceId;
