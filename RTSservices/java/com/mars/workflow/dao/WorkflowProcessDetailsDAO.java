...
/**
 * <p>Title: WorkflowProcessDetailsDAO.java </p>

 * <p>Description: This interface is used for hibernate operations for WorkflowProcessDetails</p>
...
public interface WorkflowProcessDetailsDAO
{
    ...
    /**
     * This method save/updates the WorkflowProcessDetails information to the database.
     * 
     * @param WorkflowProcessDetails object
     * 
     */
    ...
    /**
     * This method will return a list of all WorkflowProcessDetails from the database
     * 
    ...
    /**
     * This method save/updates a list of WorkflowProcessDetails information to the database.
     * 
     * @param listWorkflowProcessDetails as List
     * 
     */
    public void saveAll(List<WorkflowProcessDetails> listWorkflowProcessDetails);

    /**
     * This method is used to delete a list of WorkflowProcessDetails records from the database.
     * 
     * @param listWorkflowProcessDetails as List
     */
    ...
    /**
     * This method returns list of the WorkflowProcessDetails objects available based page number.
     * 
    ...
    /**
     * This method returns count of the WorkflowProcessDetails objects from the database
     * 
     * @return long
     * @exception Exception
     */
    ...
    /**
     * This method returns WorkflowProcessDetails objects from the database by process Id
     * @param processId
    ...
    /**
     * This method returns WorkflowProcessDetails objects from the database by entity Id and entity Name
     * @param entityId
     * @param entityName
     * @return WorkflowProcessDetails
     * @exception Exception
	...
	/* public AddressDetails merge(AddressDetails entity);*/
